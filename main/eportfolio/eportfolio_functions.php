...
function render_eportfolio_fields_form() {
    ...
    <nav id='navbar-examplePortfolioEdit' class='navbar navbar-light mt-4 bg-white flex-column align-items-stretch p-3 sticky-top Borders shadow-default' style='z-index:2;'>
        <nav class='nav nav-pills flex-column'>";
