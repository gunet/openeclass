...
if (!get_config('eportfolio_enable')) {
    $tool_content = "<div class='row p-2'></div><div class='col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12'><div class='alert alert-danger'>$langePortfolioDisabled</div></div>";
    draw($tool_content, 1);
    exit;
}
...
if (isset($_GET['delete_bio'])) {
    ...
    $tool_content .= "<div class='row p-2'></div><div class='col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12'><div class='alert alert-success'>$langBioDeletedSuccess</div></div>";
    ...
    if (isset($_FILES['bio']) && is_uploaded_file($_FILES['bio']['tmp_name'])) {
        ...
        if (finfo_file($finfo, $_FILES['bio']['tmp_name']) == 'application/pdf') {
            if ($_FILES['bio']['size'] <= get_config('bio_quota')*1024*1024) {
                ...
                $tool_content .= "<div class='row p-2'></div><div class='col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12'><div class='alert alert-success'>$langUploadBioSuccess</div></div>";
            } else {
                //Session::Messages(sprintf($langUploadBioFailSize, get_config('bio_quota')), 'alert-danger');
                $tool_content .= "<div class='row p-2'></div><div class='col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12'><div class='alert alert-danger'>$langUploadBioFailSize ".get_config('bio_quota')."</div></div>";
            }
        } else {
            //Session::Messages($langUploadBioFailType, 'alert-danger');
            $tool_content .= "<div class='row p-2'></div><div class='col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12'><div class='alert alert-danger'>$langUploadBioFailType</div></div>";
        }
        redirect_to_home_page('main/eportfolio/bio_upload.php');
    } 
}
...
$tool_content .= 
    "<div class='row p-2'></div><div class='col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12'><div class='alert alert-info'>$langBioPermFileType ".sprintf($langBioMaxSize, get_config('bio_quota'))."</div></div>
