    ...
    public static function week_calendar_item($event, $class) {
        ...
        if ($event->event_type == "personal" || ($event->event_type == "admin" && $is_admin)) {
            $formatted_calendar_item .= icon('fa-edit', $langModify, str_replace('thisid',$event->id, $urlServer.Calendar_Events::$event_type_url[$event->event_type])). "&nbsp;
                        ".icon('fa-xmark', $langDelete, "?delete=$event->id&et=$event->event_type", "onClick=\"return confirmation('$langConfirmDelete');\""). "&nbsp;";
        }
            ...
            $calendar = "<div class='panel-heading p-0 d-flex justify-content-center align-items-center' style='background-color:#2B3944;'>
                            <div id='cal-header' class='cal-header-course Neutral-900-bg d-flex justify-content-center align-items-center w-100'>
                                <div class='btn-group w-100' role='group'>
                                    ...
                                    <button type='button' class='btn btn-transparent d-flex justify-content-center align-items-center' data-calendar-nav='next'><div class='btn-calendar-next d-flex justify-content-center align-items-center'><i class='fa-solid fa-chevron-right'></i></div><span class='sr-only'>$langNextMonth</span></button>
                                </div>
                            </div>
                        </div>";
       }else{
