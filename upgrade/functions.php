...
function upgrade_to_4_2($tbl_options) : void {
    ...
    Database::get()->query("CREATE TABLE `game` (
        `id` int(11) not null auto_increment primary key,
        `course_id` int(11) not null,
        `title` varchar(255) not null,
        `description` text,
    ...
    Database::get()->query("CREATE TABLE `game_criterion` (
        `id` int(11) not null auto_increment primary key,
    ...
    Database::get()->query("CREATE TABLE `game_levels` (
        `id` int(11) not null auto_increment primary key,
        `game` int(11) not null,
    ...
    Database::get()->query("CREATE TABLE `user_game_criterion` (
        `id` int(11) not null auto_increment primary key,
        `user` int(11) not null,
    ...
    Database::get()->query("CREATE TABLE `user_game_points` (
        `id` int(11) not null auto_increment primary key,
        `user` int(11) not null,
        `game` int(11) not null,
