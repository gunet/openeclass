...
function convert_db_encoding_to_utf8mb4() {
    ...
    Database::get()->query("ALTER TABLE `admin_announcement` CHANGE lang lang varchar(16)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    ...
    Database::get()->query("ALTER TABLE `assignment` CHANGE lang lang varchar(50)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    ...
    Database::get()->query("ALTER TABLE `assignment_grading_review` CHANGE file_path file_path varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    ...
    Database::get()->query("ALTER TABLE `assignment_submit` CHANGE file_path file_path varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    ...
    Database::get()->query("ALTER TABLE `assignment_submit` CHANGE grade_comments_filepath grade_comments_filepath varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    ...
    Database::get()->query("ALTER TABLE `conference` CHANGE status status enum('active','inactive')  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    ...
    Database::get()->query("ALTER TABLE `course` CHANGE lang lang varchar(16)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    ...
    Database::get()->query("ALTER TABLE `document` CHANGE path path varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    Database::get()->query("ALTER TABLE `document` CHANGE extra_path extra_path varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    ...
    Database::get()->query("ALTER TABLE `document` CHANGE language language varchar(16)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    ...
    Database::get()->query("ALTER TABLE `forum_post` CHANGE topic_filepath topic_filepath varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    ...
    Database::get()->query("ALTER TABLE `group` CHANGE name name varchar(100)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    ...
    Database::get()->query("ALTER TABLE `h5p_library_translation` CHANGE language_code language_code varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    ...
    Database::get()->query("ALTER TABLE `log` CHANGE ip ip varchar(45)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    ...
    Database::get()->query("ALTER TABLE `lp_learnPath` CHANGE `lock` `lock` enum('OPEN','CLOSE')  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    ...
    Database::get()->query("ALTER TABLE `lp_module` CHANGE accessibility accessibility enum('PRIVATE','PUBLIC')  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    Database::get()->query("ALTER TABLE `lp_module` CHANGE contentType contentType enum('CLARODOC','DOCUMENT','EXERCISE','HANDMADE','SCORM','SCORM_ASSET','LABEL','COURSE_DESCRIPTION','LINK','MEDIA','MEDIALINK')  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    Database::get()->query("ALTER TABLE `lp_module` CHANGE launch_data launch_data text  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    Database::get()->query("ALTER TABLE `lp_rel_learnPath_module` CHANGE `lock` `lock` enum('OPEN','CLOSE')  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    ...
    Database::get()->query("ALTER TABLE `lp_user_module_progress` CHANGE lesson_status lesson_status enum('NOT ATTEMPTED','PASSED','FAILED','COMPLETED','BROWSED','INCOMPLETE','UNKNOWN')  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    Database::get()->query("ALTER TABLE `lp_user_module_progress` CHANGE entry entry enum('AB-INITIO','RESUME','')  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    ...
    Database::get()->query("ALTER TABLE `lp_user_module_progress` CHANGE credit credit enum('CREDIT','NO-CREDIT')  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    ...
    Database::get()->query("ALTER TABLE `lti_apps` CHANGE lti_provider_url lti_provider_url varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    Database::get()->query("ALTER TABLE `lti_apps` CHANGE lti_provider_key lti_provider_key varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    Database::get()->query("ALTER TABLE `lti_apps` CHANGE lti_provider_secret lti_provider_secret varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    Database::get()->query("ALTER TABLE `lti_apps` CHANGE type type varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    ...
    Database::get()->query("ALTER TABLE `note` CHANGE reference_obj_type reference_obj_type enum('course','personalevent','user','course_ebook','course_event','course_assignment','course_document','course_link','course_exercise','course_learningpath','course_video','course_videolink')  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    Database::get()->query("ALTER TABLE `oai_metadata` CHANGE field field varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    Database::get()->query("ALTER TABLE `oai_metadata` CHANGE value value text  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    Database::get()->query("ALTER TABLE `oai_record` CHANGE oai_identifier oai_identifier varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    Database::get()->query("ALTER TABLE `oai_record` CHANGE oai_metadataprefix oai_metadataprefix varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    Database::get()->query("ALTER TABLE `oai_record` CHANGE oai_set oai_set varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    ...
    Database::get()->query("ALTER TABLE `personal_calendar` CHANGE reference_obj_type reference_obj_type enum('course','personalevent','user','course_ebook','course_event','course_assignment','course_document','course_link','course_exercise','course_learningpath','course_video','course_videolink')  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    Database::get()->query("ALTER TABLE `personal_calendar_settings` CHANGE view_type view_type enum('day','month','week')  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    ...
    Database::get()->query("ALTER TABLE `tag` CHANGE name name varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    ...
    Database::get()->query("ALTER TABLE `tc_servers` CHANGE type type varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    Database::get()->query("ALTER TABLE `tc_servers` CHANGE hostname hostname varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    Database::get()->query("ALTER TABLE `tc_servers` CHANGE ip ip varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    Database::get()->query("ALTER TABLE `tc_servers` CHANGE port port varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    Database::get()->query("ALTER TABLE `tc_servers` CHANGE enabled enabled enum('true','false')  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    Database::get()->query("ALTER TABLE `tc_servers` CHANGE server_key server_key varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    Database::get()->query("ALTER TABLE `tc_servers` CHANGE username username varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    Database::get()->query("ALTER TABLE `tc_servers` CHANGE password password varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    Database::get()->query("ALTER TABLE `tc_servers` CHANGE api_url api_url varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    Database::get()->query("ALTER TABLE `tc_servers` CHANGE webapp webapp varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    Database::get()->query("ALTER TABLE `tc_servers` CHANGE enable_recordings enable_recordings enum('true','false')  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    Database::get()->query("ALTER TABLE `tc_servers` CHANGE screenshare screenshare varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    ...
    Database::get()->query("ALTER TABLE `tc_session` CHANGE public public enum('0','1')  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    Database::get()->query("ALTER TABLE `tc_session` CHANGE active active enum('0','1')  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    Database::get()->query("ALTER TABLE `tc_session` CHANGE meeting_id meeting_id varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    Database::get()->query("ALTER TABLE `tc_session` CHANGE mod_pw mod_pw varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    Database::get()->query("ALTER TABLE `tc_session` CHANGE att_pw att_pw varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    ...
    Database::get()->query("ALTER TABLE `tc_session` CHANGE record record enum('true','false')  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    ...
    Database::get()->query("ALTER TABLE `unit_resources` CHANGE type type varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    ...
    Database::get()->query("ALTER TABLE `user` CHANGE password password varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    ...
    Database::get()->query("ALTER TABLE `user` CHANGE lang lang varchar(16)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    ...
    Database::get()->query("ALTER TABLE `user_request` CHANGE lang lang varchar(16)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    ...
    Database::get()->query("ALTER TABLE `video` CHANGE path path varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    ...
    Database::get()->query("ALTER TABLE `wall_post` CHANGE youtube youtube varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    ...
    Database::get()->query("ALTER TABLE `wall_post_resources` CHANGE type type varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    Database::get()->query("ALTER TABLE `wiki_acls` CHANGE flag flag varchar(255)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
    Database::get()->query("ALTER TABLE `wiki_acls` CHANGE value value enum('false','true')  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin");
