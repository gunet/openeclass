<!DOCTYPE html>
    ...
    <body style="background-color: #009BDA;">
        ...
        <div style=" background: linear-gradient(180deg, rgba(8,88,121,1) 40%, rgba(0,155,218,1) 100%);">
            ...
            <img class="img-fluid mx-auto d-block"  style="padding-bottom: 20px; padding-top: 50px; padding-left: 20%; padding-right: 20%;"  src="images/maintence4.png">
