...
function list_exercises() {
    ...
    if (count($quizinfo) == 0) {
        ...
        $tool_content .= "<div class='d-flex justify-content-end mt-4 gap-2'><input class='btn submitAdminBtn' type='submit' name='submit_exercise' value='$langAddModulesButton'>                
