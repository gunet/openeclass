    ...
    <div class='row'>
        ...
        action_bar(array(
            ...
            array('title' => $langAdd.' '.$langInsertExercise,
                  ...
                  'icon' => 'fa fa-paste',
                  'level' => 'secondary',
                  'show' => visible_module(MODULE_ID_EXERCISE)),
            ...
            array('title' => $langAdd.' '.$langInsertLink,
                  ...
                  'icon' => 'fa fa-paste',
                  'level' => 'secondary',
                  'show' => visible_module(MODULE_ID_LINKS)),
            array('title' => $langAdd.' '.$langLearningPath1,
                  'url' => $base_url . 'lp',
                  'icon' => 'fa fa-paste',
                  'level' => 'secondary',
                  'show' => visible_module(MODULE_ID_LP)),
            array('title' => $langAdd.' '.$langInsertVideo,
                  'url' => $base_url . 'video',
                  'icon' => 'fa fa-paste',
                  'level' => 'secondary',
                  'show' => visible_module(MODULE_ID_VIDEO)),
            ...
            array('title' => $langAdd.' '.$langInsertEBook,
                  ...
                  'icon' => 'fa fa-paste',
                  'level' => 'secondary',
                  'show' =>  visible_module(MODULE_ID_EBOOK)),
            ...
            array('title' => $langAdd.' '.$langInsertPoll,
                  ...
                  'icon' => 'fa fa-paste',
                  'level' => 'secondary',
                  'show' => visible_module(MODULE_ID_QUESTIONNAIRE)),
            array('title' => $langAdd.' '.$langInsertWiki,
                  'url' => $base_url . 'wiki',
                  'icon' => 'fa fa-paste',
                  'level' => 'secondary',
                  'show' => visible_module(MODULE_ID_WIKI)),
            array('title' => $langAdd.' '.$langInsertChat,
                'url' => $base_url . 'chat',
                'icon' => 'fa fa-paste',
                'level' => 'secondary',
                'show' => visible_module(MODULE_ID_CHAT)),
            array('title' => $langAdd.' '.$langInsertTcMeeting,
                'url' => $base_url . 'tc',
                'icon' => 'fa fa-paste',
                'level' => 'secondary',
                'show' => (visible_module(MODULE_ID_TC) && is_configured_tc_server()))
            )) .
    "
    </div>
  </div>";
