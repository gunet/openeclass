...
$langNoAdminAccess = '
		...
		<a href='.$urlServer.'>αρχική σελίδα</a> και δώστε τα
		στοιχεία σας.</p>
';
...
$langLoginRequired = '
		...
		Παρακαλούμε επιστρέψτε στην <a href='.$urlServer.'>αρχική
		σελίδα</a> και εγγραφείτε στο μάθημα αν η εγγραφή είναι ελεύθερη.
		</p>
';
