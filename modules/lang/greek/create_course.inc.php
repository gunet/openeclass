...
$langFieldsRequ="Όλα τα πεδία με αστερίσκο είναι υποχρεωτικά!";
...
$langObjectives="π.χ. <i>Οι μαθητές καλούνται να μάθουν ... και να εξοικειωθούν με ...</i>";
$langIntroNote="π.χ. <i>Καλωσήρθατε στο μάθημα της Ιστορίας Ι. Μέσα από τις σελίδες του μαθήματος μπορείτε...</i>";
...
$langAgendaText="Εισαγωγή στην θεωρία αριθμών";
