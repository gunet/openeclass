...
$langLanguage="Γλώσσα";
$langConfTip="Εξ ορισμού, το μάθημα είναι προσπελάσιμο μόνο από εσάς. Αν θέλετε ελεγχόμενη πρόσβαση, μπορείτε να επιλέξετε 'Ελεγχόμενη Πρόσβαση με ανοικτή εγγραφή' και να ζητήσετε από τους χρήστες να γραφτούν. Μόλις τελειώσει η εγγραφή μπορείτε να επιλέξετε 'Ελεγχόμενη Πρόσβαση'.";
...
$langByDel="Διαγράφοντας αυτό το μάθημα θα διαγραφτούν μόνιμα όλα τα περιεχόμενα του και όλοι οι φοιτητές που είναι γραμμένοι σε 
αυτό (δεν θα διαγραφτούν από τα άλλα μαθήματα).<p>Θέλετε πράγματι να διαγράψετε το";
$langY="ΝΑΙ";
$langN="ΟΧΙ";

// deluser_course.php

$langUserDel="Πρόκειται να διαγράψετε όλους τους μαθητές από το μάθημα (δεν θα διαγραφτούν από τα άλλα μαθήματα).<p>Θέλετε 
πράγματι να προχωρήσετε στη διαγραφή τους από το μάθημα";

// refresh course.php
$langRefreshCourse = "Ανανέωση μαθήματος";

$langRefresh="Προκειμένου να προετοιμάσετε το μάθημα για μια νέα ομάδα φοιτητών μπορείτε να διαγράψετε το παλιό 
περιεχόμενο. Επιλέξτε ποιες ενέργειες θέλετε να πραγματοποιηθούν.";
...
$langUsersDeleted="Οι χρήστες διαγράφτηκαν από το μάθημα";
$langAnnDeleted="Οι ανακοινώσεις διαγράφτηκαν από το μάθημα";
$langAgendaDeleted="Οι εγγραφές της ατζέντας διαγράφτηκαν από το μάθημα";
