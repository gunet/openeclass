...
<br><br>
Η πρόσβαση στην υπηρεσία γίνεται με τη χρήση ενός απλού φυλλομετρητή (web browser) χωρίς την απαίτηση εξειδικευμένων τεχνικών γνώσεων και προηγούμενης εμπειρίας στη χρήση ανάλογων συστημάτων. Ειδικότερα, προσφέρει ένα δυναμικό περιβάλλον  αλληλεπίδρασης και συνεχούς επικοινωνίας εκπαιδευτή εκπαιδευόμενου, ενώ συγχρόνως επιτρέπει στον εκπαιδευτή την ηλεκτρονική οργάνωση, αποθήκευση και παρουσίαση του εκπαιδευτικού υλικού, στον εκπαιδευόμενο ένα εναλλακτικό κανάλι εξατομικευμένης μάθησης ανεξάρτητο από χωροχρονικές δεσμεύσεις, στο διαχειριστή ένα ανοικτό ασφαλές κι αξιόπιστο σύστημα και τέλος στον εκπαιδευτικό οργανισμό αποτελεσματικότητα, αξιοποίηση της συσσωρευμένης εμπειρίας, οικονομία κλίμακας και εποικοδομητική χρήση της υπάρχουσας δικτυακής υποδομής.";
