...
$langGroupSpaceLink="Περιοχή ομάδας χρηστών";
...
$l_hotthres	= "Περισσότερα από $hot_threshold μηνύματα";
...
$l_invalidname	= "Το όνομα χρήστη που επιλέξατε, \"$username\", χρησιμοποιείται ήδη.";
$l_disallowname	= "Το όνομα χρήστη \"$username\" δεν επιτρέπεται από τον διαχειριστή.";

$l_welcomesubj	= "Καλωσορίσατε στις περιοχές συζητήσεων του $sitename";
$l_welcomemail	=
"
$l_welcomesubj,
...
// Prefs
$l_prefupdated	= "Οι προτιμήσεις ενημερώθηκαν. <a href=\"index.$phpEx\">Πιέστε εδώ για να επιστρέψετε</a> στην κεντρική σελίδα";
...
// Replypmsg
$l_pmposted	= "Στάλθηκε απάντηση, πιέστε <a href=\"viewpmsg.$phpEx\">εδώ</a> για να δείτε τα προσωπικά σας μηνύματα";
...
$l_passchange	= "Το συνθηματικό σας αλλάχτηκε επιτυχώς. Μπορείτε τώρα να πάτε στο <a href=\"bb_profile.$phpEx?mode=edit\">προφίλ σας</a> και να διαλάξετε ένα συνθηματικό της προτίμησής σας.";
$l_wrongmail	= "Η διεύθυνση email που δώσατε δεν ταιριάζει με αυτήν που είναι αποθηκευμένη στη βάση μας.";

$l_passsubj	= "Αλλαγή συνθηματικού περιοχών συζητήσεων $sitename";
