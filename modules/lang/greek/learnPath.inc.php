...
Confirm ?";
$langAlertBlockingPathMadeInvisible = "Αυτή η γραμμή ειναι φραγμένη.
Κάνοντας την μη ορατή θα επιτραπεί στους μαθητές η είσοδος
στην επόμενη γραμμή χωρίς να χρειάζεται να ολοκληρώσουν την παρούσα.
...
Θα διαγραφεί εντελώς από τον κεντρικό υπολογιστή και από κάθε γραμμή. Δεν θα είστε σε θέση να τη χρησιμοποιήσετε.
...
$langLearningPathAdmin = "Διαχειριση γραμμής μάθησης";
$langLearningPathEmpty = " Η γραμμή μάθησης είναι κενή ";
$langLearningPathList = "Λίστα διαχείρισης γραμμής ";
...
$langNewLabel = "Δημιουργία νέου επιπέδου / τίτλος αυτής της γραμμής μάθησης";
...
$langNotInstalled = "Προέκυψε σφάλμα.  Η εισαγωγή της γραμμής μάθηση απέτυχε.";
...
$langRoot = "αιτία";
$langSCORMTypeDesc = "SCORM 2004 προσαρμοσμένο περιεχόμενο";
$langScore = "Βαθμολογία";
$langScormIntroTextForDummies = "Τα εισαγόμενα πακέτα πρεπει να αποτελούνται απο ένα zip αρχείο και να είναι συμβατά με το SCORM 2004 ";
$langSecondShort = "sec.";
$langSize = "Μέγεθος";
...
$langTrackAllPath = "Παρακολούθηση γραμμής μάθησης";
...
$langUseOfPool = "Αυτή η σελίδα επιτρέπει να δείς όλες τις διαθέσιμες ενότητες σε αυτό το μάθημα. <br />
                     ...
                     Όποια άσκηση ή έγγραφο έχει προστεθεί στη γραμμή μάθησης θα εμφανίζεται σε αυτή τη λίστα.";
...
$langimportLearningPath = "Εισαγωγή μιας γραμμής μάθησης";
