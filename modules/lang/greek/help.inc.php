...
$langHHome="Βοήθεια";
$langHomeContent="<p>Για περισσότερη ευκολία, τα εργαλεία του Open eClass δε
...
// Help Group
$langHGroup="Βοήθεια Ομάδων Χρηστών";
...
$langVideo_studentContent = "<b><u>Περιγραφή</u></b><p>Επιλέξτε το βίντεο που θέλετε να δείτε. Αν το σύστημα είναι συνδεμένο με εξυπηρετητή ροών ο εκπαιδευόμενος πρέπει να γνωρίζει με
...
$langImportContent = "<p>Αν θέλετε μπορείτε να ανεβάσετε αρχείο σχετικό με το μάθημα σας. Το αρχείο αυτό θα αποθκευτεί στον εξυπηρετητή του Open eClass. Θα δημιουργηθεί σύνδεσμος προς αυτό στο αριστερό μενού του μαθήματος
