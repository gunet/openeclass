...
<p>Χρησιμοποιήστε τα εικονίδια για να μορφοποιήσετε το κείμενό σας. Σημειώστε ότι μπορείτε να δημιουργήστε σύνδεσμο (επιλέγοντας το κείμενο σας και κάνοντας κλικ στο εικονίδιο <img src='../../modules/wiki/toolbar/bt_link.png' align='absmiddle' border='0'>) προς μια καινούρια σελίδα του wiki την οποία θα δημιουργήσετε στη συνέχεια.";