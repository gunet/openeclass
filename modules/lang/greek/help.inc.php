...
'Προσθήκη Ανακοίνωσης'. Αν επιθυμείτε η ανακοίνωση να σταλεί και με mail στους φοιτητές που είναι εγγεγραμμένοι στομάθημα, τότε επιλέγετε 'Αποστολή (με email) της ανακοίνωσης στους εγγεγραμμένους μαθητές'.</p><p>Επίσης μπορείτε να
...
// xinha help
$langHXinha = "Συντάκτης HTML";
$langHXinha_student = $langHXinha ;
$langXinhaContent = "<p>Πληκτρολογήστε τον τίτλο και το σώμα της ανακοίνωσης. Χρησιμοποιήστε τον συντάκτη κειμένου για να εισάγετε το περιεχόμενό σας.
<p>Σημειώστε, ότι αν θέλετε, μπορείτε να εισάγετε και μαθηματικά σύμβολα. Για να το κάνετε αυτό κάντε τα ακόλουθα: Κάντε κλικ στο εικονίδιο 'Μετάβαση σε κώδικα HTML'. Εισάγετε το μαθηματικά σύμβολα σας μεταξύ των tags
&lt;m>.....&lt;/m>. Για την σύνταξη ανατρέξτε στη σελίδα <a href='http://www.xm1math.net/phpmathpublisher/doc/help.html'>http://www.xm1math.net/phpmathpublisher/doc/help.html</a>. 
Π.χ. για να εισάγετε την τετραγωνική ρίζα του a πληκτρολογήστε &lt;m>sqrt{a}&lt;/m> 
</p>
 <p>Μετά κάντε κλικ στο 'Προσθήκη'.</p></p>";
