...
$langInitContent = "<p class='helptopic'>Βρίσκεστε στην Αρχική Σελίδα της πλατφόρμας eClass. Για να χρησιμοποιήσετε την πλατφόρμα πληκτρολογήστε το όνομα χρήστη και το συνθηματικό σας. Αν δεν θυμάστε τα στοιχεία σας, κάντε κλικ στο σύνδεσμο 'Ξεχάσατε το συνθηματικό σας' και στην φόρμα που θα σας εμφανιστεί, συμπληρώστε την ηλεκτρονική σας διεύθυνση που δηλώσατε κατά την εγγραφή σας στην πλατφόρμα για να σταλούν τα στοιχεία σας.</p><p class='helptopic'>Αν είστε φοιτητής και δεν έχετε λογαριασμό, κάντε κλικ στο σύνδεσμο 'Εγγραφή Φοιτητή' για να αποκτήσετε. Αν θέλετε να αποκτήσετε λογαριασμό με δικαιώματα 'καθηγητή', κάντε κλικ στο σύνδεσμο 'Εγγραφή καθηγητή' για να συμπληρώσετε την 'Αίτηση Εγγραφής Καθηγητή'</p><p class='helptopic'>Για περισσότερες πληροφορίες σχετικά με τη λειτουργία της πλατφόρμας διαβάστε τα σχετικά εγχειρίδια χρήσης.</p>";
...
$langHcourse_home_stud='Αρχική σελίδα μαθήματος';
...
$langHcourse_home_prof='Αρχική σελίδα μαθήματος';
$langcourse_home_profContent='<p>Βρίσκεστε στην κεντρική σελίδα του
...
<p>Από τα εργαλεία διαχείρισης μπορείτε να ενεργοποιήσετε ή να
