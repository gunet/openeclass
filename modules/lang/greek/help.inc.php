...
'Προσθήκη Ανακοίνωσης'. Στην φόρμα που θα σας εμφσνιστεί πληκτρολογήστε τον τίτλο και το σώμα της ανακοίνωσης. Χρησιμοποιήστε τον συντάκτη κειμένου για να εισάγετε το περιεχόμενό σας.
...
".<m>."....</m>. Για την σύνταξη ανατρέξτε στη σελίδα http://www.xm1math.net/phpmathpublisher/doc/help.html
Π.χ. για να εισάγετε την τετραγωνική ρίζα του a πληκτρολογήστε <m>sqrt{a}</m> 
</p>
 <p>Μετά κάντε κλικ στο 'Προσθήκη'. Αν επιθυμείτε η ανακοίνωση να σταλεί και με mail στους φοιτητές που είναι εγγεγραμμένοι στομάθημα, τότε επιλέγετε 'Αποστολή (με email) της ανακοίνωσης στους εγγεγραμμένους μαθητές'.</p><p>Επίσης μπορείτε να
