...
$langForContent="<p>Οι περιοχές συζητήσεων είναι ένα εργαλείο για ασύγχρονη
 ...
 ανάμεσα σε δύο μόνο άτομα, οι περιοχές συζητήσεων επιτρέπουν δημόσιες
 συζητήσεις. Από τεχνική άποψη, για τη χρήση μιας περιοχής
 συζητήσεων απαιτείται μόνο ένα πρόγραμμα browser.</p><p>Για την οργάνωση
 των περιοχών συζητήσεων, κάντε κλίκ στο «Διαχείριση». Οι συζητήσεις είναι
 ...
 απαντήσεων σε αυτούς. Οι περιοχές συζητήσεων του e-Class έχουν
 μια περιοχή συζήτησης και ένα θέμα ως δείγματα.</p><p>Το πρώτο πράγμα που πρέπει να
 κάνετε είναι να διαγράψετε το δοκιμαστικό θέμα και να μετονομάσετε την
 περιοχή συζήτησης. Στη συνέχεια, μπορείτε να δημιουργήσετε και
 άλλες περιοχές, κατά ομάδες ή κατά θέματα, που να ταιριάζουν στις εκπαιδευτικές σας ανάγκες.</p>
<p>Μην ανακατεύετε τις κατηγορίες και τις περιοχές συζητήσεων, και μην ξεχνάτε ότι μια κενή
 ...
 κατάλογο των μελών της, το σκοπό της, κάποιο έργο ή θέμα, κλπ.</p>";

// help_home.php

$langHHome="Βοήθεια";
$langHomeContent="<p>Για περισσότερη ευκολία, τα εργαλεία του e-Class δε
δημιουργούνται κενά. Σε κάθε εργαλείο υπάρχει ένα μικρό παράδειγμα για
να σας βοηθήσει να κατανοήσετε ευκολότερα τον τρόπο λειτουργίας του.
...
επιλογή να απενεργοποιήσετε αυτά που δε χρειάζεστε. Απλώς κάντε κλίκ στο
«Απενεργοποίηση». Τότε, μεταφέρετε στο γκρίζο μέρος της σελίδας. Δεν
...
να καθορίσετε τα δικαιώματα πρόσβασης για τους χρήστες του συστήματος, από
...
$langHClar="Βοήθεια";
$langClarContent="<p>Πληκτρολογήστε το όνομα χρήστη και το συνθηματκό σας για να
 μπείτε στην πλατφόρμα.</p>
 <p>
<b>Εγγραφή</b></p><p>Αν είστε φοιτητής, θα πρέπει να γραφτείτε
 επιλέγοντας «Εγγραφή Χρήστη», και μετά να επιλέξετε τα μαθήματα που
 επιθυμείτε να παρακολουθήσετε.</p><p>Αν είστε καθηγητής ή βοηθός, θα πρέπει
 και πάλι να γραφτείτε, επιλέγοντας όμως «Αίτηση Καθηγητή». Στη συνέχεια,
 θα συμπληρώσετε μια φόρμα με τα στοιχεία σας: Ονοματεπώνυμο, τηλέφωνο, όνομα χρήστη,
 e-mail και τη Σχολή / Τμήμα στο οποίο ανήκετε. Μόλις ολοκληρώσετε την εισαγωγή των στοιχείων σας,
 η αίτηση σας θα σταλεί στην Διαχειριστική Ομάδα της Πλατφόρμας
 η οποία θα δημιουργήσει τον λογαριασμό σας και θα σας στείλει ενημερωτικό e-mail με τα στοιχεία σας.
 Χρησιμοποιώντας το όνομα χρήστη / συνθηματικό θα μπείτε στην πλατφόρμα και
 θα κάνετε κλίκ στην επιλογή Δημιουργία Μαθήματος. Μόλις συμπληρώσετε τα ζητούμενα στοιχεία
 θα μεταφερθείτε στη σελίδα που μόλις θα έχει δημιουργηθεί για το μάθημα,
 και θα μπορείτε να αλλάξετε τα περιεχόμενα και την οργάνωσή της ανάλογα με
 τις ανάγκες σας.</p>";


$langHClar2="Αρχική σελίδα μαθημάτων";
$langClar2Content="<b>Αρχική σελίδα μαθημάτων</b><p>Σε αυτή τη σελίδα βλέπετε τα μαθήματα στα οποία είστε γραμμένος (σαν φοιτητής)
        ή έχετε δημιουργήσει (σαν καθηγητής).
                 Μπορείτε να παρακολούθησετε όποιο επιθυμείτε κάνοντας κλίκ στον αντίστοιχο τίτλο.
                 Κάνοντας κλίκ στην 'Αλλαγή του Προφίλ μου' μπορείτε να αλλάξετε κάποιο από τα προσωπικά σας
στοιχεία </p>";
...
$langDocContent="<p>Το εργαλείο αρχείων είναι όμοιο σε λειτουργία με τον Διαχειριστή Αρχείων
 ...
 μολυσμένα αρχεία. Συνίσταται να ελέγχεται τα έγγραφα σας με ένα αντιβιοτικό πρόγραμμα
 πριν τα ανεβάσετε.</p>
...
$langHUser="Βοήθεια";
$langUserContent="<b>Ρόλοι</b><p>Οι ρόλοι των χρηστών στην πλατφόρμα δεν σχετίζονται καθόλου με τον υπολογιστή
στον οποίο τρέχει η πλατφόρμα. Αυτό σημαίνει ότι δεν δίνουν κανένα δικαιώμα πάνω στο λειτουργικό σύστημα.
    Συνήθως δείχνουν στους ανθρώπους, ποιος είναι ποιος.</P><hr>
...
<p>Για να επιτρέψετε σε ένα βοηθό, για παράδειγμα, να συν-διαχειριστεί το μάθημα, αρκεί να
...
Απλά κάντε κλίκ στην εικόνα <img src=\"../../images/edit.gif\" border=\"0\" align=\"absmiddle\"> δίπλα στην άσκηση για να
την αλλάξετε.</p>
<hr>
<b>Διαγραφή Aσκησης</b>
<p>Για να διαγράψετε μια άσκηση, κάντε κλίκ στην εικόνα
<img src=\"../../images/delete.gif\" border=\"0\" align=\"absmiddle\"> δίπλα από την άσκηση για να τη διαγράψετε.</p>
<hr>
...
<img src=\"../../images/invisible.gif\" border=\"0\" align=\"absmiddle\"> δίπλα από την άσκηση για να την ενεργοποιήσετε.</p>
<hr>
...
στο εικονίδιο <img src=\"../../images/invisible.gif\" border=\"0\" align=\"absmiddle\">. Η εργασία θα είναι ορατή και
προσβάσιμη από τους φοιτητές μόνο όταν την ενεργοποιήσετε. Μπορείτε ανά πάσα στιγμή να διορθώσετε την
εργασία κάνοντας κλικ στο εικονίδιο <img src=\"../../images/edit.gif\" border=\"0\" align=\"middle\"> ή να την
...
$langAnnounceContent = "Σας δίνεται η δυνατότητα να  προσθέσετε ανακοινώσεις στην σελίδα του μαθήματος
πληκτρολογώντας  την περιγραφή της  και στη συνέχεια πατώντας το πλήκτρο 'εντάξει'.  Επίσης μπορείτε να
...
μάθημα, τότε επιλέγετε 'Αποστολή (με email) της ανακοίνωσης στους εγγεγραμμένους μαθητές'.";
...
υπάρχουσες κατηγορίες και κάνοντας κλικ στο πλήκτρο 'Προσθήκη'. Στη συνέχεια μπορείτε να πληκτρολογήσετε  τις
πληροφορίες που επιθυμείτε σχετικά με την κατηγορία που επιλέξατε και για να ολοκληρωθεί η προσθήκη των
πληροφοριών πατήστε το πλήκτρο 'Προσθήκη'. Αν τελικά δεν επιθυμείτε να προσθέσετε την κατηγορία που επιλέξατε
...
$langcourseToolsContent = "<p>Αυτό το εργαλείο προσφέρει τη δυνατότητα στον καθηγητή να ενεργοποιήσει και να απενεργοποιήσει τα εργαλεία του μαθήματος. Στην στήλη 'Kατάσταση' παρουσιάζεται η κατάσταση του κάθε εργαλείου , δηλαδή αν είναι ενεργό ή όχι.</p>
<p>Τα εργαλεία μαθήματος μπορούν να βρίσκονται σε τρεις δυνατές καταστάσεις:</p>
<ul>
	<li><input type=\"checkbox\" checked> Ενεργό</li>
	<li><input type=\"checkbox\" checked disabled> Ενεργό χωρίς δυνατότητα απενεργοποίησης (αυτό αφορά τα εργαλεία διαχείρισης του μαθήματος)</li>
	<li><input type=\"checkbox\"> Ανενεργό</li>
</ul>
<p>Για να αλλάξετε την κατάσταση κάποιου εργαλείου κάντε κλικ στο αντίστοιχο checkbox και στη συνέχεια πιέστε το πλήκτρο 'Αποθήκευση αλλαγών' στο τέλος του table.</p>
";
...
$langUsageContent =
"
Εδώ θα γραφτεί το κείμενο Βοήθειας.
";
