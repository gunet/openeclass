...
<ol>
  ...
  <li>Κάντε κλικ στο σύνδεσμο &quot;Καινούρια Aσκηση&quot;.</li>
...
επιλέγοντας το εικονίδιο 'τροποποίηση' ή να διαγράψετε κάποιο γεγονός από την ατζέντα επιλέγοντας το εικονίδιο 'διαγραφή'.</p>$langPHPMathPublisher";
...
<p>Επίσης μπορείτε να αλλάξετε το περιεχόμενο της ανακοίνωσης επιλέγοντας 'Aλλαγή' ή να διαγράψετε μια ανακοίνωση  επιλέγοντας
'Διαγραφή'.</p>$langPHPMathPublisher";
...
υπάρχουσες κατηγορίες και κάνοντας κλικ στο πλήκτρο 'Προσθήκη'.</p><p>Στη συνέχεια μπορείτε να πληκτρολογήσετε  τις πληροφορίες που επιθυμείτε σχετικά με την κατηγορία που επιλέξατε και για να ολοκληρωθεί η προσθήκη των πληροφοριών πατήστε το πλήκτρο 'Προσθήκη'.</p><p>Αν τελικά δεν επιθυμείτε να προσθέσετε την κατηγορία που επιλέξατε πατήστε 'Επιστροφή και Ακύρωση'. Οποιαδήποτε χρονική  στιγμή  σας δίνετε η δυνατότητα να αλλάξετε τις πληροφορίες μιας κατηγορίας επιλέγοντας 'Αλλαγή' ή να διαγράψετε τις πληροφορίες μιας κατηγορίας επιλέγοντας 'Διαγραφή'.</p>$langPHPMathPublisher";
