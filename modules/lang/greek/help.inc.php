...
'Διαγραφή'.</p>";
$langAnnounce_studentContent =  '<p>Το υποσύστημα Ανακοινώσεις επιτρέπει την ενημέρωση των εγγεγραμμένων χρηστών σε θέματα που αφορούν το συγκεκριμένο μάθημα. Παράλληλα επιτρέπει στους υπεύθυνους εκπαιδευτές του μαθήματος να στέλνουν τις ανακοινώσεις με ηλεκτρονικό ταχυδρομείο, στους Εκπαιδευόμενους που είναι εγγεγραμμένοι στο μάθημα. Βασική προϋπόθεση για να λαμβάνετε τα ενημερωτικά μηνύματα είναι να έχετε ορίσει σωστή διεύθυνση email στο προφίλ σας. ("Αλλαγή του Προφίλ μου" στο χαρτοφυλάκιο χρήστη).
.</p>';
