...
$langTooBig="Δεν διαλέξατε κάποιο αρχείο ή το αρχείο είναι πολύ μεγάλο.";
...
$langdate="Ημερομηνία";
$langAreYouSureToDelete = "Είστε βέβαιος ότι θέλετε να διαγράψετε το αρχείο/σύνδεσμο";
