...
$langMultiRegUserInfo = 'Εισαγάγετε στο παρακάτω πεδίο έναν κατάλογο με τα
στοιχεία των χρηστών, μία γραμμή ανα χρήστη που επιθυμείτε να δημιουργηθεί, με
τα στοιχεία στην εξής σειρά: Επώνυμο, όνομα, διεύθυνση ηλεκτρονικού
ταχυδρομείου. Αν επιθυμείτε οι χρήστες να εγγραφούν αυτόματα σε κάποια
μαθήματα, προσθέστε τους κωδικούς τους στο τέλος της γραμμής. Το e-mail είναι
προαιρετικό - αν θέλετε να το παραλείψετε, βάλτε στη θέση του μια παύλα (-).
Οι γραμμές που αρχίζουν από # αγνοούνται.';
...
$langWarningInstall1 = "<b>Προσοχή!</b> Φαίνεται πως η επιλογή register_globals στο αρχείο php.ini δεν είναι ενεργοποιημένη. Χωρίς αυτήν το Open eClass δεν μπορεί να λειτουργήσει. Παρακαλούμε διορθώστε το αρχείο php.ini ώστε να περιέχει τη γραμμή:</p> <p><b>register_globals = On</b></p><p>Πιθανόν επίσης να χρειάζονται και κάποιες άλλες αλλαγές. Διαβάστε τις οδηγίες εγκατάστασης στο αρχείο <a href='$install_info_file'>εδώ</a> και επανεκκινείστε τον οδηγό εγκατάστασης.";
$langWarningInstall2 = "<b>Προσοχή!</b> Φαίνεται πως η επιλογή short_open_tag στο αρχείο php.ini δεν είναι ενεργοποιημένη. Χωρίς αυτήν το Open eClass δεν μπορεί να λειτουργήσει. Παρακαλούμε διορθώστε το αρχείο php.ini ώστε να περιέχει τη γραμμή:</p><p><b>short_open_tag = On</b></p><p>Πιθανόν επίσης να χρειάζονται και κάποιες άλλες αλλαγές. Διαβάστε τις οδηγίες εγκατάστασης στο αρχείο <a href='$install_info_file'>εδώ</a> και επανεκκινείστε τον οδηγό εγκατάστασης.";
$langWarningInstall3 = "<b>Προσοχή!</b> Φαίνεται πως ο οδηγός εγκατάστασης δεν έχει δικαιώματα δημιουργίας του κατάλογου <b>/config</b>.<br/>Χωρίς δικαιώματα δημιουργίας, ο οδηγός εγκατάστασης δεν μπορεί να συνεχίσει. Παρακαλούμε διορθώστε τα δικαιώματα.<br/>Πιθανόν επίσης να χρειάζονται και κάποιες άλλες αλλαγές. Διαβάστε τις οδηγίες εγκατάστασης στο αρχείο <a href='$install_info_file'>εδώ</a> και επανεκκινείστε τον οδηγό εγκατάστασης.";
