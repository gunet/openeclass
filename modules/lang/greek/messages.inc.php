...
$langAreYouSureToRemove = "Σίγουρα θέλετε να αφαιρέσετε την παρακάτω ενότητα απο τη γραμμή μάθησης: ";
...
$langNoModule = "Δεν υπάρχουν ενότητες";
...
$langTrackAllPathExplanation = "Πρόοδος ".$langsOfStudents." στις γραμμές μάθησης";
...
$langUseOfPool = "Αυτή η σελίδα σας επιτρέπει να δείτε όλες τις διαθέσιμες ενότητες στο μάθημα. <br /> Όποια άσκηση ή έγγραφο έχει προστεθεί στη γραμμή μάθησης θα εμφανίζεται παρακάτω.";
