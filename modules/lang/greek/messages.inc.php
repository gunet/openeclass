...
$langInfoAboutRegistration = "Το μάθημα στο οποίο θέλετε να έχετε πρόσβαση είναι κλειστό. Για να εγγραφείτε και εσείς, θα πρέπει
να το ζητήσετε από τον διδάσκοντα του μαθήματος, στέλνοντας σχετικό μήνυμα στη φόρμα που ακολουθεί.<br />
Σμειώστε, ότι θα πρέπει οπωσδήποτε να αναφέρετε το ονοματεπώνυμό σας ή / και το όνομα χρήστη (username), που έχετε στην πλατφόρμα.";
...
$langStartNewTopic = "Μπορείτε να ξεκινήσετε ένα νέο.";
...
$langPollCreated ="<p class='success'>Το Ερωτηματολόγιο δημιουργήθηκε με επιτυχία.<br /><a href=\"questionnaire.php\">Επιστροφή</a></p>";
$langPollEdited ="<p class='success'>Το Ερωτηματολόγιο τροποποιήθηκε με επιτυχία.<br /><a href=\"questionnaire.php\">Επιστροφή</a></p>";
...
$langPollDeleted ="<p class='success'>Το Ερωτηματολόγιο διαγράφηκε με επιτυχία. <br><a href=\"questionnaire.php\">Επιστροφή</a></p>";
...
$langPollSubmitted ="<p class='success'>Ευχαριστούμε για την συμμετοχή σας!<br /><a href=\"questionnaire.php\">Επιστροφή</a></p>";
