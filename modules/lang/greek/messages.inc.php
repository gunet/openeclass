...
$langByDel="Διαγράφοντας το μάθημα θα διαγραφούν μόνιμα όλα τα περιεχόμενά του και όλοι οι ".$langsStudents." που είναι γραμμένοι σε αυτό (δεν θα διαγραφούν από τα άλλα μαθήματα).";
...
$langContactMessage = "Εισαγάγετε το κείμενο του μηνύματός σας. Αυτό θα σταλεί μεσω email στους υπεύθυνους $langsTeachers του μαθήματος.";
...
$dropbox_lang['backList'] = "Επιστροφή στον Χώρο Ανταλλαγής Αρχείων";
...
$langExerciseDone = "Η άσκηση ολοκληρώθηκε. Για να συνεχίσετε, μπορείτε να επιλέξετε την επόμενη ενότητα, κάνοντας κλίκ στο επόμενο βήμα.";
...
$langMediaAlreadyUsed = "Αυτό το πολυμέσο ήδη χρησιμοποιείται σαν ενότητα σε αυτήν τη γραμμή μάθησης";
...
$showall = "Εμφάνιση";
$shownone = "Απόκρυψη";
$langProfNoLinksExist = "Μπορείτε να χρησιμοποιήσετε τις λειτουργίες του εργαλείου για να προσθέσετε σύνδεσμους.";
...
$langPassCannotChange3="Παρακαλούμε επικοινωνήστε με τον διαχειριστή της πλατφόρμας στην διεύθυνση";
...
$langNoForumsCat = "Δεν υπάρχουν περιοχές συζήτησεων σε αυτή την κατηγορία.";
...
$langStudentCannotRegister = "Για να εγγραφείτε σαν χρήστης με δικαιώματα $langsOfStudent, επικοινωνήστε με τους διαχειριστές της πλατφόρμας.";
$langTeacherCannotRegister = "Για να εγγραφείτε σαν χρήστης με δικαιώματα $langsOfTeacher, επικοινωνήστε με τους διαχειριστές της πλατφόρμας.";
...
$langMailVerificationAddrChange = "Αν η διεύθυνση είναι λάθος παρακαλούμε εισαγάγετε την σωστή";
$langMailVerificationSuccess3="Ελέγξτε οτι είναι σωστή η παρακάτω ηλεκτρονικη διεύθυνση και πατήστε στην «<b>$langMailVerificationNewCode</b>»";
...
$langWikiContentEmpty = "Αυτή η σελίδα είναι κενή, κάνε κλικ στο 'Αλλαγή της σελίδας' για να προσθεσεις περιεχομενο";
...
$langWikiDefaultDescription = "Εισαγάγετε την περιγραφή του νέου σας wiki έδω";
...
$langWikiEditConflict = "Αλλαγή διένεξης";
...
vietopic.php
**************************************************************/
$langErrorConnectPostDatabase="Παρουσιάστηκε πρόβλημα. Αδύνατη η σύνδεση με τη βάση δεδομένων των μηνυμάτων.";
