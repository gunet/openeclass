...
$dropbox_lang['noUserSelected'] = "Παρακαλούμε επιλέξτε τον χρήστη στον οποίο θέλετε να σταλεί το αρχείο.";
...
$dropbox_lang['newDropboxFile'] = "Ενημέρωση για καινούριο αρχείο";
...
$langOtherDropBoxFiles = "Λοιπές αποστολές αρχείων";
/**********************************************************
* exercise.php
**********************************************************/
...
$langOpenCoursesMandatoryMetadata = "Υποχρεωτικά Metadata";
$langOpenCoursesLicense = "Άδεια Διάθεσης";
$langOpenCoursesTeacherConfirm = "Δήλωση καθηγητή 100% Διδακτέας Ύλης";
...
$langOpenCoursesTeacherConfirmVideo = "Δήλωση καθηγητή 80% Διαλέξεων";
$langOpenCoursesFiles = "Αρχεία";
$langOpenCoursesIsAMinusLevel = "Είναι Α-";
$langOpenCoursesIsALevel = "Είναι Α";
$langOpenCoursesIsAPlusLevel = "Είναι Α+";
