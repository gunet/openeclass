...
$langByDel="Διαγράφοντας το μάθημα θα διαγραφούν μόνιμα όλα τα περιεχόμενα του και όλοι οι φοιτητές που είναι γραμμένοι σε αυτό (δεν θα διαγραφούν από τα άλλα μαθήματα).";
...
$langRefreshInfo="Προκειμένου να προετοιμάσετε το μάθημα για μια νέα ομάδα φοιτητών μπορείτε να διαγράψετε το παλιό περιεχόμενο.";
...
$langQuestion1= array('Σε αυτή την ενότητα, η προσπάθια μου επικεντρώθηκε σε θέματα που με ενδιέφεραν.'
					,'Σχεδόν ποτέ.'
					,'Σπάνια.'
					,'Μερικές φορές.'
					,'Συχνά.'
...
$langSelectValues="Επιλέξτε μία από τις προκαθορισμένες ερωτήσεις (πρότυπα COLLES/ATTL)...";					
$langUnitInterested="Σε αυτή την ενότητα, η προσπάθια μου επικεντρώθηκε σε θέματα που με ενδιέφεραν.";	
$langUnitProfession="Σε αυτή την ενότητα, αυτά που μαθαίνω έχουν να κάνουν με το επάγγελμά μου.";
$langUnitCritic="Σε αυτή την ενότητα, ασκώ κριτική σκέψη.";
$langUnitColleges="Σε αυτή την ενότητα, συνεργάζομαι με τους συμφοιτητές μου.";	
$langUnitTeaching="Σε αυτή την ενότητα, η διδασκαλία κρίνεται ικανοποιητική.";
$langUnitCommunication="Σε αυτή την ενότητα, υπάρχει σωστή επικοινωνία με τον διδάσκοντα.";
$langUnitThought="Προσπαθώ να βρίσκω λάθη στο σκεπτικό του συνομιλητή μου.";
$langUnitPlace="Όταν συζητώ μπαίνω στην θέση του συνομιλητή μου.";
$langUnitDiscuss="Όταν συζητώ μπαίνω στην θέση του συνομιλητή μου.";
$langUnitAnalice="Μένω αντικειμενικός κατά την ανάλυση καταστάσεων.";
$langunitAdvocate="Μου αρέσει να παίρνω τον ρόλο του συνήγορου του διαβόλου.";
...
* listerqusers.php
**************************************************************/
$langRequestStudent="Η αίτηση του φοιτητή έκλεισε !";
...
* myannouncements.php
**************************************************************/
$langDatabaseProblem="Πρόβλημα στην βάση δεδομένων!";
/*************************************************************
* admin.php
**************************************************************/
$langAlertAdmin="Παρακαλώ συμπληρώστε τουλάχιστον έναν διαχειριστή για το μάθημα!";
