...
στο 'edit last version' για να προσπαθήσετε να προσθέσετε τις αλλαγές σας στην καινούργια έκδοση της σελίδας.</li>
...
$langWikiDefaultDescription = "Πληκτρολογήστε την περιγραφή του νέου σας wiki έδω";
...
$langWikiMainPageContent = "Αυτή είναι η κύρια σελίδα του Wiki %s. Επιλέξτε '''Αλλαγή της σελίδας''' για να τροποποιήσετε το περιεχόμενο.";
