...
$dropbox_lang['backList'] = "Επιστροφή";
...
$dropbox_lang['mailtousers'] = "Να ειδοποιηθούν οι χρήστες";
$dropbox_lang['mailnotify'] = "σας έχει αποσταλλεί ένα καινούριο μήνυμα. Θα το βρείτε στο υποσύστημα 'Ανταλλαγή Μηνυμάτων' αφού προηγουμένως κάνετε login στην πλατφόρμα ή κάνοντας κλικ στο παρακάτω σύνδεσμο:";
...
$langNameOfLang['slovak'] = "Σλοβάκικα";
$charset = 'UTF-8';
...
$langDelF="Η διαγραφή πραγματοποιήθηκε";
...
$langWarnForSubmissions = "ΠΡΟΣΟΧΗ! Αν έχουν υποβληθεί εργασίες, αυτές θα διαγραφούν";
