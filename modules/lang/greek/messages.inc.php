...
$langWarningInstall1 = "<b>Προσοχή!</b> Φαίνεται πως η επιλογή register_globals στο αρχείο php.ini είναι ενεργοποιημένη. Το Open eClass μπορεί να λειτουργήσει και χωρίς αυτή. Για μεγαλύτερη ασφάλεια, παρακαλούμε διορθώστε το αρχείο php.ini ώστε να περιέχει τη γραμμή:</p> <p><b>register_globals = Off</b></p>";
...
$m['this_is_group_assignment'] = 'Η εργασία αυτή είναι ομαδική. Μπορείτε να στείλετε κάποιο υπάρχον αρχείο από';
$m['group_documents'] = 'το χώρο αρχείων της ομάδας σας';
$m['select_publish'] = 'επιλέγοντας «Δημοσίευση» για το αρχείο που θέλετε.';
