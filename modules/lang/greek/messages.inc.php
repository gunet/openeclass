...
$langCourseNotExist = "Ο κωδικός μαθήματοςα δεν υπάρχει";
$langAskManyUsersToCourses = "<strong>Σημείωση</strong>:<br /> Τα μαθήματα θα πρέπει να υπάρχουν και οι χρήστες θα πρέπει να
                έχουν ήδη λογαριασμό στην πλατφόρμα για να εγγραφούν σε αυτά.
                Πληκτρολογήστε τα ονόματα χρήστη (usernames) και τους κωδικούς των μαθημάτων σε ξεχωριστές γραμμές.";
...
$langInfoUnsubscribe = "Μπορείτε να ρυθμίσετε τη λήψη ειδοποιήσεων από τα παρακάτω μαθήματα. Αν δεν επιθυμείτε 
        να δέχεστε e-mails από κάποιο μάθημα, αποεπιλέξτε το και κάντε κλικ στο 'Ύποβολή'. <br />
        (Σημείωση: Δεν απεγγράφεστε από το μάθημα).";
...
$langExplainShib = "Πληκτρολογήστε τα ονόματα των μεταβλητών που επιστρέφει ο εξυπηρέτης Shibboleth. 
        Οι μεταβλητές θα γραφτούν στο αρχείο <em>%ssecure/index.php</em>. Σημειώστε ότι, αν το Shibboleth Canonical Name περιλαμβάνει το ονοματεπώνυμο του χρήστη, τότε θα πρέπει να ορίσετε τον χαρακτήρα που χωρίζει το όνομα από το επώνυμο.";
...
$langCreateCourseStep1Title="Στοιχεία και πληροφορίες μαθήματος";
...
$dropbox_lang['noUserSelected'] = "Παρακαλούμε επιλέξτε χρήστη.";
...
$dropbox_lang['uploadFile'] = "Νέο μήνυμα";
...
$dropbox_lang['tableEmpty'] = "Δεν υπάρχουν μηνύματα";
...
$dropbox_lang['docAdd'] = "Το μήνυμα στάλθηκε με επιτυχία";
$dropbox_lang['fileDeleted'] = "Το επιλεγμένο αρχείο έχει διαγραφεί από το Χώρο Ανταλλαγής Μηνυμάτων.";
$dropbox_lang['backList'] = "Επιστροφή στο Χώρο Ανταλλαγής Μηνυμάτων";
...
$dropbox_lang['mailnotify'] = "σας έχει αποσταλλεί ένα καινούριο μήνυμα. Θα το βρείτε στο υποσύστημα 'Ανταλλαγή Μηνυμάτων' αφού προηγουμένως κάνετε login στην πλατφόρμα.";
$dropbox_lang['newDropboxFile'] = "Ενημέρωση για καινούριο μήνυμα";
...
$langLink="Σύνδεσμος";
$langInvalidLink = "Ο σύνδεσμος (ή η περιγραφή του) είναι κενός ή μη έγκυρος και δεν προστέθηκε!";
...
$langGroupsProperties="Ρυθμίσεις ομάδων χρηστών";
...
$langExpPhpMyAdmin = "Η διανομή του Open eClass <b><u>ΔΕΝ</u></b> περιλαμβάνει πλέον το διαχειριστικό εργαλείο βάσεων δεδομένων MySQL μέσω web <a href=\"http://www.phpmyadmin.net\" target=_blank>phpMyAdmin</a>. 
        Μπορείτε να το εγκαταστήσετε εσείς αν επιθυμείτε.";
...
$lang_case_insensitive_usernames = "Χωρίς διάκριση πεζών/κεφαλαίων στο όνομα χρήστη";
$lang_email_required = "Να είναι υποχρεωτικό το email του $langOfStudent";
...
$lang_dropbox_allow_student_to_student = "Να επιτρέπεται η ανταλλαγή μηνυμάτων μεταξύ $langsOfStudents στο υποσύστημα 'Ανταλλαγή μηνυμάτων'";
...
$langPassEmail1 = "Το συνθηματικό σας έχει οριστεί ξανά με επιτυχία. Το νέο σας συνθηματικό είναι: ";
...
$langPersonalSettingsMore= "Κάντε κλίκ <a href='../../index.php'>εδώ</a> για να εισέλθετε στο προσωπικό σας χαρτοφυλάκιο.
        <br>Εκεί μπορείτε:<ul><li>να περιηγηθείτε στο περιβάλλον της πλατφόρμας και τις προσωπικές σας επιλογές,
        </li><li>να επιλέξετε από τον 'Κατάλογο Μαθημάτων' τα μαθήματα που επιθυμείτε να παρακολουθήσετε.</li><ul>";
...
$langAskManyUsers = "<strong>Σημείωση</strong>:<br /> Οι χρήστες θα πρέπει να
                ...
                Πληκτρολογήστε τα ονόματα χρήστη (usernames) ή τους αριθμούς μητρώου σε ξεχωριστές γραμμές.";
...
$langMailVerificationNotice = "Εάν είναι υποχρεωτική η επιβεβαίωση του e-mail του $langOfUser και η επιβεβαίωση εκκρεμεί, 
        τότε ισχύουν τα παρακάτω μέχρι να ολοκληρωθεί η επιβεβαίωση:<br />
        <ul><li>η πλατφόρμα θα παραπέμπει τον χρήστη στη σελίδα επιβεβαίωσης του e-mail</li>
...
$langWarning = "<em><font color='red'>ΠΡΟΣΟΧΗ!</font></em> Αν επιλέξετε να μην προστεθούν οι χρήστες του μαθήματος και το αντίγραφο ασφαλείας περιέχει υποσυστήματα με πληροφορίες σχετικά με τις ενέργειες των χρηστών, τότε οι πληροφορίες αυτές <b>ΔΕΝ</b> θα ανακτηθούν.";
...
$langExpl2Upgrade = "<ul><li>Για λόγους ασφαλείας βεβαιωθείτε ότι έχετε κρατήσει αντίγραφα ασφαλείας των βάσεων δεδομένων.</li>
                <li>Επίσης η τρέχουσα διανομή του Open eClass <b><u>ΔΕΝ</u></b> περιλαμβάνει πλέον το διαχειριστικό εργαλείο 
                βάσεων δεδομένων phpMyAdmin. Μπορείτε να αντιγράψετε το φάκελο (path του eclass)/modules/admin/mysql/ 
                σε μια προσωρινή τοποθεσία (π.χ. /tmp) και μετά την αναβάθμιση να το επαναφέρετε στην προηγούμενη θέση.
                Εναλλακτικά μπορείτε να κατεβάσετε την τελευταία έκδοση από <a href=\"http://www.phpmyadmin.net\" target=_blank>εδώ</a>.</li></ul>";
...
$langReregisterImpossible = "Θέλετε σίγουρα να απεγγραφείτε από το μάθημα; Το μάθημα είναι κλειστό και δε θα μπορείτε να επανεγγραφείτε.";
...
********************************************************************/
 ...
 $langOldStatsExpl = "Συγκεντρωτικά μηνιαία στατιστικά στοιχεία <u>παλιότερα των δεκατεσσάρων μηνών</u>.";
 $langOldStatsLoginsExpl = "Συγκεντρωτικά μηνιαία στατιστικά σχετικά με τις εισόδους στην πλατφόρμα παλιότερα των δεκατεσσάρων μηνών.";
 $langOldStatsExpireConfirm = "Επιβεβαίωση επίσκεψης παλαιότερων στατιστικών. Συνεπάγεται δημιουργία συγκεντρωτικών εγγραφών για στατιστικά παλαιότερα των δεκατεσσάρων μηνών. Επιθυμείτε να συνεχίσετε;";
...
$langOnBehalfOf = 'Εκ μέρους του χρήστη';
...
$license = array(
    ...
    '4' => array('title' => $langCreativeCommonsCCBYNC, 'link' => 'http://creativecommons.org/licenses/by-nc/3.0/', 'image' => 'cc/by-nc'),
    '5' => array('title' => $langCreativeCommonsCCBYNCSA, 'link' => 'http://creativecommons.org/licenses/by-nc-sa/3.0/', 'image' => 'cc/by-nc-sa'),
    '6' => array('title' => $langCreativeCommonsCCBYNCND, 'link' => 'http://creativecommons.org/licenses/by-nc-nd/3.0/', 'image' => 'cc/by-nc-nd'),
