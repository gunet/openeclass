...
$langErrorDataOne="Λάθος στην ανάκτηση των στοιχείων από τη βάση δεδομένων (1)";
$langErrorDataTwo="Λάθος στην ανάκτηση των στοιχείων από τη βάση δεδομένων (2)";
$langUnableUpadatePost="Αδύνατο να ανανέωθεί το μυνημά σας στη βάση δεδομένων ";
$langUnableUpadateTopic="Αδύνατο να ανανέωθεί το θέμα σας στη βάση δεδομένων";
$langUnableDeletePost="Αδύνατο να διαγραφεί το μύνημα σας απο τη βάση δεδομένων";
$langPostRemoved="Αδύνατο να ανανέωθει το προηγούμενο μύνημα σας - το τελευταίο μηνημα έχει μεταφερθεί ";
...
$langErrorTopicSelect="Error - Το φόρουμ/θέμα που επιλέξατε δεν υπάρχει. Παρακαλώ επιστρέψτε και προσπαθήστε πάλι.";
...
$langErrorDataForum="Τα δεδομένα του forum δεν έιναι διαθέσιμα.";
$langErrorPost="Το φόρουμ που προσπαθείτε να συμετάσχετε δεν υπάρχει. Παρακαλώ προσπαθήστε πάλι.";
...
vietopic.php
**************************************************************/
$langErrorConnectPostDatabase="Παρουσιάστηκε πρόβλημα. Αδύνατη η σύνδεση με τη βάση δεδομένων τών μυνημάτων .";
