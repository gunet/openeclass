...
$dropbox_lang['mailnotify'] = "σας έχει αποσταλλεί ένα καινούριο αρχείο ή μήνυμα. Θα το βρείτε στο υποσύστημα 'Ανταλλαγή Αρχείων' αφού προηγουμένως κάνετε login στην πλατφόρμα.";
