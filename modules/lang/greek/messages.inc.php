...
$langContactMessage = "Εισάγετε το κείμενο του μηνύματός σας. Αυτό θα σταλεί μεσω email στους υπεύθυνους $langsTeachers του μαθήματος.";
...
$langAuthorHelp = "Συμπληρώστε τα ονόματα των συγγραφέων του μαθησιακού αντικειμένου (έως 10 ονόματα)";
$langLanguageHelp = "Επιλέξτε τη γλώσσα που χρησιμοποιείται στο μαθησιακό αντικείμενο";
$langLearningResourceTypeHelp = "Συμπληρώστε το είδος του μαθησιακού αντικειμένου (έως 10 τιμές). Ενδεικτικά: Άσκηση, προσομοίωση, ερωτηματολόγιο, διάγραμμα, σχήμα, γράφημα, ευρετήριο, διαφάνεια, πίνακας, αφηγηματικό κείμενο, διαγώνισμα, πείραμα, διατύπωση προβλήματος, αυτοαξιολόγηση, διάλεξη";
$langKeywordsHelp = "Δώστε έως 10 λέξεις κλειδιά ή φράσεις που περιγράφουν το μαθησιακό αντικείμενο";
$langTopicHelp = "Σημειώστε το γνωστικό αντικείμενο στο οποίο προτείνετε να αξιοποιηθεί το μαθησιακό αντικείμενο. Πχ. Φησική, Χημεία, Ιστορία";
$langSubTopicHelp = "Εφόσον κρίνετε σκόπιμο σημειώστε επιπλέον εξειδίκευση του γνωστικού αντικειμένου: πχ Ηλεκτρομαγνητισμός";
$langLevelHelp = "Σημειώστε το περιβάλλον όπου προτείνετε να αξιοποιηθεί το μαθησιακό αντικείμενο. Πχ. Δημοτικό, Γυμνάσιο, Λύκειο, ΤΕΕ, Ειδική Αγωγή (έως 10 τιμές)";
$langTypicalAgeRangeHelp = "Σημειώστε την ηλικία του τυπικού στοχευμένου χρήστη σε ηλικιακές ομάδες πχ. 5-7, 0-5, 18-25 (έως 5 τιμές)";
$langCommentHelp = "Σημειώστε σχόλια ή οδηγίες για την εκπαιδευτική χρήση αυτού του μαθησιακού αντικειμένο";
...
$langIntentedEndUserRoleHelp = "Σημειώστε ποιός είναι ο κύριος χρήστης ή η ομάδα χρηστών για τους οποίους σχεδιάστηκε αυτό το μαθησιακό αντικείμενο, με πρώτο το πλέον βασικό. Πχ. μαθητής, δάσκαλος, κλπ (έως 5 στοιχεία)";
...
$langAccountNotFound2 = "Αν παρόλα αυτά είστε σίγουρος/η ότι έχετε ήδη λογαριασμό, παρακαλούμε επικοινωνήστε με τους διαχειριστές της πλατφόρμας στη διεύθυνση ";
...
$langPassCannotChange3="Παρακαλούμε, επικοινωνήστε με το διαχειριστή της πλαφόρμας στην διεύθυνση";
...
$langStartNewTopic = "Καντε κλικ για να δημιουργήσετε ένα νέο.";
...
$langCaptchaWrong="Ο κωδικός ασφαλείας που έχετε εισάγει είναι λάθος.";
$langTipCaptcha = "Πληκτρολογήστε τον κωδικό ασφάλειας που εμφανίζεται";
...
$langLoginRequired = '
		<p class=\"caution\"><b>Δεν είστε εγγεγραμμένος στο μάθημα και επομένως δεν μπορείτε να χρησιμοποιήσετε το αντίστοιχο υποσύστημα.</b>
		Η πλατφόρμα σας ανακατεύθυνε αυτόματα στην αρχική σελίδα
		για να εγγραφείτε στο μάθημα, αν η εγγραφή είναι ελεύθερη. </p>
';
$langSessionIsLost = "
		<p class=\"alert1\"><b>Η σύνοδος σας έχει λήξει. </b><br/>Η πλατφόρμα σας ανακατεύθυνε αυτόματα στην αρχική σελίδα
		για να συνδεθείτε προτού προχωρήσετε σε άλλες ενέργειες.</p>
			";
$langCheckProf = "
		<p class=\"caution\"><b>Η ενέργεια που προσπαθήσατε να εκτελέσετε απαιτεί δικαιώματα καθηγητή. </b><br/>
		Η πλατφόρμα σας ανακατεύθυνε αυτόματα στην αρχική σελίδα
		για να συνδεθείτε ξανά.</p>
";
$langLessonDoesNotExist = "
	<p class=\"caution\"><b>Το μάθημα που προσπαθήσατε να προσπελάσετε δεν υπάρχει.</b><br/>
	Αυτό μπορεί να συμβαίνει γιατί εκτελέσατε μια μη επιτρεπτή ενέργεια ή λόγω τεχνικού προβλήματος
	στην πλατφόρμα.</p>
";
$langCheckAdmin = "
		<p class=\"caution\"><b>Η ενέργεια που προσπαθήσατε να εκτελέσετε απαιτεί δικαιώματα διαχειριστή. </b><br/>
		Η πλατφόρμα σας ανακατεύθυνε αυτόματα στην αρχική σελίδα
		για να συνδεθείτε, εάν είστε ο διαχειριστής της πλατφόρμας.</p>
";
$langCheckGuest = "
		<p class=\"caution\"><b>Η ενέργεια που προσπαθήσατε να εκτελέσετε δεν είναι δυνατή με δικαιώματα επισκέπτη χρήστη. </b><br/>
		Για λόγους ασφάλειας η πλατφόρμα σας ανακατεύθυνε αυτόματα στην αρχική σελίδα
		για να συνδεθείτε ξανά.</p>
";
$langCheckPublicTools = "
		<p class=\"caution\"><b>Προσπαθήσατε να αποκτήσετε πρόσβαση σε απενεργοποιημένο εργαλείο μαθήματος. </b><br/>
		Για λόγους ασφάλειας η πλατφόρμα σας ανακατεύθυνε αυτόματα στην αρχική σελίδα
		για να συνδεθείτε ξανά.</p>
";
