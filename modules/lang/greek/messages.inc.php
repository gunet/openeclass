...
$langAlertBlockingPathMadeInvisible = "Αυτή η γραμμή ειναι φραγμένη. Κάνοντας την μη ορατή θα επιτραπεί στους ".$langsOfStudentss." η είσοδος στην επόμενη γραμμή χωρίς να χρειάζεται να ολοκληρώσουν την παρούσα. Επιβεβαιώστε την επιλογή σας";
...
$langSubmissions = "Εργασίες ".$langsOfStudents." που έχουν υποβληθεί";
