...
$langLearningResourceTypeHelp = "Συμπληρώστε το είδος του μαθησιακού αντικειμένου (έως 10 τιμές, ο διαχωρισμός γίνεται με το κόμμα). Ενδεικτικά: Άσκηση, προσομοίωση, ερωτηματολόγιο, διάγραμμα, σχήμα, γράφημα, ευρετήριο, διαφάνεια, πίνακας, αφηγηματικό κείμενο, διαγώνισμα, πείραμα, διατύπωση προβλήματος, αυτοαξιολόγηση, διάλεξη";
...
$langLevelHelp = "Σημειώστε το περιβάλλον όπου προτείνετε να αξιοποιηθεί το μαθησιακό αντικείμενο (έως 10 τιμές, ο διαχωρισμός γίνεται με το κόμμα). Πχ. Δημοτικό, Γυμνάσιο, Λύκειο, ΤΕΕ, Ειδική Αγωγή";
...
$langIntentedEndUserRoleHelp = "Σημειώστε ποιός είναι ο κύριος χρήστης ή η ομάδα χρηστών για τους οποίους σχεδιάστηκε αυτό το μαθησιακό αντικείμενο, με πρώτο το πλέον βασικό (έως 5 στοιχεία, ο διαχωρισμός γίνεται με το κόμμα). Πχ. μαθητής, δάσκαλος, κλπ";
...
$langUserAltAuth = "Το όνομα χρήστη με το οποίο προσπαθήσατε να συνδεθείτε χρησιμοποιεί διαφορετικό τρόπο πιστοποίησης.";
