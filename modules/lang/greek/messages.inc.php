...
$langAddForums="Για να προσθέσετε περιοχές συζητήσεων, κάντε κλίκ στο εικονίδιο «Διαχείριση περιοχών συζητήσεων»
της αντίστοιχης κατηγορίας. Σημειώστε ότι, αν σε μια κατηγορία δεν έχουν οριστεί περιοχές συζητήσεων, τότε δεν θα εμφανίζεται στους ".$langsOfStudentss." ";
