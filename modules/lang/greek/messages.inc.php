...
$lang_pass_invalid_mail = 'Η διεύθυνση ηλεκτρονικού ταχυδρομείου που δώσατε δεν είναι έγκυρη.';
...
$langWikiConflictHowTo = "<p><strong>Αλλάξτε τη σύγκρουση</strong> : Η σελίδα που πρσπαθείς φαίνεται ότι έχει αλλάξει από τον καιρό που την άλλαξες.<br /><br />
