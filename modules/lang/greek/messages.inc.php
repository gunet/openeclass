...
$langExerciseCancelled = "Η άσκηση ακυρώθηκε. Για να συνεχίσετε, μπορείτε να επιλέξετε την επόμενη ενότητα, κάνοντας κλίκ στο επόμενο βήμα.";
...
$langMediaInsertedAsModule = "Έχει προστεθεί σαν ενότητα μαθήματος αυτής της γραμμής μάθησης";
...
$langGiveRightTutor="Προσθήκη δικαίωματος υπεύθυνου ομάδας";
$langGiveRightΕditor="Προσθήκη δικαίωματος βοηθού εκπαιδευτή";
$langGiveRightAdmin="Προσθήκη δικαίωματος εκπαιδευτή";
$langRemoveRightTutor="Αφαίρεση δικαίωματος υπεύθυνου ομάδας";
$langRemoveRightEditor="Αφαίρεση δικαίωματος βοηθού εκπαιδευτή";
$langRemoveRightAdmin="Αφαίρεση δικαίωματος εκπαιδευτή";
...
$langUserMergeForbidden = "Δεν είναι δυνατή η ενοποίηση $langsOfTeachers με μη-$langsTeachers. Παρακαλώ επιλέξτε κάποιον άλλο χρήστη.";
...
$langUnableUpdateTopic="Αδύνατο να ανανέωθεί το θέμα σας στη βάση δεδομένων";
