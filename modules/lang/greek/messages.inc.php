...
$langNodeAdd="Προσθήκη Σχολής - Τμήματος";
...
$langNodeProErase="Υπάρχουν μαθήματα που ανήκουν σε αυτή τη σχολή - τμήμα!";
...
$langEmptyNodeSelect="Παρακαλώ κάντε μια επιλογή από τη λίστα και μετά επιλέξτε Προσθήκη";
