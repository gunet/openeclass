...
$langCheckCourseAdmin = "
                <p class=\"caution\"><b>Η ενέργεια που προσπαθήσατε να εκτελέσετε απαιτεί δικαιώματα διαχειριστή μαθήματος. </b><br/>
		Η πλατφόρμα σας ανακατεύθυνε αυτόματα στην αρχική σελίδα
		για να συνδεθείτε ξανά.</p>";
...
$langCheckAdmin = "
		...
		για να συνδεθείτε ξανά.</p>";
$langCheckPowerUser = "
		<p class=\"caution\"><b>Η ενέργεια που προσπαθήσατε να εκτελέσετε απαιτεί δικαιώματα διαχειριστή χρηστών και μαθημάτων. </b><br/>
		Η πλατφόρμα σας ανακατεύθυνε αυτόματα στην αρχική σελίδα
		για να συνδεθείτε ξανά.</p>";
$langCheckGuest = "
