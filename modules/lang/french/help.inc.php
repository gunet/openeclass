...
$langPHPMathPublisher = "<p><u>Mathematic symbols support</u>
<br />
For the incorporation of mathematic symbols in your texts, you can use the <a href='../../manuals/PhpMathPublisherHelp.pdf' target='_blank'>commands</a> (symbolisms) provided by PhpMathPublisher.<br />
More specifically, you may use the text editor in order to insert your content. If within the content you import there are any mathematic symbols you wish to present, then:
<ol>
...
$langHPortfolio = "Portfolio d'utilisateur";
...
$langHcourse_home = 'Page principale du cours';
$langHcourse_home_student = $langHcourse_home;
$langcourse_home_studentContent = "<p>Vous êtes actuellement sur la page centrale du cours en ligne. Par le biais des options proposées dans le menu gauche de l'écran, vous pourrez accéder aux sous-systèmes disponibles, activés par les enseignants du cours.</p>";
...
$langHGroup = "Groupes d'utilisateurs";
...
<hr noshade size=1>";
$langGroup_studentContent = "<p>Un groupe d'utilisateurs est un <b>ensemble</b> d'utilisateurs inscrits au module qui se partagent le même espace de discussions ainsi que le même espace de chargement de fichiers et de devoirs. Le sous-système 'Groupes d'utilisateurs' permet la collaboration et l'interactivité des formés à travers leur organisation en groupes. De cette manière, l'apprentissage collaboratif est renforcé, bon nombre de questions sont répondus et des points de vue sont échangés sur des sujets bien précis du module. Les données d'un groupe tels le responsable du groupe, le nombre d'utilisateurs inscrits, le maximum d'utilisateurs autorisés au groupe sont disponibles ce qui vous permet d'avoir une meilleure information sur le groupe.</p>";
$langHAgenda = "Agenda";
...
$langHImport = "Téléverser une page html";
...
";
$langHInfocours = "Gestion du cours";
...
$langHAddCourseUnits = "Ajouter/Modifier une unité thématique";
$langAddCourseUnitsContent = "<p class='helptopic'> Pour ajouter une nouvelle unité thématique, veuillez insérer son intitulé et une courte description. Cliquez sur le bouton 'Ajouter' pour créer la nouvelle unité thématique.</p>";
