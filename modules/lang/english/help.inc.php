...
<li><b>Wiki Title</b>: choose a title for the Wiki</li> <li><b>Wiki Description</b>: choose a description for the Wiki</li> <li><b>Access control management</b>: set the Wiki access control by checking/uncheking the box (see below)</li> </ul> <p>To enter a Wiki click on the Wiki title from the list.</p> <p>To change the properties of a Wiki click on the icon <img src="../../template/classic/img/edit.png" align="absmiddle" border="0">.</p>  <p>To delete a Wiki click on the icon <img src="../../template/classic/img/delete.gif" align="absmiddle" border="0"></p>  <p>To get the list of the last modified pages click on the link "Recent changes".</p>
