...
$langWarningInstall1 = "<b>Warning!</b> It seems that the option <em>register_globals</em> of php.ini is enabled, while it should be disabled for the  platform to function properly. Please modify php.ini accordingly (i.e.: <b>register_globals = Off</b>).";
...
$langInsert = "Insert";
$langAnnMod = 'The announcement has been modified';
...
$lang_disable_log_user_actions = 'Disable detailed user action logging';
$langPassShort = 'Password is too short: it must be at least %d characters long';
...
$langSubmissionError = "Non-existent assignment";
