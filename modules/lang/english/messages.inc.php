...
$langUpgSucNotice = "If an error occured, you may encounter problems.<br>
In such case, please contact us at <a href='mailto:info@openeclass.org'>info@openeclass.org</a> describing exactly the problem<br>, including (if possible) all error messages.";
...
$langInfoAboutRegistration = "You are trying to access a closed course. To register, you need to contact the course instructor.<br />
Please note that you should mention your full name or username on the platform so that the instructor can register you to the course.";
...
$langStartNewTopic = "You can start a new one.";
