...
$langWarningInstall1 = "<b>Warning!</b> It seems that the option register_globals of php.ini is not set. Without it Open eClass cannot run. Please modify php.ini </p> <p>(e.g.: <b>register_globals = On</b>).</p><p>Probably some other changes are required. Read the installation instructions in <a href='$install_info_file'>here</a> and restart installation wizard again.";
$langWarningInstall2 = "<b>Warning!</b> It seems that the option short_open_tag of php.ini is not set. Without it Open eClass cannot run. Please modify php.ini </p> <p>(e.g.: <b>short_open_tag = On</b>).</p><p>Probably some other changes are required. Read the installation instructions in <a href='$install_info_file'>here</a> and restart installation wizard again.";
$langWarningInstall3 = "<b>Warning!</b> It seems that installation wizard has not creation rights of directory <b>/config</b>.<br/>Without creation rights, installation wizard cannot continue. Please change creation rights.<p>Probably some other changes are required. Read the installation instructions in <a href='$install_info_file'>here</a> and restart installation wizard again.";
