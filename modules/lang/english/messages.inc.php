...
$langMultiRegCourseInvalid = 'Users: invalid course code "%s"';
...
$langCleaningUp = 'Cleaning up files older thans %s from the %s directory ';
$langDaySing = 'day';
$langDayPlur = 'days';
...
$dropbox_lang['backList'] = 'Back in the Message Exchange';
...
$langOr = "or";
$langNote = "Note";
$langAcrobat = "In order to read PDF files, you can usesAcrobat Reader%s or %sother free software available here%s.";
...
$langUserMergeLegend = 'Merging users with...';
...
$langMailVerificationError = "An error occured during sending the message to addresss.<br/><br/>Please <a href='%s'>try again</a> or contact the platform administrator at: %s";
...
$charset = 'UTF-8';
$dateFormatShort = "%bd, %y";
$dateFormatLong = '%AB %e, %Y';
$dateTimeFormatLong = '%Bd, %Y at %I:%M %p';
$timeNoSecFormat = '%I:%Mp';
...
$langWikiDifferencePattern = "differences between version1\$s modified by %2\$s and version %3\$s modified by %4\$s";
...
$langWikiRecentChangesPattern = "%1\$s modified on2\$s by %3\$s";
...
$langWikiVersionInfoPattern = "(version of1\$s modified by %2\$s)";
$langWikiVersionPattern = "%1\$s by2\$s";
$lang_footer_p_CourseManager = "Manager(s) fors";
$lang_p_platformManager = "Administrator fors";
...
$langSubmissionDescr = "%s, ons, submitted a file named \"%s\".";
