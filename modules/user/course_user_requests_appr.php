...
$sql_rej = Database::get()->queryArray("SELECT * FROM course_user_request WHERE course_id = ?d AND status = 2 ORDER BY ts DESC", $course_id);
...
if ($sql_rej) {
    ...
    $tool_content .= "<th style='width:20%;'>$langSurnameName</th><th style='width:36%;'>$langComments</th><th style='width:22%;'>$langDateRequest</th><th style='width:22%;'>$langDateAccept</th>";
