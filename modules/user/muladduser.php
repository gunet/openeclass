...
if (isset($add)) {
	...
	echo "</td></tr><tr><td><a href=\"adduser.php\">$langAddBack</a></td></tr>\n";
} else {

?>
	<tr><td><font size="2"><?= $langAskManyUsers ?></td></font></tr>
	<tr><td>&nbsp;</td></tr>
	<tr><td><font size="2"><?= $langAskManyUsers2 ?></td></font></tr>
	<tr><td>
	<table>	
    	<form method="post" action="<?= $_SERVER['PHP_SELF'] ?>" enctype="multipart/form-data">
	<tr><td><font size="2"><?= $langAskUserFile ?></td<td><input type="file" name="users_file"></td></font></tr> 
	<tr><td>&nbsp;</td></tr>
	<tr><td><input type="submit" value="<?= $langOk ?>"></td></tr>
	</form>
	</table>	
	</td></tr>
	<tr><td>
