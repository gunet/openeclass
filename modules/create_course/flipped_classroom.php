...
$toolName = "$langCourseCreate - $langFlippedClassroom";
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.btn_remove', function() {
            ...
            if (buttonName=="remove_g"){
                var confirm = window.confirm('$langConfirmDelete');
                if(confirm){
                ...
                <form class='form-horizontal' role='form' method='post' name='createform' action='$_SERVER[SCRIPT_NAME]'>
                    <fieldset>
                        ...
                        <div class='form-group mt-4'>
                            ...
                            <div class='col-sm-12'>
                                  " .  rich_text_editor('description', 4, 20, purify($_SESSION['description']), options: array('id' => 'description')) . "
                            </div>
                        </div>
                        <div class='form-group mt-4'>
                        ...
                        <div class='form-group mt-4'>
                            <div class='col-12 d-inline-flex mb-2'>
                                <div class='control-label-notes me-2'>$langCourseUnits</div>
                            </div>
                            <div id='row_u_1' class='col-12 d-inline-flex'>
                                <label for='unit_1' id='utitle_1' class='control-label-notes text-nowrap'></label>
                                <input name='units[]' id='unit_1' type='text' class='form-control w-100 ms-2' value='"."' placeholder='$langCourseUnits'>
