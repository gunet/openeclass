...
elseif (isset($_GET['forumgosave'])) {
    ...
    Indexer::queueAsync(ConstantsUtil::REQUEST_STORE, ConstantsUtil::RESOURCE_FORUM, $forum_id);
...
elseif (isset($_GET['forumgoadd'])) {
    ...
    Indexer::queueAsync(ConstantsUtil::REQUEST_STORE, ConstantsUtil::RESOURCE_FORUM, $forid);
