...
class RestoreHelper {
    ...
    private function populateTypes() {
        ...
        $this->types[self::STYLE_3X]['tc_servers']['max_rooms'] = '?d';
        $this->types[self::STYLE_3X]['tc_servers']['max_users'] = '?d';
        $this->types[self::STYLE_3X]['tc_servers']['weight'] = '?d';
        $this->types[self::STYLE_3X]['tc_session']['course_id'] = '?d';
        $this->types[self::STYLE_3X]['tc_session']['start_date'] = '?t';
        $this->types[self::STYLE_3X]['tc_session']['running_at'] = '?d';
        $this->types[self::STYLE_3X]['tc_session']['unlock_interval'] = '?d';
        $this->types[self::STYLE_3X]['tc_session']['sessionUsers'] = '?d';
