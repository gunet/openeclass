    ...
    if (count($result) == 0) {
        ...
        if (count($sql) > 0) {
            foreach ($sql as $catrow) {
                ...
                $ret_string .= "<td class='text-center'><label class='label-container'><input type='checkbox' name='catlink[]' value='$catrow->id' /><span class='checkmark'></span></label></td>";
                $ret_string .= "</tr>";
                ...
                foreach ($sql2 as $linkcatrow) {
                    ...
                    $ret_string .= "<td class='text-center'><label class='label-container'><input type='checkbox' $checked name='link[]' value='$linkcatrow->id' /><span class='checkmark'></span></label></td>";
                    $ret_string .= "</tr>";
                }
            }
        }
        ...
        if (count($linkinfo) > 0) {
            ...
            foreach ($linkinfo as $entry) {
                ...
                $ret_string .= "<tr>" .
                    ...
                    "<td class='text-center'><label class='label-container'><input type='checkbox' $checked name='link[]' value='$entry[id]' /><span class='checkmark'></span></label></td>";
                "</tr>";
            }
        }
