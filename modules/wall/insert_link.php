        ...
        if (count($sql) > 0) {
            foreach ($sql as $catrow) {
                ...
                foreach ($sql2 as $linkcatrow) {
                    ...
                    $ret_string .= "<td class='text-center'><input type='checkbox' $checked name='link[]' value='$linkcatrow->id' /></td>";
                    $ret_string .= "</tr>";
                }
            }
        }
        ...
        if (count($linkinfo) > 0) {
            ...
            foreach ($linkinfo as $entry) {
                ...
                $ret_string .= "<tr>" .
                    ...
                    "<td class='text-center'><input type='checkbox' $checked name='link[]' value='$entry[id]' /></td>";
                "</tr>";
            }
        }
