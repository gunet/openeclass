...
if (isset($_GET['showPost'])) { //show comments case
    ...
    if (allow_to_edit($id, $uid, $is_editor)) {
        ...
        if ($is_editor || visible_module(MODULE_ID_VIDEO)) {
            ...
            $video_li = '<li class="nav-item"><a id="nav_edit_video" class="nav-link" data-bs-toggle="tab" href="#videos_div" role="tab" aria-controls="videos_div" tabindex="-1">'.$langVideo.'</a></li>';
        } else {
            $video_div = '';
            $video_li = '';
        }
        ...
        if ($is_editor || visible_module(MODULE_ID_DOCS)) {
            ...
            $docs_li = '<li class="nav-item"><a id="nav_edit_docs" class="nav-link" data-bs-toggle="tab" href="#docs_div" role="tab" aria-controls="docs_div" tabindex="-1">'.$langDoc.'</a></li>';
        } else {
            $docs_div = '';
            $docs_li = '';
        }
        ...
        if (($post_author == $uid) && (($is_editor && get_config('mydocs_teacher_enable')) || (!$is_editor && get_config('mydocs_student_enable')))) {
            ...
            $mydocs_li = '<li class="nav-item"><a id="nav_edit_mydocs" class="nav-link" data-bs-toggle="tab" href="#mydocs_div" role="tab" aria-controls="mydocs_div" tabindex="-1">'.$langMyDocs.'</a></li>';
        } else {
            $mydocs_div = '';
            $mydocs_li = '';
        }
        ...
        if ($is_editor || visible_module(MODULE_ID_LINKS)) {
            ...
            $links_li = '<li class="nav-item"><a id="nav_edit_links" class="nav-link" data-bs-toggle="tab" href="#links_div" role="tab" aria-controls="links_div" tabindex="-1">'.$langLinks.'</a></li>';
        } else {
            $links_div = '';
            $links_li = '';
        }
        ...
        if((isset($is_collaborative_course) and !$is_collaborative_course) or is_null($is_collaborative_course)){
            if ($is_editor || visible_module(MODULE_ID_EXERCISE)) {
                ...
                $exercises_li = '<li class="nav-item"><a id="nav_edit_exercises" class="nav-link" data-bs-toggle="tab" href="#exercises_div" role="tab" aria-controls="exercises_div" tabindex="-1">'.$langExercises.'</a></li>';
            } else {
                $exercises_div = '';
                $exercises_li = '';
            }
        ...
        if((isset($is_collaborative_course) and !$is_collaborative_course) or is_null($is_collaborative_course)){
            if ($is_editor || visible_module(MODULE_ID_ASSIGN)) {
                ...
                $assignments_li = '<li class="nav-item"><a id="nav_edit_assigments" class="nav-link" data-bs-toggle="tab" href="#assignments_div" role="tab" aria-controls="assignments_div" tabindex="-1">'.$langWorks.'</a></li>';
            } else {
                $assignments_div = '';
                $assignments_li = '';
            }
        ...
        if ($is_editor || visible_module(MODULE_ID_CHAT)) {
            ...
            $chats_li = '<li class="nav-item"><a id="nav_edit_chats" class="nav-link" data-bs-toggle="tab" href="#chats_div" role="tab" aria-controls="chats_div" tabindex="-1">'.$langChat.'</a></li>';
        } else {
            $chats_div = '';
            $chats_li = '';
        }
        ...
        if ($is_editor || visible_module(MODULE_ID_QUESTIONNAIRE)) {
            ...
            $polls_li = '<li class="nav-item"><a id="nav_edit_polls" class="nav-link" data-bs-toggle="tab" href="#polls_div" role="tab" aria-controls="polls_div" tabindex="-1">'.$langQuestionnaire.'</a></li>';
        } else {
            $polls_div = '';
            $polls_li = '';
        }
        ...
        if ($is_editor || visible_module(MODULE_ID_FORUM)) {
            ...
            $forums_li = '<li class="nav-item"><a id="nav_edit_forums" class="nav-link" data-bs-toggle="tab" href="#forums_div" role="tab" aria-controls="forums_div" tabindex="-1">'.$langForum.'</a></li>';
        } else {
            $forums_div = '';
            $forums_li = '';
        }
                            ...
                            <div class="panel panel-default mt-3 border-0">
                                <div class="panel-body border-0">
                                    <ul class="nav nav-tabs border-0" role="tablist">
                                        <li class="nav-item"><a id="nav_edit_extvideo" class="nav-link active" data-bs-toggle="tab" href="#extvideo_video_div" role="tab" aria-controls="extvideo_video_div" tabindex="0">'.$langWallExtVideo.'</a></li>
                                        '.$video_li.'
                                        '.$docs_li.'
                                        '.$mydocs_li.'
                                        '.$links_li.'
