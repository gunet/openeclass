...
global $cookie;
    ...
    $profadm=mysql_query("select Username from cours where code_cours='$dbname' AND Username='$cookie[1]'");
    while ($myprof = mysql_fetch_array($profadm)) {
    $prof=$myprof[0];
    }
...
?>
<TR>                    
        <TD ALIGN="CENTER" WIDTH="50%" ROWSPAN="2"><br>
			</TD>
<?php
...
?>
	<TD ALIGN="CENTER">
		<FONT FACE="<?php echo $FontFace?>" SIZE="<?php echo $FontSize4?>" COLOR="<?php echo $textcolor?>"><?php echo "$sitename"?></font>
	</TD>
<?php
	break;
