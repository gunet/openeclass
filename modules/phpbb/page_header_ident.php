...
echo "<center><table border=0 width=\"600\" cellpadding=\"3\" align=\"center\"><tr><td colspan=\"2\">";
include('../cours/settings.php');
$cheminpage="<a href=../$dbname/index.php>$intitule</a>&nbsp;&gt;&nbsp;<b>S'identifier</b>";
...
?>
<TR>                    
        <TD ALIGN="left" WIDTH="50%" ROWSPAN="2"><h2>S'identifier</h2>
			</TD>
<?php
...
?>
	<TD ALIGN="CENTER">
		<FONT FACE="<?php echo $FontFace?>" SIZE="<?php echo $FontSize2?>" COLOR="<?php echo 
$textcolor?>"><b>Υποβολή νέου θέματος στο:<BR>
