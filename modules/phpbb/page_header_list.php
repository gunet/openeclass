...
$cheminpage="<a href=../$dbname/index.php>$intitule</a>&nbsp;&gt;&nbsp;<b>Liste des Ètudiants enregistrÈs</b>";
...
?>
<TR>                    
        <TD ALIGN="left" WIDTH="50%" ROWSPAN="2"><h2>Liste des Ètudiants enregistrÈs</h2>
			</TD>
<?php
...
?>
	<TD ALIGN="CENTER">
		<FONT FACE="<?php echo $FontFace?>" SIZE="<?php echo $FontSize2?>" COLOR="<?php echo $textcolor?>"><b>’Ô‚ÔÎﬁ 
Ì›Ôı Ë›Ï·ÙÔÚ ÛÙÔ:<BR>
