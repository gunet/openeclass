...
if (!$conference_activity) {
    ...
    if ($is_editor && $conference_agent && $agent_id && !isset($_GET['create_agent']) && !isset($_GET['edit_agent'])) {
        ...
        if ($laSessionId && $laSessionToken) {
            ...
            $colmooc_teacher_la_url = COLMOOC_ANALYTICS_URL . "/?lasession_id=" . $laSessionId . "&lasession_token=" . $laSessionToken;
        }
        ...
        if ($laSessionId && $laSessionToken) {
            ...
            $colmooc_student_la_url = COLMOOC_ANALYTICS_URL . "/?lasession_id=" . $laSessionId . "&lasession_token=" . $laSessionToken;
        }
    }
