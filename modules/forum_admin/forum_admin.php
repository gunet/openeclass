...
if($is_adminOfCourse) {
	...
	<th>$langActions</th></tr></thead></tbody>";
	...
	$tool_content .= "<td align='center'><a href=forum_admin.php?forumgoedit=yes&forum_id=$forum_id&ctg=$ctg&cat_id=$cat_id><img src='../../template/classic/img/edit.gif' title='$langModify' border='0'></img></a>&nbsp;<a href=forum_admin.php?forumgodel=yes&forum_id=$forum_id&cat_id=$cat_id&ctg=$ctg&ok=0><img src='../../template/classic/img/delete.gif' title='$langDelete' border='0'></img></a>
	</td></tr>";
		$i++;
	}
    ...
    <th>$langNbFor</th><th>$langActions</th></tr></thead><tbody>";
		...
		<a href=forum_admin.php?forumcatdel=yes&cat_id=$cat_id&ok=0><img src='../../template/classic/img/delete.gif' border='0' title='$langDelete'></img></a></td></tr>";
			$i++;
		}
