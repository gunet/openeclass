...
function get_auth_info($auth)
{
	if(!empty($auth))
	{
		switch($auth)
		{
			case '1': $m = "Ðéóôïðïßçóç ìÝóù ECLASS";
				break;
			case '2': $m = "Ðéóôïðïßçóç ìÝóù POP3";
				break;
			case '3': $m = "Ðéóôïðïßçóç ìÝóù IMAP";
				break;
			case '4':	$m = "Ðéóôïðïßçóç ìÝóù LDAP";
				break;
			case '5': $m = "Ðéóôïðïßçóç ìÝóù External DB";
				break;
			default:	$m = 0;
				break;
		}
