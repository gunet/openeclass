...
include '/home/panagoulias/hybridauth/vendor/autoload.php';
include '/home/panagoulias/hybridauth/modules/auth/methods/hybridauth/config.php';
...
try {
     ...
     */
    HttpClient\Util::redirect('main/portfolio.php');
} catch (Exception $e) {
    echo $e->getMessage();
}
