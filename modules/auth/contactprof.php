...
<table width=\"99%\"><thead>";
	$tool_content .= "<tr><th>�����:</th><td><input type=\"text\" name=\"firstname\" value=\"".$row["nom"]."\" readonly></td></tr>";
	$tool_content .= "<tr><th>�������:</th><td><input type=\"text\" name=\"lastname\" value=\"".$row["prenom"]."\" readonly></td></tr>";
	$tool_content .= "<tr><th>Email:</th><td><input type=\"text\" name=\"email\" value=\"".$row["email"]."\" readonly></td></tr>";
	$tool_content .= "<th>������:</th><td><textarea rows=\"6\" cols=\"40\" name=\"body\"></textarea></td></tr>";
	...
	<br/>
	<input type=\"submit\" name=\"submit\" value=\"��������\"><input type=\"hidden\" name=\"cc\" value=\"".$_GET['cc']."\">
	</form>";

}

//$tool_content .= "<p><a href=\"courses.php?fc=".$_GET['fc']."\">���������</a></p>";
