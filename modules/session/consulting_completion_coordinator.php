...
function pdf_reports_output($uId) {
    global $tool_content, $currentCourseName, $course_code;

    $pdf_title_tmp = ($uId > 0) ? '(Summary sessions) ' . uid_to_name($uId) : '(Summary sessions) all_users_reports';
    $pdf_title = $course_code . ' ' . $pdf_title_tmp;
