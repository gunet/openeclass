...
if (isset($_GET['action']) && $_GET['action'] === 'prepareModule') {
    ...
    $commitUrl = $urlAppend . "modules/learnPath/viewer.php?course=$course_code$unitParamPlain&action=updateProgress";
...
$isAnonymous = !$uid;
$lp_update_url = $urlAppend . "modules/learnPath/viewer.php?course=$course_code$unitParamPlain&action=updateProgress";
// Provide locals for scormAPI.inc.php (no direct $_SESSION reads there)
$lp_pathId = $pathId;
$lp_moduleId = $moduleId;
$lp_attempt = $attempt;
$lp_attemptClean = $attemptClean;
ob_start();
require_once 'viewerlib/scormAPI.inc.php';
...
view_lp_player('modules.learnPath.viewer', $data);
