...
// file output
    ...
    $pdf_title = "$course_code learning_path_results";
    $course_title = q("$currentCourseName - $langTrackAllPathExplanation");
    $module_type_title = q($langTrackAllPathExplanation);
