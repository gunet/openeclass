...
==============================================================================        
        @Description: Search function that searches data within the courses
        that the user is registered in or administrates.
...
***********************************************************************************************/
	...
	//**************************************************************************************************************************************
	//vrogxos gia na diatreksoume ola ta mathimata sta opoia enai eggegrammenos h' kathigitis o xrhsths
    ...
    }//telos anazhthshs sta mathimata sta opoia o xrhsths einai eggegrammenos
    ...
    /////////////////////////////////////////////////////////////
	// ANAZHTHSH STA MATHIMATA OPOU O XRHSTHS EINAI KATHIGITIS //
	/////////////////////////////////////////////////////////////
    $result2 = mysql_query("SELECT cours.code k, cours.fake_code c, cours.intitule i, cours.titulaires t, cours_user.statut s
	...
	}//telos anazhthshs sta mathimata sta opoia o xrhsths einai diaxeirisths/kathigitis
                	    
	//telos vrogxou gia na diatreksoume ola ta mathimata sta opoia enai eggegrammenos h' kathigitis o xrhsths
    //**************************************************************************************************************************************
      
	
    @$dbname = $backup_dname; //epanafora tis arxikhs timhs ths $dbname
