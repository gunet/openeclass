...
if (get_config('ext_solr_enabled')) {
    ...
    $data['results'] = $searchEngine->searchInCourse2($search_terms, $page, $course_id);
    $data['page'] = $page;
    view('modules.search_incourse.results_solr', $data);
    exit();
}
