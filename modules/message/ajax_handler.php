...
if(!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) === 'xmlhttprequest') {
    ...
    foreach ($msgs as $msg) {
        ...
        if (($msg->filename != '') and ($msg->filesize != 0)) {
            ...
            $filename = "&nbsp;&nbsp;&#124;&nbsp;&nbsp;" .
                "<a class='outtabs' href='$ahref' target='_blank' aria-label='$langOpenNewTab' title='$langDownload' data-bs-toggle='tooltip' data-bs-placement='top'>" .
        ...
        $td[$i++] = "<a role='button' href='javascript:void(0)' aria-label='$langDelete' class='$btn_class link-delete' data-id='$msg->id'><span class='fa-solid fa-xmark' style='padding-top:8px; font-size:1.2em;'></span></a>";
