...
$tool_content .= "<div class='panel panel-primary'>
  <div class='panel-heading'>
    ...
    $question_types = Database::get()->queryArray("SELECT exq.question, exq.q_position, exq.id, eur.eid, eur.eurid AS eurid, ear.weight "
            ...
            . "GROUP BY exq.id, eur.eid, eur.eurid, ear.weight ORDER BY exq.q_position",$exerciseId);
