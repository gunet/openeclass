      ...
      <thead>
        <tr class='active'>
          <td colspan='$colspan'>
            ...
            <a target='_blank' href='$editUrl' aria-label='(opens in a new tab)' data-bs-toggle='tooltip' data-bs-placement='bottom' data-bs-original-title='$langModify'><i class='fa fa-edit'></i></a>
          </td>
        </tr>
      </thead>
      <tr>
