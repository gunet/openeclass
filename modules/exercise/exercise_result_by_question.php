...
if (isset($_GET['exerciseId'])) {
    ...
    if (isset($_POST['question_id']) || isset($_GET['question_id'])) {
        ...
        $eurid = Database::get()->querySingle("SELECT eur.eurid AS eurid "
                ...
                . "WHERE eur.eid = ?d AND ear.weight IS NULL AND exq.type = 6 AND exq.id = ?d "
...
$tool_content .= "<div class='panel panel-primary'>
                <div class='panel-heading'>
                  <h3 class='panel-title'>" .$langQuestionCorrectionTitle . "</h3>
...
if (count($exercise_question_ids) > 0) {
    foreach ($exercise_question_ids as $row) {
        ...
        $tool_content .= "<br>
            ...
            <tr>
                <td class='text-right'><b>$langYourTotalScore: <span id='total_score'>$exercise_user_record->total_score</span> / $exercise_user_record->total_weighting</b></td>
            </tr>
            </table>";
