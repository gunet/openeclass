...
$tool_content .= '
  <div id="operations_container">
    <ul id="opslist">' . "\n";
$tool_content .= '          <li>'
    . '<img src="'.$themeimg.'/wiki.png" align="middle" />&nbsp;<a class="claroCmd" href="'.$_SERVER['SCRIPT_NAME'].'?course='.$code_cours
    ...
    ;
$tool_content .= '          <li>'
    . '<img src="'.$themeimg.'/history.png" align="middle" />&nbsp;<a class="claroCmd" href="'.$_SERVER['SCRIPT_NAME'].'?course='.$code_cours
    . '&amp;wikiId=' . $wiki->getWikiId()
    . '&amp;action=recent'
    . '">'
...
$tool_content .= '          <li>'
    . '<img src="'.$themeimg.'/book.png" align="middle" />&nbsp;<a class="claroCmd" href="'.$_SERVER['SCRIPT_NAME'].'?course='.$code_cours
    . '&amp;wikiId=' . $wiki->getWikiId()
    . '&amp;action=all">'
...
if ( $action == "edit" || $action == "diff" || $action == "history" )
{
	...
	. '<a class="claroCmd" href="'.$_SERVER['SCRIPT_NAME'].'?course='.$code_cours
	. '&amp;wikiId=' . $wiki->getWikiId()
	. '&amp;action=show'
...
switch( $action )
{
	...
	$tool_content .= '<form id="editConflict" action="'.$_SERVER['SCRIPT_NAME'].'?course='.$code_cours.'" method="POST">';
	...
	if ( is_array( $recentChanges ) )
	{
		...
		$entry = '<strong><a href="'.$_SERVER['SCRIPT_NAME'].'?course='.$code_cours.'&amp;wikiId='
	...
	$tool_content .= '<ul><li><a href="'.$_SERVER['SCRIPT_NAME'].'?course='.$code_cours
	    . '&amp;wikiId=' . $wikiId
	...
	if ( is_array( $allPages ) )
	{
		...
		$link = '<a href="'.$_SERVER['SCRIPT_NAME'].'?course='.$code_cours.'&amp;wikiId='
	...
	{
	    $script = $_SERVER['SCRIPT_NAME']."?course=$code_cours";
	...
	if ( is_array( $history ) )
	{
		...
		$versionUrl = '<a href="' . $_SERVER['SCRIPT_NAME'] . '?course='.$code_cours.'&amp;wikiId='
