...
class ElementTypes {
    const elements = array(
        ...
        ANALYTICS_EXERCISEGRADE => array('title' => 'Βαθμός σε άσκηση', 'link' => 'exercise-grade', 'icon' => 'fa fa-pencil-square-o'),
        ...
        ANALYTICS_WIKIACTIVITY => array('title' => 'Σελίδες στο Wiki', 'link' => 'wiki-pages', 'icon' => 'fa fa-wikipedia-w fa-fw'),
