 ...
 */
function pdf_output() {
    global $langUserDuration, $currentCourseName, $course_code;

    $pdf_title = "$course_code user_report";
    $course_title = q("$currentCourseName - $langUserDuration");
    $module_type_title = q($langUserDuration);
