...
$tool_content .= '<div class="form-wrapper form-edit borderLg" data-placement="top">';
...
$tool_content .= '<div class="float-end pt-4">
    <div id="toggle-view" class="btn-group">
        <a id="plots-view" class="btn submitAdminBtn submitAdminBtnClassic active me-2"  data-bs-placement="top" title="'.$langPlots.'" data-bs-toggle="tooltip" data-original-title="'.$langPlots.'"><span class="fa fa-bar-chart"  data-bs-toggle="tooltip" data-bs-placement="top"></span></a>
        <a id="list-view" class="btn submitAdminBtn submitAdminBtnClassic"  data-bs-placement="top" title="'.$langDetails.'" data-bs-toggle="tooltip" data-original-title="'.$langDetails.'"><span class="fa fa-list"  data-bs-toggle="tooltip" data-bs-placement="top"></span></a>';
