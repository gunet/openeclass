...
if (isset($_GET['stats_submit'])) {
    ...
    if (isset($_GET['c'])) {
        ...
        $tool_content .= "<div class='panel panel-admin'><div class='panel-body panel-body-admin'><p class='text-center text-white'>$s $langCourses ($langFrom2 $all $langSumFrom $siteName)</p></div></div>";
