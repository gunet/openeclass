...
if (isset($_GET['stats_submit'])) {
    ...
    if (isset($_GET['c'])) {
        ...
        $tool_content .= "<div class='panel panel-admin'><div class='panel-body panel-body-admin'><p class='text-center text-secondary'>$s $langCourses ($langFrom2 $all $langSumFrom $siteName)</p></div></div>";
        ...
        foreach ($sql as $data) {
            ...
            <td class='ps-3'>$data->creation_time</td><td class='text-center'>". action_button(array(
                    array('title' => $langCsv,
