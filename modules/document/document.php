...
if($is_adminOfCourse) {   
    ...
    **************************************/
    ...
    $langDownloadFile&nbsp;:<input type=\"file\" name=\"userFile\"><br>
    $langTitle&nbsp;:<input type=\"text\" name=\"file_title\" value=\"\" size=\"40\"><br>
    $langComment&nbsp;:<input type=\"text\" name=\"file_comment\" value=\"\" size=\"40\"><br>
    $langCategory&nbsp;:
    ...
    $langSubject&nbsp;:<input type=\"text\" name=\"file_subject\" value=\"\" size=\"40\"><br>
    $langDescription&nbsp;:<input type=\"text\" name=\"file_description\" value=\"\" size=\"40\"><br>
    $langAuthor&nbsp;:<input type=\"text\" name=\"file_author\" value=\"\" size=\"40\"><br>
    <input type=\"hidden\" name=\"file_date\" value=\"\" size=\"40\"><br>
    <input type=\"hidden\" name=\"file_format\" value=\"\" size=\"40\"><br>
    $langLanguage&nbsp;:";
    ...
    <?php
    echo "<br>
    $langCopyrighted&nbsp;:<input name=\"file_copyrighted\" type=\"radio\" value=\"0\" checked=\"checked\" /> $langCopyrightedUnknown
