...
==============================================================================
    ...
    inputs for metadata. The actual uploading takes place at document/index.php
==============================================================================*/
...
if ($can_upload) {
	...
	$tool_content .= "
	<form action='index.php?course=$course_code' method='post' enctype='multipart/form-data'>
        <fieldset>
