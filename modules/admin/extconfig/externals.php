...
class ExtAppManager {
    ...
    public static $AppNames = ['APITokenApp', 'H5PApp', 'BBBApp', 'GoogleMeetApp', 'JitsiApp', 'ZoomApp',
        'WebexApp', 'TurnitinApp', 'LtiPublishApp', 'UnPlagApp', 'OpenDelosApp', 'GoogleDriveApp',
