...
if (isset($_GET['add_cat'])) { //add a new category form
    ...
    $tool_content .= "</div>";
    $tool_content .= "<div class='row p-2'></div><div class='form-group'><label for='fielddescr' class='col-sm-6 control-label-notes'>$langCPFFieldDescr</label>
    ...
    $tool_content .= "<div class='row p-2'></div><div class='col-sm-offset-2 col-sm-10'>".showSecondFactorChallenge()."<input class='btn btn-primary' type='submit' name='submit_field' value='$langAdd'></div>";
    $tool_content .= "</fieldset>". generate_csrf_token_form_field() ."</form></div></div>";
    ...
    if (count($result) != 0) {
        ...
        $tool_content .= "<div class='row p-2'></div><div class='col-sm-offset-2 col-sm-10'><input class='btn btn-primary' type='submit' name='submit_field' value='$langSave'></div>";
        $tool_content .= "</fieldset>". generate_csrf_token_form_field() ."</form></div></div>";
