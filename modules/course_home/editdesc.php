...
if (isset($course->course_image)) {
    $course_image = "
        <img src='{$urlAppend}courses/$course_code/image/".urlencode($course->course_image)."' style='max-height:100px;max-width:150px;'> &nbsp;&nbsp;<a class='btn btn-sm btn-danger' href='$_SERVER[SCRIPT_NAME]?delete_image=true&" .  generate_csrf_token_link_parameter() . "'>$langDelete</a>
