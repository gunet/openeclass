...
$course_info = Database::get()->querySingle("SELECT keywords, visible, prof_names, public_code, course_license,
                                                    view_type, start_date, finish_date, description, home_layout,
                                                    course_image, password
...
// Units sorting
if ($is_editor and in_array($course_info->view_type, ['weekly', 'units'])) {
    $head_content .= '
...
if (($total_cunits > 0 or $is_editor) and in_array($course_info->view_type, ['weekly', 'units'])) {
    $alter_layout = FALSE;
