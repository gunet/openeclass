                ...
                if ($course_info->view_type == 'weekly') { // actions for course weekly format
                    ...
                    action_button(array(
                        ...
                        array('title' => $vis == 1? $langViewHide : $langViewShow,
                              'url' => $urlAppend . "courses/$course_code/index.php?visW=". getIndirectReference($cu->id),
                              'icon' => $vis == 1? 'fa-eye-slash' : 'fa-eye'),
                        array('title' => $access == 1? $langResourceAccessLock : $langResourceAccessUnlock,
                              'url' =>  $urlAppend . "courses/$course_code/index.php?access=". getIndirectReference($cu->id),
                    ...
                    action_button(array(
                        array('title' => $langEditChange,
                              ...
                              'icon' => 'fa-edit'),
                        array('title' => $vis == 1? $langViewHide : $langViewShow,
                              'url' => $urlAppend . "courses/$course_code/index.php?vis=". getIndirectReference($cu->id),
                              'icon' => $vis == 1? 'fa-eye-slash' : 'fa-eye'),
                        array('title' => $access == 1? $langResourceAccessLock : $langResourceAccessUnlock,
                              'url' => $urlAppend . "courses/$course_code/index.php?access=". getIndirectReference($cu->id),
                              'icon' => $access == 1? 'fa-lock' : 'fa-unlock',
                        ...
                        array('title' => $langDelete,
                              'url' => $urlAppend . "courses/$course_code/index.php?del=". getIndirectReference($cu->id)."&order=".$cu->order,
                              'icon' => 'fa-times',
                              'class' => 'delete',
