...
if ($is_editor) {
    $tool_content .= action_bar(array(
        array('title' => $langSave,
            'url' => "messageList.php?course=$course_code&amp;store=true&amp;conference_id=$conference_id",
            'icon' => 'fa-plus-circle',
            'level' => 'primary-label',
        ...
        array('title' => $langWash,
            'url' => "messageList.php?course=$course_code&amp;reset=true&amp;conference_id=$conference_id",
            'icon' => 'fa-trash',
            'level' => 'primary',
            'link-attrs' => "target='messageList'"
            )
...
$tool_content .= "<div class='alert alert-info'>$langTypeMessage</div>
   ...
   <form name='chatForm' action='messageList.php' method='get' target='messageList' onSubmit='return prepare_message();'><input type='hidden' name='course' value='$course_code'/><input type='hidden' name='conference_id' value='$conference_id'/>
   <fieldset>
    <div class='col-xs-12'>
