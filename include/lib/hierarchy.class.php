...
jContent;
    ...
    private function buildHtmlNodePickerIndirect($options) {
        ...
        if ($multiple) {
            ...
            $html .= '</div>';
            $html .= '<div><p><a id="ndAdd" href="#add"><span class="fa fa-plus" data-bs-toggle="tooltip" data-bs-placement="bottom" title="'.q($langNodeAdd).'"></span></a></p></div>';
    ...
    public function buildRootsSelectForm($currentNode, $options = array('respectVisibility' => true)) {
        ...
        $ret .= "<div class='form-wrapper form-edit Borders border-0 openCoursesFormWrapper' style='background-color:#EFF2FB;'>
