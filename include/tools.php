    ...
    foreach ($tools_sections as $section) {
        ...
        foreach ($result as $toolsRow) {
            ...
            if ($rich and ($mid == MODULE_ID_MESSAGE or $mid == MODULE_ID_ANNOUNCE)) {
                if ($mid == MODULE_ID_MESSAGE) {
                    ...
                    if ($new_msgs != 0) {
                        $sideMenuText[] = '<b class=>' . q($modules[$mid]['title']) .
                            " $mail_status<span class='badge Neutral-900-bg rounded-circle text-white float-end mt-1 d-flex justify-content-center align-items-center'>$new_msgs</span></b>";
                ...
                $sideMenuText[] = '<b class=>' . q($modules[$mid]['title']) .
                    "<span class='badge Neutral-900-bg rounded-circle text-white float-end mt-1 d-flex justify-content-center align-items-center'>$new_docs</span></b>";
