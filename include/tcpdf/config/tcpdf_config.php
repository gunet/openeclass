 ...
 * By default it is automatically set but you can also set it as a fixed string to improve performances.
 */
define ('K_PATH_IMAGES', 'http://'.$_SERVER['HTTP_HOST'].$themeimg.'/');

/**
 * Deafult image logo used be the default Header() method.
 * Please set here your own logo or an empty string to disable it.
 */
define ('PDF_HEADER_LOGO', 'eclass-new-logo-small.png');
 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'openeclass');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'openeclass');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Open Eclass');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Αναλυτική αναφορά εκτέλεσης των σεναρίων");
