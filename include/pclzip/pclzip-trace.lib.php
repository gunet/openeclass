...
//      if (substr($p_filename, 0, strlen($p_remove_dir)) == $p_remove_dir)
      {
        ...
        if ($v_compare == 2) {
          ...
          PclTraceFctMessage(__FILE__, __LINE__, 4, "Remove path '$p_remove_dir' in file '$p_filename' = '$v_stored_filename'");
        }
      }
    }
  ...
  function privReadCentralFileHeader(&$p_header)
  {
    ...
    PclTraceFctMessage(__FILE__, __LINE__, 4, 'CRC : \''.$p_header['crc'].'\'');
    ...
    if (substr($p_header['filename'], -1) == '/')
    {
      ...
      PclTraceFctMessage(__FILE__, __LINE__, 4, 'Force folder external : \''.$p_header['external'].'\'');
    }
  ...
  function privReadEndCentralDir(&$p_central_dir)
  {
    ...
    {
      PclTraceFctMessage(__FILE__, __LINE__, 2, "Fail to find the right signature");
