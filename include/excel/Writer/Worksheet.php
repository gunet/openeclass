...
class Spreadsheet_Excel_Writer_Worksheet extends Spreadsheet_Excel_Writer_BIFFwriter
{
    ...
    */
    ...
    {
        if ($this->_biff8_input_encoding != 'UTF-16LE') {
            $str = iconv($this->_biff8_input_encoding, 'UTF-16LE', $str);
        }
        
        $num_chars = function_exists('mb_strlen') ? mb_strlen($str, 'UTF-16LE') : (strlen($str) / 2);
