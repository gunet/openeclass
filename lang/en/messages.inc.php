...
$langPlagiarismAlreadyCheck = "File has already been sent for plagiarim check";
$langPlagiarismFileSent = "File sent for plagiarim check";
$langPlagiarismResult = "Plagiarism check result";
$langDownloadToPDF = "PDF Report";
