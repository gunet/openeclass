...
$langTryDeleteAdmin = 'You have tried to delete a user with admin rights';
...
$langEditCourseProgram = "Create / Edit";
...
$langUseTagForBlank = "Use tags [...] to define one or more blanks and use comma to define more that one correct answers to a specific blanκ (e.g. [Athens,Athena])";
...
$langUpgAdminError = "Incorrect Admin username or/and password! Please try again.";
