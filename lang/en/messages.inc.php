...
$langFileExists = "Operation not possible.<br>A file with this name already exists.";
...
$langWarnHelpDesk = 'User account and other requests are sent to this address';
...
$langModuleOfMyCourse = "Resource from Unit ";
...
$langTheForum = "The forum cannot be deleted.</br> It should be disabled from the group:";
...
$langTeacherRequestHasRejected = "Request was rejected";
...
$langWarnReject = "You are about to reject the request";
...
$m['submitted_by_other_member'] = 'This file has been submitted by another member of';
...
$langEditError = "An error occurred during the editing !";
...
$langZipDownload = "Download assignments";
...
$langWEndDeadline = "(Deadline is tomorrow)";
...
$langUploadError = "An error occurred during uploading!";
...
$langWorkToAllUsers = "To all of them $langsOfStudentss";
$langWorkInfo = 'Work items';
$langWorkAssignTo = "Assignment to";
...
$langAISyllabusURL = 'Syllabus PDF URL';
$langAIURLDownloadFailed = 'Failed to download file from URL';
$langAIInvalidURL = 'Invalid URL provided';
$langAIURLNotAccessible = 'URL is not accessible';
$langAIDownloading = 'Downloading from URL...';
$langAIURLDescription = 'Enter the direct URL to a PDF file with course description. The file will be downloaded and processed.';
