...
$langCourseEditSuccess = "$langCourse settings updated";
...
$langBackupCourse = "$langCourse Archive";
$langModifDone = "$langCourse settings updated";
...
$langRefreshCourse = "$langCourse Refresh";
...
$langDescrInfo = "Brief $langsCourse description";
...
$langDefaultMakeCorrespond1 = "Your father is";
...
$langWelcomeWizard = "Welcome to the Open eClass installation wizard!";
...
$langLessonCode = "$langCourse Name (code)";
$m['tomeas'] = 'Division';
...
$langCopyFiles = "$langCourse files copied";
...
$m['username'] = "Username";
$m['filename'] = "Filename";
$langSubmissionDate = "Submission date";
$m['comments'] = "Comments";
...
$langDeleteSubmission = 'Assignment delete';
...
$langUserTopicInformation = "Couldn't get user and topic information from the database.";
...
$langStudentViewDisable = "Back to $langsTeacher view";
...
$langRegistrationDateShort = "Resgistration date";
...
$langLinkUnsubscribeFromPlatform = "Note: You are receiving this message because you are registered to '%s'.<br />If you don't wish to receive any more email messages click";
...
$langUserBlogNotPublic = "You must log in to access this user's personal blog";
$langPublicBlogDisableWarning = "Only logged in users, but not guests, are able to access your blog";
$langPublicBlogButtonsLabel = "Publically accessible blog";
...
$langCPFConfirmCatDelete = 'Deleting this category will result in the deletion of the profile fields that belong to it and of the respective users profile data. Are you sure you want to proceed with the deletion?';
