...
$langNoCourses = "Non ci sono corsi  disponibili!";
$m['name'] = "Corso";
...
$langShowUnitCarousel = "Visualizza la sezione in una riga per colonna";
$langShowUnitRow = "Mostra sezione per riga";
...
$lang_dont_display_login_testimonials = "non compaiono nella home page";
...
$langSumCoursesEnrolled = "$langCourses I am </br>enrolled in";
...
$langFormLoginPlacementCenter = "posizione centrale";
$langFormLoginPlacementLeft = "Allineare a sinistra";
...
$langPopularCourse = 'corsi popolari';
...
$langNoAccountPleaseRegister = "Non hai un account? %sRegistrati%s.";
$langAlreadyHaveAccount = "Possiedi già un account? %sAccedi%s";
...
$langNumEntriesFound = '%s risultati trovati tramite la ricerca';
$langSearchForm = 'Search Form';
$langSearchResults = 'Risultati di ricerca';
...
$langNoEntriesFound = 'Nessun risultato trovato';
...
$langSearchFreeText = "Ricerca libera";
$langSearchFreeTextPlaceholder = "Titolo, descrizione, parole chiave...";
...
$langViewAs = "Seite als";
$langCTeacher = "LEHRER";
$langCStudent2 = "SCHÜLER";
$langSummaryProfile = "PROFILO RIASSUNTIVO";
...
$langCalculateNewDuration = "Calcolo della nuova durata";
$langChooseDayAgain = "Non puoi scegliere giorni diversi. Riprova.";
$langMessageInfo = "Contenuto del messaggio";
$langMessageContent = "Contenuto del messaggio";


$langCreateCourseLeftForm = "La creazione di un corso è l'azione più importante dell'utente – istruttore sulla piattaforma.</br></br>
Inserisci un titolo per la lezione.</br></br>
Digita una breve descrizione del corso.</br></br>
Seleziona la Facoltà o il Dipartimento in cui è offerto il corso o la categoria di corso a cui appartiene.</br></br>
...
$langSaidForUs = "Hanno detto di noi";
$langCloseOptions = "Opzioni di chiusura";
$langOpenOptions = "Opzioni aperte";
...
$langSignOut = "Logout";
$langViewMentoring = "View mentor";
$langHomeMentoringPlatform = "Home";
$langProgramS = "program";
$langNoDeleteMentorAsMemberOfProgram = "The action was not completed. The user participates as a mentor in a program.
                                        Remove that mentor from the participating program and try again.";
$langBackHomeMentoringPlatform = "Return to the mentoring platform home page";
$langBackHomeMentoringProgram = "Return to the home page of the program" ;
$langOurMentors = "Our mentors";
$langConditionMentoring = "Condition";
$langOurMentoringPrograms = "Our programs";
$langMyPrograms = "My programs";
$langAvailableUntilMentoringProgram = "Available";
$langAvailablePrograms = "Programs available where you participate as a facilitator or mentor";
$langAllMentoringPrograms = "All programs";
$langViewMentoringProgram = "View Program";
$langNoAvailablePrograms = "Unavailable programs that you participate in as a facilitator or mentor";
$langAvailableGuidedPrograms = "Programs available where you participate as a mentee";
$langNoParticipateAsGuided = "You are not participating in a program as a mentee";
$langWelcomeMentoringPlatform = "Welcome to the Open Eclass mentoring platform";
$langBackToDefaultPlatform = "Main platform of Open Eclass";
$langEnableMentoringPlatform = "Activation of Mentoring Platform";
$langDisableMentoringPlatform = "Deactivation of Mentoring Platform";
$langRegisterMentoringProgram = "Sign up";
$langUnRegisterMentoringProgram = "Unsubscribe from the program";
$langRegisterDoneMentoringProgram = "Your registration has been completed successfully.";
$langMentoringName = "Mentoring program";
$langMentoringInfo = "Program information";
$langMentoringEdit = "Edit program";
$langNoMentorsAdded = "Please select at least one mentor.";
$langMentoringSpace = "Counseling area";
$langShowMentoringProgramms = "Coaching programs available";
$langShowDisableMentoringProgramms = "Inactive programs";
$langAddMentoring = "Add Program";
$langEditMentoring = "Edit program";
$langNoMentoringPrograms = "No mentoring programs available";
$langCreateMentoringProgramms = "Create a mentoring program";
$langMentoringTutor = "Coordinator";
$langSendMessageTopicMentoring = "has sent a message";
$langMentoringMentors = "Mentor";
$langNoAvailableMentoringMentors = "No mentors available";
$langMentoringMentorss = "Program mentors";
$langDescrMentoringProgram = "Mentoring program description";
$langMentoringMentor = "Choosing a mentor";
$landAddMentor = "Add as" ;
$landDeleteMentor = "Remove from" ;
$langmentor = "mentor";
$langAvailableMentorProfile = "Active mentor";
$langNoAvailableMentorProfile = "Inactive mentor";
$langReqMentoringDone = "The mentoring program has been created successfully.";
$langNoReqMentoringDone = "The mentoring program has not been completed.";
$langCodeExistMentoring = "The code you selected already exists. Choose a different one.";
$langNoEditMentoring = "Processing was not completed successfully. Please try again.";
$langNotDeleteMentorAsTutorOfGroup = "The action cannot be performed because you have removed a mentor who is responsible for a group in the program.";
$langDoDeleteMentoringProgram = "Are you sure you want to proceed with deleting the program with a password?";
$langDelMentoringComplete = "Program deletion completed successfully.";
$langUntilMentoringProgram = "The program is available until: ";
$langAvailableMentor = "His available appointments";
$langRentezvousMentee = "My available appointments";
$langWithDrawAlForMentee = "Leaving the appointment";
$MsgWithDrawAlMentee = "Are you sure you want to leave this appointment?";
$withDrawAlMenteeSuccessMsg = "Your departure from the appointment has been completed successfully.";
$langAddViewDateMentor = "View/Add available date";
$langIsMendorChooser = "You have been selected as a mentor for this program.";
$langIsTutorChooser  = "You are the coordinator of this program.";
$langAreYouMentor = "Are you a mentor?";
$langAreYouTutor = "Are you a moderator?";
$langAreYouGuided = "Are you guided?";
$langParticipateAsMentor = "Programs in which he participates as a mentor";
$langRequestMentoring = "Request to participate to the program coordinator";
$langNoRequestMentoring = "You cannot send a collaboration request as you are participating as a coordinator or mentor of that program";
$langNoExistMentorInProgram = "He does not participate in any program as a mentor.";
$langHasSendRequestMentoring = "You have sent a cooperation request.";
$langHasSendRequestGroupMentoring = "The request has been sent.";
$langMeetingIsActive = "The meeting is in progress";
$langMeetingIsDeactivate = "The meeting has ended";
$langSendRequestGroupSuccess = "The request has been successfully sent to the group manager.";
$langSendRequestGroupNoSuccess = "The request was not sent. Try again.";

$langCancelRequestGroupNoContinue = "You cannot cancel the request. It is being processed.";
$langReqNoModify = "You cannot edit the request. The user has canceled it.";
$langReqUserToGroupNoCompleteIsMemberInOther = "The user cannot join the group. There is a user registration limit</br>
                                                subscribe to only one group and the given user participates in another.";

$langCancelRequestGroupSuccess = "The request was successfully cancelled.";
$langCancelRequestGroupNoSuccess = "The request was not cancelled. Try again.";
$langCancelSendRequest = "Cancel request";
$langSendGroupRequest = "Group registration request";

$langRegisterGroupMentoringSuccess = "Your registration was successful. You can enter the team workspace.";
$langRegisterGroupMentoringNoSuccess = "Your registration was not completed successfully.</br>
                                        There is a registration limit for the groups and you are already in one.";

$langUnRegisterGroupMentoringSuccess = "You have been successfully unsubscribed. You do not currently have access to the team workspace.";
$langUnRegisterGroupMentoringNoSuccess = "Your unsubscribe was not completed successfully. Try again.";

$langGroupMentoringMembers = "Team members";
$langInfinityNumber = "Unlimited number";
$langGroupIsFull = "The team is complete";
$langEditorOfGroup = "Team manager";
$langEditorsOfGroup = "Team Leaders";
$langMemberOfProgram = "Program member";
$langSettingsRegistrationOfGroup = "Mentor registration settings in groups";
$langSettingsRegistrationOfGroup2 = "Registration settings";
$langDeleteAllMentoringGroups = "Delete all groups";
$langRegOneGroup = "Processing completed. The mentee can only join one program group.";
$langRegManyGroup = "Processing completed. The mentee may enroll in more than one program group.";
$langRegOneOrManyGroupsNoSuccess = "Something went wrong. Try again.";

$langIsMenteeAtleastOneGroupError = "You are already registered in one group, not allowed in another.";
$langRequestCanceledByGroupSettings = "<span class='text-danger TextSemiBold'>Your request has been cancelled</br>as there is a limit of registration to a single group.</span>";

$langAbilityRegisterToOneGroup = "Possibility to register (In one group)";
$langMenteeRegisterToOneGroup = "Mentees can join a group";
$langAbilityRegisterToManyGroup = "Ability to register (In more than one group)";
$langMenteeRegisterToManyGroup = "Mentees can join more than one group";

$langBackToGroupsPage = "Back";
$langEditGroupMentoring = "Edit group";

$langExistsMenteesToParticipateInManyGroups = "The action cannot be performed because there are mentees participating in more than one group.";

$langStandByState = "Waiting";
$langRequestSendSuccess = "Request sent successfully";
$langNoRequestSendSuccess = "The request was not sent. Try again.";
$langCancelRequest = "Cancel request";
$langCancelRequestSuccess = "The request was successfully cancelled.";
$langCancelRequestNoSuccess = "The request was not cancelled.";
$langAvailableDatesContact = "Add Meeting with team manager ";
$langBackMentoringProgram = "Return to the program page";
$langDeleteRentezvous = "Delete available date";
$langDeleteAvailableDate = "do you want to proceed with the specific deletion?";
$langRedInfoRentezvousOtherProgram = "In <span class='text-danger TextBold'>red</span> color are displayed the available communication days that you have registered as a group leader in other programs.";
$langRedInfoRentezvous = "In <span class='text-danger TextBold'>red</span> color the available contact days of other managers in other groups in the current program are displayed.";
$langSuccessInfoRentezvous = "In <span class='text-success TextBold'>green</span> color the available contact days you have registered in the current schedule are displayed</br>
in the current group as a manager.";
$langWarningInfoRentezvous = "In <span class='text-warning TextBold'>orange</span> color the available contact days registered by someone else are displayed</br>
group manager in the current program in the current group.";
$langInfoInfoRentezvous = "In <span class='text-info TextBold'>blue</span> color are displayed the available communication days you have registered as</br>
team manager in the current program in another team.";
$langPinkInfoRentezvous = "With <span style='color:#FFC0CB;' class='TextBold'>pink</span> color shows the reservation made by a member of the group.";



$langRedInfoMeeting = "In <span class='text-danger TextBold'>red</span> color, the available meetings that you have registered as a group leader in other programs are displayed.";
$langSuccessInfoMeeting = "In <span class='text-success TextBold'>green</span> color the available meetings that you have registered as a group leader in the current schedule are displayed</br>
in the current group as a manager.";
$langWarningInfoMeeting = "Available meetings registered by someone else are shown in <span class='text-warning TextBold'>orange</span> color</br>
group manager in the current program in the current group.";
$langInfoInfoMeeeting = "In <span class='text-info TextBold'>blue</span> color are available meetings that you have registered as</br>
team manager in the current program in another team.";



$langContinueActionRequest = "Do you want to proceed with this action?";
$langNoExistMentoringRequests = "There are no cooperation requests";
$langAcceptRequest = "Request Acceptance";
$langDenyRequest = "Rejection of request";
$langTutotHasDeniedRequest = "Your request has been rejected by the program coordinator.";
$langDeleteRequest = "Delete request";
$langFreeMeeting = "There is no code. Free access.";
$langRequestsHasAccepted = "Requests you have accepted";
$langRequestsHasDenied = "Requests you have declined";
$langRequestReset = "Reset";
$langMentoringAction = "Logging program actions";
$langUntilNow = "Until today";
$langAboutWith = "About";
$langDirectory = "Folder";
$langNoActionsExists = "No actions have been recorded for this subsystem.";
$langProfileAsMentor = "My profile as a mentor";
$langProfileAsGuided = "My mentee profile";
$langProfileAsTutor = "My moderator profile";
$langProfileAsAdmin = "My profile as an administrator";
$langMoreChoices = "More options";
$langNoChangeRentezvousOtherUser = "You cannot change another user's appointment";
$langChangeRentezvousSuccess = "Your appointment has been successfully changed";
$langDeleteRentezvousSuccess = "Your appointment has been successfully deleted";
$langDeleteRentezvousNoUser = "You cannot delete another user's appointment.";
$langAddRentezvousSuccess = "Your appointment has been successfully added.";
$langGuidedProgramParticipate = "Protégés participating in the program";
$langDeleteGuidedMentoring = "Delete guide from this program";
$langDeleteGuidedSuccess = "The mentee was successfully deleted.";
$langNoDeleteGuidedSuccess = "The mentee was not successfully deleted. Try again.";
$langMentoringGroupSpace = "Counseling area";
$langGroupMentorsMentees = "Mentor - mentee groups";
$langCreateMentoringGroup = "Create group";
$langMentees = "Mentee";
$langMentee = "Mentee";
$langMaxMentees = "Maximum number of mentees";
...
$langDeleteMenteeFromGroupNoSuccess = "The deletion was not completed. Try again.";
$langDeleteMenteeFromGroupCheck = "The user is about to be removed from the group.</br>
Additionally, all user messages sent to group discussions will be removed.</br>
Do you want to proceed?";

$langQuestionDeleteAllMentoringGroups = "All groups of the specific program</br>are about to be deleted
and those users who participate in them.</br>
Do you want to proceed with this action?";
$langDeleteAllMentoringGroupsSuccess = "All groups have been deleted successfully";
$langDeleteAllMentoringGroupsNoSuccess = "The deletion of all groups was not completed. Try again.";
$langNoGroupMentees = "No mentor groups have been defined";
$langDeleteMentoringGroupSuccess = "Group deletion completed successfully.";
$langDeleteMentoringGroupNoSuccess = "The deletion was not completed. Try again.";

$langAboutMentoring = "
<p class='text-center mt-0'><strong class='text-capitalize fs-5'>What is mentoring</strong></p>
The mentor helps the mentee to achieve the goals related to his professional development.
He organizes a plan by sharing various experiences and knowledge he has acquired during his own journey.
Essentially, it is the tool that helps mentees to reach as high as they can in relation to the goals they have set.
";

$langAboutMentoring2 = "
<p class='text-center mt-0'><strong class='text-capitalize fs-5'>What it is not</strong></p>
Mentoring is not training, coaching, service provision, psychotherapy.
The mentor does not know everything, but facilitates the process of development of the mentee.
";

$langAboutMentoring3 = "

<p class='text-center mt-0'><strong class='text-capitalize fs-5'>How exactly it works</strong></p>
<div class='col-12 text-start'>
  <div class='d-flex'>
    <span class='TextBold'> 1) </span>
    <span class='ms-1'>face-to-face meetings</span>
  </div>

  <div class='d-flex mt-2'>
    <span class='TextBold'> 2) </span>
    <span class='ms-1'>communication via online platform, Skype, Zoom, Microsoft Teams, telephone, etc.</span>
  </div>

  <div class='d-flex mt-2'>
    <span class='TextBold'>3)</span> <span class='ms-1'>shadowing term, where the mentee observes the mentor at work</span>
  </div>
</div><br>
";
...
$langAboutMentoring4 = "
<p class='text-center'><strong class='text-capitalize fs-5'>Who is it for</strong></p>
<p class='text-center'>To those who want to make their professional dreams come true,
to share their experience or even better both!</p>
";

$langDocsMentoringGroups = "Documents";
$langForumMentoringGroups = "Forums";
$langAllMenteesMentoringGroups = "Members";
$langRequestsRegisterGroups = "Registration requests";
$langMananeDocMentees = "Document settings for users";
$langRequestsRegisterGroupsNoExists = "There are no registration requests";
$langExistRequestToMentoringGroup = "There are requests from mentees who want to join the group.";
$langAcceptRequestForGroupMentees = "";
$langReuestHasCanceledFromUser = "Warning! The user has canceled their request. The request has not been processed.";
$langCancelRequestIsModified = "You cannot proceed with this action. The request is being processed by the program coordinator.";
$langRegisterDoneMenteesOfGroup = "Mentees who participate in this group";
$langCreateTopicMentoringGroup = "Add discussion topic";
$langTopicCreate = "Theme created successfully.";
$langTopicDontCreateEmptyMessage = "Topic not created. You may have left some mandatory fields blank.";
$langAnswerTopicMentoringGroup = "Answer to the subject";
$langDeleteAllMessagesOfTopic = "Delete all messages";
$langMessagesOfTopicHasDeleted = "Messages deleted successfully.";
$langDeleteAllMessagesOfTopicQuestion = "All messages are about to be deleted. Do you want to proceed?";
$langTopicDontAnswerEmptyMessage = "The issue was not answered. You may have left some mandatory fields blank.";
$langAcceptRequestMsg = "<p class='fs-6 ​​TextBold mb-0'>You are about to process this request.</p>
<strong class='TextRegular'>1) If you reject the request then user will not be able to send again until you reset it.</br>
        2) If you delete it then the user will be able to request re-registration by sending a request.</strong>";
$langNoInfoForMentees = "There is no information about this user.";
$langNoInfoForDatesMentor = "There is no information about the user.";
$langUntilOneMonth = "Until a month later";
$langAddDateAvailableMentor = "Create a meeting";
$langMyAvailableDates = "Contact days and times in the current schedule for --> ";
$langReqEditMsg = "The request was successfully processed.";
$langReqDeniedFromTutor = "Your request has been rejected.";
$langNoForumMentoring = "There are no discussion topics in this group.";
$langEditTopicMentoring = "Edit message";
$langDeleteTopicMentoring = "Delete message";
$langDeleteTopicMentoringSuccess = "Message deleted successfully.";
$langSubjectMentoringDeleteSuccess = "The topic has been successfully deleted along with its entire discussion.";
$langTopicEditSuccessName = "Theme name changed successfully.";
$langDeleteTopicMentoringMsg = "Do you want to proceed to delete the message?";
$langDeleteSubjectMentoringMsg = "<strong>Caution!</strong> Deleting this topic will also delete all its content.</br>Do you want to proceed?";
$langFileDeleted = "File deleted successfully.";
$langBackDocGroup = "Back to team documents";
$langConfirmEmptyInput = "Please fill in the required fields.";
$langHistoryRentezvous = "Historical appointment";
$langNoExistHistoryRentezvous = "There is no appointment";
$langRemoveFromProgram = "Remove user from program";

$langProgramDel = "Delete program";
$langFinalizeProgram = "Create a program";
$langModifyProgram = "Edit program";
$langProgram = "Program";
$langProgramInfo = "Program information";
$langDocEnable = "program registrations";
$langForumEnable = "program discussions";

$langAvailableInPlatform = "Active";
$langAddAvailabilityMentor = "Your availability date on the platform has been completed successfully.";
$langParticipateAsTutorProgram = "Are you a program coordinator?";
$langParticipateAsTutorProgramNoExist = "You are not participating in a program as a moderator.";
$langParticipateAsMenteeProgramNoExist = "You are not participating in a program as a mentee.";
$langMenteeCanRegisterToOneGroup = "In this program you have chosen that the mentee can only join one group of the program.";
$langMenteeCanRegisterToManyGroups = "In this program you have chosen the mentee to be able to join more than one program group.";
$langParticipateAsMentorProgram = "Are you a program mentor?";
$langParticipateAsMenteeProgram = "Are you guided by a program?";
$langParticipateAsMenteeProgramUser = "Programs he participates as a mentee";
$langUpgradeDbFist = "<strong>NOTE</strong></br>To proceed with activating the mentoring platform, you must first upgrade your base.";

$langSetAvailableDateForGroup = "<span class='fa fa-calendar'></span>&nbspAre you available?";
$langAddAvailableDateTime = "List your available days and times so team members can contact you.";
$langDatesAddedComplete = "Available contact date successfully added.";
$langDatesADeletedComplete = "The available date was successfully deleted";
$langDatesDeletedNotComplete = "You cannot proceed with this action as it has been booked by a user for communication.</br>
                                Cancel this reservation and try again.";
$langContactDates = "Contact days";
$langToolsGroup = "Tools";
$langAddTagMentor = "Tag list - tag a mentor";
$langAddTagMentorSuccessMsg = "Registering a tag to a mentor has been completed successfully.";
$langStepMentoring = "Step";
$langEmploymentSector = "Employment sector";
$langCommonGroup = "Common group";
$langUnRegisterDontAllowedFromGroup = "Unsubscribing from the group is not allowed.";
$langWallProgram = "Program wall";

$langAddBooking = "Book";
$langBookings = "Bookings with the group manager";
$langAddBookingSuccess = "Your booking has been successfully made. An informative email has been sent to the person in charge.";
$langAddBookingByMentee = "Booking for contact";
$langAddBookingNoSuccess = "The booking was not completed because another user has used the specified date.";
$langContinueToBooking = "Do you want to proceed with this action?";
$langContinueToDeleteBooking = "Do you want to proceed with the cancellation of the reservation?";
$langDeleteBookingSuccess = "Your booking has been successfully deleted.";
$langDeleteBookingByMentee = "Cancel booking";
$langBookingHasCalceledAll = "Bookings removed successfully.";
$langNoExistBookings = "There are no bookings available.";
$langHasDoingBookingWith = "You have booked the group manager ";
$langForContanct = "for communication";
$langBookingHasBooking = "has booked to contact you";
$langHasBookingAdminTutor = "booked to contact the group manager";
$langCancelBooking = "Cancel";
$langBookingHasCalceled = "Booking successfully cancelled. An information email has been sent to the user.";
$langBookingHistory = "Expired bookings";
$langDeleteAllBookings = "Delete all bookings";
$langAcceptBooking = "Acceptance";
$langBookingHasAccepted = "Booking accepted. An information email has been sent to the use ";
$langYourBookingHasAccepted = "Your booking has been accepted";
$langUpdateSoon = "You will be informed shortly about your meeting with the manager.";
$langHasAcceptedBooking = "The booking has been accepted";

$langYourBookingHasCanceled = "Your booking has been cancelled";
$langDetailsBooking = "The booking details are as follows:";
$langMentorHasRemovedTheDate = "The booking has not been completed as the person in charge has removed their available date.";

$langAnnHasPublishedGroup = "An announcement has been posted to the group";
$langDeleteAnnouncementGroup = "The announcement will be removed from the group. Do you want to proceed?";
$invalidDate = "Incorrect date. Try again.";
$AnnDelSuccess = "The announcement was successfully deleted.";
$langNoExistAnnGroup = "There are no announcements for this group.";
$langEmailNotSendedByInvisibleAnn = "Announcement status changed to not visible.</br>
No email was sent to the selected users.";
$langMenteeAllowRegister = "Mentees are allowed to register";
$langMenteeAllowUnregister = "Mentees are allowed to unsubscribe";
$langCanRegisterToGroup = "Registration request option";
$langMenteeSendRequest = "Mentees can send a registration request";
$langTheTutorsOfProgram = "The program coordinators";
$langInvalidDates = "The dates you entered are not valid. Try again.";

$langEmptyComment = "The action was not completed. The text was empty. Try again.";
$langCommentAddSuccess = "Comment added successfully.";
$langAddAcomment = "add a comment";
$langChangeComment = "Edit comment";
$langdeleteComment = "Delete comment";

$langContinueChangeComment = "Do you want to proceed with this action?";
$langCommentUpdateSuccess = "Comment changed.";
$langCommentUpdateNoSuccess = "Something went wrong. Try again";
$langCommentDeleteSuccess = "The comment was deleted.";
$langCommentDeleteNoSuccess = "Something went wrong. Try again";
...
$langDateHasExpire = "Problem! Select a date from the current date.";
$langAddDatesSuccess = "Date successfully added.";

$langBooking = "Booking";
$langGroupMentees = "User groups";

$langHaveDoneBooking = "YOU HAVE MADE A BOOKING - CANCEL IT";
$langDoBooking = "DO BOOKING";
$langDisableBooking = "NOT AVAILABLE";
$langBookingIsDone = "IT IS CLOSED";

$langMentoringGroupMembers = "User groups";

$langSendMenteeRequestToProgram = "Request for cooperation in the program";
$langDetailsUser = "User Information";
$langAcceptRequestInProgram = "Accepting a request to the program";
$langYourRequestHasAccepted = "The request for cooperation in the program has been accepted. You are now a member of the program.";
$langDiscardRequestInProgram = "Reject request to program";
$langYourRequestHaDiscurded = "The request for cooperation in the program has been rejected.";
$langRequestToGroup = "Request to join the group";
$langRequestInGroupHasAccepted = "Your request has been accepted to the group:";
$langRequestInGroupHasDiscurded = "Your request was not accepted in the group:";
$langAvailableMeeting = "Meeting available";

$langWithTutorOfGroup = "With the team leader:";
$typeMeetings = "Type of meeting:";
$langDetailsMeeting = "Meeting details";
$langPlsWait = "Wait...";
$langMembers = "Members";

$langManageGroup = "Manage groups";

$langAvailability = "Availability";
$langAvailabilityMentor = "Active";
$langUnAnavailability = "Not active";
$langlistMentor = "List of mentors";

$langDeleteMentorFromTag = "Untag this mentor";
$langDeleteTagsFromMentor = "Remove tags from the user";
$langDelMentorFromTag = "Untag from mentor";
$langDeleteCurrentTagsFromMentor = "Tags removed by user successfully.";
$langSearchTagByKeyboard = "You can search for any tag by typing in the text field the title of the tag you have entered.";
$langShowAllMentors = "In the selection field, all platform mentors designated by the platform administrator are displayed.";

$langTagList = "List of tags";
$langNoExistsMentorInThisTag = "There are no mentors listed in this tag.";
$langDelTag = "Delete tag:";
$langDeleteTagMsg = "<strong class='text-warning TextBold'>CAUTION!</strong></br>
If you remove this tag, all the mentors listed on it will be deleted as well.</br>
<strong>Do you want to proceed with this action?</strong>";
$langDelTagSuccessMsg = "Tag deleted successfully.";
$langSelectTagMsg = "You did not select any tags. The action was not completed.";
$langChooseTagMentorMsg = "The action was not completed. You did not enter a tag.";
$langAddTagSuccessMsg = "Tag added successfully.";
$langTextHomePage = "Homepage texts";

$langIsAvailableInPlatform = "Are you available on the platform?";

$langTutorProgram = "Coordinator";
$langMentorProgram = "Mentor";
...
$langMentoringSkills = "Skills";
$langInsertMentoringSkills = "Enter the skill fields for the field of expertise in the text form below.";

$langMentoringKeyWords = "Keywords";
$langInsertMentoringKeyWords = "Enter keywords related to your area of ​​expertise and skills.";

$langFieldsExpertise = "Field of expertise";
$langInsertFieldsExpertise = "Enter the field of expertise in the text form below.";

$langAddFiltersSuccessMsg = "Filter values ​​added successfully.";
$langAddFiltersNoSuccessMsg = "The action did not complete as you are entering values ​​that already exist. Try again.";

$langSpecializations = "Specializations";
$langSkills = "Skills";
$langSkillCanOfferMentor = "Skills that the mentor can support in the specific specialization";
$langKeyWord = "Keywords";

$langDelSpecializationSuccessMsg = "Deletion completed successfully.";
$langDelSpecializationNoSuccessMsg = "Something went wrong. Try again.";

$langListFilters = "List of filters";

$langRelationshipMentorsFilter = "Interconnection of mentors - filters";

$langformSubmitSuccess = "Mentors have been successfully added to your selected filters.";
$langformSubmitNoSuccess = "You cannot re-enter the same values ​​for the specific mentors or mentors you selected.";
$langformSubmitWarning = "You have left some fields blank. Try again.";
$langMentorsHasAdded = "Mentors you have listed in available specializations";
$langMentorDelFromSkillSuccess = "The mentor was removed from the specific specialization and skill successfully.";
$langDelMentorFromSkill = "Do you want to proceed with the removal of the mentor from the specific specialization-skill?";
$langDelSpecialization = "Do you want to proceed with the removal of this specialization?</br>
In addition, all the mentors you have registered in it will be removed.";
$langChooser = "<span class='small-text help-block'>Select&nbsp<span class='fa fa-arrow-down'></span></span>";
$langAvailableSpecializations = "Specializations available";
$langAddSkillIfYouWant = "Do you wish to add a skill or remove an existing one?";
$langAddKeyIfYouWant = "Do you wish to add a keyword or remove an existing one?";
$langClickHere = "Click here";
$langNameSkill = "Skill name";
$langAddSkillSuccessMsg = "The skill was successfully added to the compared expertise.";
$langAddSkillNoSuccessMsg = "The action was not completed. You may have entered a name that already exists. Try again.";
$langdelSkill = "Delete skill";
$langSkillSuccessMsg = "Skill removal completed successfully.";
$langSkillNoSuccessMsg = "The action was not completed. Try again.";
$langByKewWords = "Search for active and inactive mentors via keywords";

$langSearchMentorsForCreateProgram = "Search for the platform's active mentors based on the specializations below";
$langSearchMentorsForEditProgram = "All platform mentors, active and inactive, as well as selected program mentors are displayed below.</br>
Notice if a program mentor is unavailable on the platform to remove them from the program.</br>
The following <span class='badge bg-danger'><span class='fa fa-info'></span></span> badge will appear next to the mentor's name.
<p class='TextBold text-info mt-3 mb-0'>IMPORTANT NOTE</p>
<p>The mentor who is also the coordinator of the program cannot be removed as a mentor in the current program as he participates as a group leader in the plenary group.</p>";
$langNoFound = "Not found";
$langUnvailableMentor = "No mentor available on the platform";
$langDeleteAvailableMeeting = "Do you want to delete this meeting?";
$langdobookingwithmentor = "Do you want to make a reservation to contact the specific mentor?";
$langdelbookingwithmentor = "Do you want to cancel this reservation?";

$langExitMentoring = "Open Eclass platform";
$langMentoringPrograms = "Programs";
$langWelcomeMentoring = "Welcome to the Open Eclass mentoring platform!";
$langInfoWelcomeMentoring = "The Mentoring platform of Open Eclass offers you the possibility
to look for the mentor you want to guide you through various challenges you face in your professional field.";
$langInfoWelcomeMentoring2 = "Are you a new user and need help?</br>
Look for the mentor you want.";
$langViewMentor = "Meet them";
$langPlatformOpenEclass = "Open Eclass platform";
$langPlatformMentoring = "Mentoring platform";

$MentoringEnableHomepageEclass = "<p class='TextBold fs-6'>Welcome to the new feature of Open Eclass, the <span class='text-warning'>MENTORING</span> platform.</p>
<p class='small-text text-secondary TextBold mt-2'>Looking for a mentor to guide you through various challenges you face in your professional field?</p>";

$langOldVersion = "Older version";
$langVersionEclass = "eClass Edition";
...
$langTotalMentees = "Mentees";
$langTotalTutors = "Tutors";
$langInfoPrograms = "Choose the program with the mentor you wish to work with.";
$langGoToPrograms = "See our programs";
$langInfoHomeText = "Here you can look for the mentor who will help you face the challenges of your professional life or become a mentor yourself and share with someone being guided the various professional experiences you have had.";
$langGoToMentors = "See our mentors";
$langInfoMentors = "Choose the mentor you wish to work with.";
$langInfoMentorsText = "Our available mentors can guide you and support you in various professional fields. Search for the industry you desire and find the mentor who will help you meet your professional life.";
$langInfoProgramsText = "Have you chosen the mentor you want to work with?</br>
                            Search for the program your mentor supports and become a member.";
$langShowMentoringPlatform = "Meet the Mentoring platform";
$langInfoMyProgramsText = "All my available programs in which I</br>participate either as a facilitator, mentor or mentee.";
$langInfoMyDeactiveProgramsText = "All my unavailable programs in which I</br>participate either as a facilitator, mentor or mentee.";
$langInfoMyProfileText = "Available profile for all users.</br>Available user information about their participation in a program.";
$langRequestsPrograms = "Program Requests";
$langProgramUsers = "Program users";
$langInfoUserProgramsText = "Here you will find all available users</br>participating as group mentors in the current program.";
$langInfoUserGroupText = "Here you will find all available users</br>participating as mentors in this group.";
$langInfoHistoryMeetingsText = "Here you will find all the meeting history, meetings that are active and meetings that have expired.";
$langNextMeeting = "Next meeting";
$langNoExistMeetings = "There are no meetings available";
$langInfoMeetingsText = "Here you will find all your available meetings up to a month later.</br>You can also see the history of appointments from the <<appointment history>> option.";
$langWithMentor = "with the person in charge";
$langMeetingNotStartedYet = "The meeting has not started yet";
$langInfoActionProgramText = "Below you can use the energy log for the current program about the tools available to the teams.";
$langInfoCreateProgramText = "Create the program that will utilize the requirements of the mentees.</br>Choose the appropriate mentors for this program and create a plenary group common to all members of the program.";
$langInfoEditProgramText = "Now you have the ability to leverage the program and set it up to provide everything a program mentee is looking for.";
$langAlwaysActiveMentoringPlatform = "Always on";
$langTutorMentor = "Coordinator - Mentor";
$langMentee = "Mentee";
$langProfRegTutorMentor = "Requests for coordinators - mentors";
$langUserOpenMentee = "Mentee requests";
$linkRegTutorMentor = "Coordinator - mentor registration";
$langReqHaveClosedTutorMentor = "Open requests for coordinators - mentors";
$langUserOpenMenteeRequests = "Mentee requests";
$langOpenProfessorTutorMentorRequests = "Open requests for coordinators - mentors";
$langMenteeDetails = "Enroll mentee";
$langProfTutorMentorReg = 'Coordinator - mentor registration';
$langsOfMentee = "Mentees";
$langsOfTutorMentor = "Coordinators - Mentors";
$langProfTutorMentorOnly = "to the coordinators - mentors";
$langMenteesOnly = "to the mentees";
$langProfileInfoTutors = "display to moderators";
$langSuchAsTutorMentor = "Coordinator - mentor";
$langUserMenteeRequest = "Request to create a mentee account";
$langReqRegTutorMentor = "Request to create a coordinator-mentor account";
$langBackPage = "Back";
$langPressMessage = "Write your message...";
$langBelowDaysMentor = "In the calendar below you can find the available contact hours of the person in charge.";
$langInfoMentorsText2 = "See all available information about the mentor you selected.</br>You can also see all the programs in which he participates.";
$langNoGroupRegMentees = "Unregistered mentees";
$langMenteeCanSendGroupRequest = "Mentees can send a registration request";
$langOpRegReq = "Registration request option";
$langGroupAllowMenteeUnregister = "Mentees are allowed to unsubscribe";
$langGroupAllowMenteeRegistration = "Mentees are allowed to register";
$langRequestsExist = "Collaboration requests";
$langInfoGroupSpaceText = "Explore the team workspace.</br>See available tools and contact hours available.";
$langInfoWallGroupSpaceText = "Explore the team workspace.</br>See available tools and available team wall.";
$langInfoDivGroupSpaceText = "Here you will find all the available sub-groups of the program.</br>Register in a group with the manager you wish to have a collaboration with.";
$langCreateMeeting = "Would you like to create a meeting to communicate</br>with a team member?";
$langAddAvailableDateHour = "Would you like to add your available days and times</br>contact?";
$langPostWall = "Wall hangings";
$langNoWallPostsMentoring = "There are no posts on the group wall";
$langInfoGroupAnnouncementText = "All the team announcements are in the table below.</br>See the latest team announcements by selecting the one you want.";
$langInfoGroupForumText = "Now you have the possibility to create a discussion topic</br>and exchange opinions with the members of the group.";
$langInfoWallText = "You now have the option to make a post on the group wall.<br>Make a post if you wish.";
$langHasNoAcceptedBookingYet = "It has not yet been accepted by the person in charge.</br>You will be informed soon by email.</br></br>You can cancel your reservation if you wish.";
$langMyMeetings = "My meetings";
$langMyBookings = "My bookings";
$langInfoGroupWallCommentsText = "You can now add a comment to a user's post.</br>Want to comment on a post?</br>Make a comment.";
...
$langKeySuccessMsg = "Keyword successfully added";
$langMissingKeyNameMsg = "Please enter a keyword.";
$langDontSelectKeyNameMsg = "You did not select a keyword. Try again.";
$langDelKeyNameMsgSuccess = "Keywords removed successfully.";
$langInfoGroupMentoringSpaceText = "In the counseling area you will find the available groups of the program.</br>
Do you want to share different opinions with all the members of the program?</br>
In the plenary group you have the possibility.</br>
Do you want to work with a program mentor?</br>
In the user groups, find the manager you are looking for and register.";
$langShareInCommonGroup = "Share your views with the program members.</br>Make a post on the plenary wall.";
$langShareInGroups = "Find the mentor you want to work with.</br>Sign up for the group.";



$langNoTutorAsMenteeFromAdminTool = "The action concerning the user with coordinator-mentor capacity not to participate as
guided , not completed as there are users participating in programs.
They should be removed from them and try again.</br>
Users are:</br></br>";
$langCreateEditDelDoc = "(file upload,edit,delete)";
$langManageDocs = "Allow users to manage files";
$langMentoringIntro = "Introductory text";
$langAddText = "Add text";
$langdelHomePageIntroSuccess = "Introductory text deleted.";
$langOutSideHomePage = "external home page";
$langInsideHomePage = "internal home page";
$langMentoringAdminCreateHomeTexts = "Internal home page texts";
$langRegUserGroup = "registered users of the group";
$langDateMaxHour = "Your available time should be half an hour or one hour long";
$langRentezvousMaxHour = "Your available appointment should be half an hour or one hour long";
$langTranslation = "Translation";
$langTranslationExisting = "Translation of an existing skill";
$langAddTranslationSuccessMsg = "The translation was successful";
$langHasTranslated = "It has been translated into:";
$langDatesHourTutorAvailability = "Contact days and hours of the group manager";
$langAllowUnregMenteeFromProgram = "Can the mentee unsubscribe from the program?";
$langUnregProgramMentee = "Unsubscribe from the program";
$langHasUnregisteredSuccess = "You have been successfully unsubscribed from the program.";
$langNolangHasUnregisteredSuccess= "Your unsubscribe from the program was not completed successfully. Try again.";
$langMentorAsTutorProgram = "Can a mentor create a program as a program coordinator?";
$langNoMentorAsTutorProgram = "The action for a mentor to be able to create a program as a moderator is not complete
as there is a mentor who has already created a program. You should delete the program or remove the mentor from the moderator and choose someone else.
</br>Below are the mentors who are program coordinators:</br>";
$langMentorAsTutorExistMsg = "The action to prevent a mentor from creating a program as a moderator has been completed successfully.</br>
But there are some mentors who previously became coordinators.</br>
If you want you can remove them.</br>
Below are the specific mentors as program coordinators:</br>";
$langNoGroupRegUsers = "Unregistered users";
$langLimitGroupNotAllowed = "Enrollment limit not allowed";
$langInfoAutomaticallyRegMentor = "<strong>NOTE</strong></br>
When creating the plenary group, the mentors you selected in the specific program will automatically join the group.</br>
If the number of participants in the group is less than the number of mentors, then some of them will not automatically join the group
and they should register themselves in that group if the groups registration limit is allowed.";
$langBookingHasCalceledOne = "The booking successfully removed.";
$langOnlyNumbersLetters = "The code must contain only letters and numbers.";
