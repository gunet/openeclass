...
$langAboutExercise = "Riguardo l'esercizio";
$langEditQuestions = "A proposito delle domande";
...
$langConfirmEnableIndex = "The indexing process requires <strong>certain time period and computing resources</strong>, depending on the size of the DataBase.<br/><br/>The process will run in a <strong>separate browser window</strong>.<br/><br/>Furthermore, indexing <strong>is not</strong> available if platform is installed on <strong>NFS filesystem</strong>.<br/><br/><em>Cancel</em> your choice if you wish to start the indexing at a <strong>different</strong> time.";
...
$lang_allow_rec_video = "Allow video file creation in $langsCourse";
$lang_allow_rec_audio = "Allow recording file creation in $langsCourse";
...
$lang_hide_login_link = "Don't display a link to the homepage";
