...
$langePortfolioSocialActivitiesDescr = "<h3>Κοινωνικές Δράσεις</h3>
<p>Καταγράψτε τη συμμετοχή σας σε δραστηριότητες που έχουν κοινωνικό ή κοινοτικό χαρακτήρα, όπως οργανώσεις, ομάδες ή πρωτοβουλίες που στοχεύουν στην κοινωνική ανάπτυξη και ευαισθητοποίηση.</p>
...
$langePortfolioVolunteerActivitiesDescr = "<h3>Εθελοντικές Δράσεις</h3>
<p>Καταγράψτε τη συμμετοχή σας σε εθελοντικές πρωτοβουλίες όπου προσφέρετε υπηρεσίες ή βοήθεια χωρίς αμοιβή, όπως σε φιλανθρωπικές εκδηλώσεις, κοινωνικές υπηρεσίες ή οργανώσεις.</p>
