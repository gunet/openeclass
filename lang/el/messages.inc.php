...
/* * ********************************************************************
  mentoring
 * ********************************************************************* */
$langMentoringPlatform = "Πλατφόρμα mentoring";
$langEnableMentoringPlatform = "Ενεργοποίηση Mentoring πλατφόρμας";
$langEnableMentoringPlatformSuccess = "Η πλατφόρμα mentoring ενεργοποιήθηκε επιτυχώς."; 
$langDisableMentoringPlatformSuccess = "Η πλατφόρμα mentoring απενεργοποιήθηκε επιτυχώς."; 
$langDisableMentoringPlatform = "Ενεργοποίηση Mentoring πλατφόρμας";
$langMentoringPlatforms = "Πλατφόρμας mentoring";
$langSignOut = "Αποσύνδεση";
$langViewMentoring = "Προβολή μέντορα";
$langHomeMentoringPlatform = "Αρχική";
$langProgramS = "προγράμματος";
$langNoDeleteMentorAsMemberOfProgram = "Η ενέργεια δεν ολοκληρώθηκε. Ο χρήστης συμμετέχει ως μέντορας σε κάποιο πρόγραμμα.
                                        Αφαιρέστε τον συγκεκριμένο μέντορα από το πρόγραμμα που συμμετέχει και δοκιμάστε πάλι.";
$langBackHomeMentoringPlatform = "Επιστροφή στην αρχική σελίδα mentoring πλατφόρμας";
$langBackHomeMentoringProgram = "Επιστροφή στην αρχική σελίδα του προγράμματος" ;
$langOurMentors = "Οι μέντορες μας";
$langConditionMentoring = "Κατάσταση";
$langOurMentoringPrograms = "Τα προγράμματά μας";
$langMyPrograms = "Τα προγράμματά μου";
$langAvailableUntilMentoringProgram = "Διαθέσιμο";
$langAvailablePrograms = "Διαθέσιμα προγράμματα που συμμετέχετε ως συντονιστής ή μέντορας";
$langAllMentoringPrograms = "Ολα τα προγράμματα";
$langViewMentoringProgram = "Προβολή Προγράμματος";
$langNoAvailablePrograms = "Μη διαθέσιμα προγράμματα που συμμετέχετε ως συντονιστής ή μέντορας";
$langAvailableGuidedPrograms = "Διαθέσιμα προγράμματα που συμμετέχετε ως καθοδηγούμενος";
$langNoParticipateAsGuided = "Δεν συμμετέχετε σε κάποιο πρόγραμμα ως καθοδηγούμενος";
$langWelcomeMentoringPlatform = "Καλώς ήρθατε στην πλατφόρμα mentoring του Open Eclass";
$langBackToDefaultPlatform = "Κύρια πλατφόρμα του Open Eclass";
$langEnableMentoringPlatform = "Ενεργοποίηση Πλατφόρμας mentoring";
$langDisableMentoringPlatform = "Απενεργοποίηση Πλατφόρμας mentoring";
$langRegisterMentoringProgram = "Κάντε την εγγραφή σας";
$langUnRegisterMentoringProgram = "Απεγγραφή από το πρόγραμμα";
$langRegisterDoneMentoringProgram = "Η εγγραφή σας ολοκληρώθηκε επιτυχώς.";
$langMentoringName = "Πρόγραμμα καθοδήγησης";
$langMentoringInfo = "Πληροφορίες προγράμματος";
$langMentoringEdit = "Επεξεργασία προγράμματος";
$langNoMentorsAdded = "Παρακαλώ επιλέξτε τουλάχιστον έναν μέντορα.";
$langMentoringSpace = "Χώρος συμβουλευτικής";
$langShowMentoringProgramms = "Διαθέσιμα προγράμματα καθοδήγησης";
$langShowDisableMentoringProgramms = "Μη ενεργά προγράμματα";
$langAddMentoring = "Προσθήκη Προγράμματος";
$langEditMentoring = "Επεξεργασία προγράμματος";
$langNoMentoringPrograms = "Δεν υπάρχουν διαθέσιμα προγράμματα καθοδήγησης";
$langCreateMentoringProgramms = "Δημιουργία προγράμματος καθοδήγησης";
$langMentoringTutor = "Συντονιστής";
$langMentoringTutors = "Συντονιστές προγράμματος";
$langSendMessageTopicMentoring = "έχει στείλει ένα μήνυμα";
$langMentoringMentors = "Μέντορας";
$langNoAvailableMentoringMentors = "Δεν υπάρχουν διαθέσιμοι μέντορες";
$langMentoringMentorss = "Μέντορες προγράμματος";
$langDescrMentoringProgram = "Περιγραφή προγράμματος καθοδήγησης";
$langMentoringMentor = "Επιλογή μέντορα";
$landAddMentor = "Προσθήκη ως" ;
$landDeleteMentor = "Αφαίρεση από" ;
$langmentor = "μεντορα";
$langAreYouMentee = "Είστε καθοδηγούμενος?";
$langAvailableMentorProfile = "Ενεργός μέντορας";
$langNoAvailableMentorProfile = "Μη ενεργός μέντορας";
$langReqMentoringDone = "Το πρόγραμμα καθοδήγησης δημιουργήθηκε με επιτυχία.";
$langNoReqMentoringDone = "Το πρόγραμμα καθοδήγησης δεν ολοκληρώθηκε.";
$langCodeExistMentoring = "Ο κωδικός που επιλέξατε υπάρχει ήδη. Επιλέξτε έναν διαφορετικό.";
$langNoEditMentoring = "Η επεξεργάσια δεν ολοκληρώθηκε επιτυχώς. Δοκιμάστε ξανά.";
$langNotDeleteMentorAsTutorOfGroup = "Η ενέργεια δεν μπορεί να εκτελεστεί διότι αφαιρέσατε μέντορα που είναι υπεύθυνος σε κάποια ομάδα του προγράμματος.";
$langDoDeleteMentoringProgram = "Είστε σίγουρος/η ότι θέλετε να προχωρήσετε στη διαγραφή του προγράμματος με κωδικο";
$langDelMentoringComplete = "Η διαγραφή του προγράμματος ολοκληρώθηκε με επιτυχία.";
$langUntilMentoringProgram = "Το πρόγραμμα είναι διαθέσιμο μέχρι: ";
$langAvailableMentor = "Τα διαθέσιμα ραντεβού του";
$langRentezvousMentee = "Τα διαθέσιμα ραντεβού μου";
$langWithDrawAlForMentee = "Αποχώρηση από το ραντεβού";
$MsgWithDrawAlMentee = "Είστε σίγουρος/η ότι θέλετε να αποχωρήσετε απο το συγκεκριμένο ραντεβού?";
$withDrawAlMenteeSuccessMsg = "Η αποχώρηση σας από το ραντεβού ολοκληρώθηκε επιτυχώς.";
$langAddViewDateMentor = "Προβολή/Προσθήκη διαθέσιμης ημερομηνίας";
$langIsMendorChooser = "Εχετε επιλεγεί ως μέντορας του συγκεκριμένου προγράμματος.";
$langIsTutorChooser  = "Είστε ο συντονιστής του συγκεκριμένου προγράμματος.";
$langAreYouMentor = "Είστε μέντορας?";
$langAreYouTutor = "Είστε συντονιστής?";
$langAreYouGuided = "Είστε καθοδηγούμενος?";
$langParticipateAsMentor = "Προγράμματα στα οποία συμμετέχει ως μέντορας";
$langRequestMentoring = "Αίτημα συμμετοχής στο πρόγραμμα";
$langNoRequestMentoring = "Δεν μπορείτε να στείλετε αίτημα συνεργασίας καθώς συμμετέχετε ως συντονιστής ή μέντορας του συγκεκριμένου προγράμμτος";
$langNoExistMentorInProgram = "Δεν συμμετέχει σε κάποιο πρόγραμμα ως μέντορας.";
$langHasSendRequestMentoring = "Έχετε στείλει αίτημα συνεργασίας.";
$langHasSendRequestGroupMentoring = "Το αίτημα έχει σταλεί.";
$langMeetingIsActive = "Το meeting βρίσκεται σε εξέλιξη";
$langMeetingIsDeactivate = "Το meeting έχει λήξει";
$langSendRequestGroupSuccess = "Το αίτημα στάλθηκε επιτυχώς στον υπεύθυνο της ομάδας.";
$langSendRequestGroupNoSuccess = "Το αίτημα δεν στάλθηκε. Δοκιμάστε παλι.";

$langCancelRequestGroupNoContinue = "Δεν μπορείτε να ακυρώσετε το αίτημα. Είναι υπό επεξεργασία.";
$langReqNoModify = "Δεν μπορείτε να επεξεργαστείτε το αίτημα. Ο χρήστης το έχει ακυρώσει.";
$langReqUserToGroupNoCompleteIsMemberInOther = "Ο χρήστης δεν μπορεί να εγγραφεί στην ομάδα. Υπάρχει όριο εγγραφής των χρηστών</br>
                                                να εγγράφονται σε μία μόνο ομάδα και ο συγκεκριμένος χρήστης συμμετέχει σε κάποια άλλη.";

$langCancelRequestGroupSuccess = "Το αίτημα ακυρώθηκε επιτυχώς.";
$langCancelRequestGroupNoSuccess = "Το αίτημα δεν ακυρώθηκε. Δοκιμάστε παλι.";
$langCancelSendRequest = "Ακύρωση αιτήματος";
$langSendGroupRequest = "Αίτημα εγγραφής στην ομάδα";

$langRegisterGroupMentoringSuccess = "Η εγγραφή σας έγινε επιτυχώς. Μπορείτε να εισέλθετε στο χώρο εργασίας της ομάδας.";
$langRegisterGroupMentoringNoSuccess = "Η εγγραφή σας δεν ολοκληρώθηκε επιτυχώς.</br>
                                        Υπάρχει όριο εγγραφής στις ομάδες και εσείς συμμετέχετε ήδη σε μία.";

$langUnRegisterGroupMentoringSuccess = "Η απεγγραφή σας έγινε επιτυχώς. Αυτη τη στιγμη δεν έχετε δικαίωμα πρόσβασης στο χώρο εργασίας της ομάδας.";
$langUnRegisterGroupMentoringNoSuccess = "Η απεγγραφή σας δεν ολοκληρώθηκε επιτυχώς. Δοκιμάστε πάλι.";

$langGroupMentoringMembers = "Μέλη ομάδας";
$langInfinityNumber = "Απεριόριστος αριθμός";
$langGroupIsFull = "Η ομάδα είναι πλήρης";
$langEditorOfGroup = "Υπεύθυνος ομάδας";
$langEditorsOfGroup = "Υπεύθυνοι ομάδας";
$langMemberOfProgram = "Μέλος προγράμματος";
$langSettingsRegistrationOfGroup = "Ρυθμίσεις εγγραφής καθοδηγούμενων στις ομάδες";
$langSettingsRegistrationOfGroup2 = "Ρυθμίσεις εγγραφής";
$langDeleteAllMentoringGroups = "Διαγραφή όλων των ομάδων";
$langRegOneGroup = "Η επεξεργασία ολοκληρώθηκε. Ο καθοδηγούμενος μπορεί να εγγραφεί μόνο σε μία ομάδα του προγράμματος.";
$langRegManyGroup = "Η επεξεργασία ολοκληρώθηκε. Ο καθοδηγούμενος μπορεί να εγγραφεί σε περισσότερες από μία ομάδα του προγράμματος.";
$langRegOneOrManyGroupsNoSuccess = "Κάτι πήγε λάθος. Δοκιμάστε πάλι.";

$langIsMenteeAtleastOneGroupError = "Έχετε εγγραφεί ήδη σε μία ομάδα, δεν επιτρέπεται σε άλλη.";
$langRequestCanceledByGroupSettings = "<span class='text-danger TextSemiBold'>Το αίτημα σας ακυρώθηκε</br>καθως υπάρχει όριο εγγραφής σε μία μόνο ομάδα.</span>";

$langAbilityRegisterToOneGroup = "Δυνατότητα εγγραφής (Σε μία ομάδα)";
$langMenteeRegisterToOneGroup = "Οι καθοδηγούμενοι μπορούν να εγγραφούν σε μία ομάδα";
$langAbilityRegisterToManyGroup = "Δυνατότητα εγγραφής (Σε περισσότερες από μία ομάδες)";
$langMenteeRegisterToManyGroup = "Οι καθοδηγούμενοι μπορούν να εγγραφούν σε περισσότερες από μία ομάδες";

$langBackToGroupsPage = "Πίσω";
$langEditGroupMentoring = "Επεξεργασία ομάδας";

$langExistsMenteesToParticipateInManyGroups = "Η ενέργεια δεν μπορεί να εκτελεστεί διότι υπάρχουν καθοδηγούμενοι που συμμετέχουν σε περισσότες από μία ομάδες.";

$langStandByState = "Σε αναμονή";
$langRequestSendSuccess = "Το αίτημα στάλθηκε επιτυχώς";
$langNoRequestSendSuccess = "Το αίτημα δεν στάλθηκε. Δοκιμάστε πάλι.";
$langCancelRequest = "Ακύρωση αιτήματος";
$langCancelRequestSuccess = "Το αίτημα ακυρώθηκε επιτυχώς.";
$langCancelRequestNoSuccess = "Το αίτημα δεν ακυρώθηκε.";
$langAvailableDatesContact = "Προσθήκη Meeting με τον υπεύθυνο ομάδας ";
$langBackMentoringProgram = "Επιστροφή στη σελίδα του προγράμματος";
$langDeleteRentezvous = "Διαγραφή διαθέσιμης ημερομηνίας";
$langDeleteAvailableDate = "θέλετε να προχωρήσετε στην συγκεκριμένη διαγραφή?";
$langRedInfoRentezvousOtherProgram = "Με <span class='text-danger TextBold'>κόκκινο</span> χρώμα εμφανίζονται οι διαθέσιμες ημέρες επικοινωνίας που έχετε καταχωρίσει ως υπεύθυνος ομάδας σε άλλα προγράμματα.";
$langRedInfoRentezvous = "Με <span class='text-danger TextBold'>κόκκινο</span> χρώμα εμφανίζονται οι διαθέσιμες ημέρες επικοινωνίας άλλων υπευθύνων σε άλλες ομάδες στο τρέχων πρόγραμμα.";
$langSuccessInfoRentezvous = "Με <span class='text-success TextBold'>πράσινο</span> χρώμα εμφανίζονται οι διαθέσιμες ημέρες επικοινωνίας που έχετε καταχωρίσει στο τρέχων πρόγραμμα</br>
                           στην τρέχων ομάδα ως υπεύθυνος.";
$langWarningInfoRentezvous = "Με <span class='text-warning TextBold'>πορτοκαλί</span> χρώμα εμφανίζονται οι διαθέσιμες ημέρες επικοινωνίας που έχει καταχωρίσει κάποιος άλλος</br>
                              υπεύθυνος ομάδας στο τρέχων πρόγραμμα στη τρέχων ομάδα.";
$langInfoInfoRentezvous = "Με <span class='text-info TextBold'>γαλάζιο</span> χρώμα εμφανίζονται οι διαθέσιμες ημέρες επικοινωνίας που έχετε καταχωρίσει ως</br>
                              υπεύθυνος ομάδας στο τρέχων πρόγραμμα σε άλλη ομάδα.";
$langPinkInfoRentezvous = "Με <span style='color:#FFC0CB;' class='TextBold'>ροζ</span> χρώμα εμφανίζεται η κράτηση που έχει γίνει από κάποιο μέλος της ομάδας.";



$langRedInfoMeeting = "Με <span class='text-danger TextBold'>κόκκινο</span> χρώμα εμφανίζονται τα διαθέσιμα meetings που έχετε καταχωρίσει ως υπευθυνος ομάδας σε άλλα πρόγραμμα.";
$langSuccessInfoMeeting = "Με <span class='text-success TextBold'>πράσινο</span> χρώμα εμφανίζονται τα διαθέσιμα meetings που έχετε καταχωρίσει ως υπευθυνος ομάδας στο τρέχων πρόγραμμα</br>
                           στην τρέχων ομάδα ως υπεύθυνος.";
$langWarningInfoMeeting = "Με <span class='text-warning TextBold'>πορτοκαλί</span> χρώμα εμφανίζονται τα διαθέσιμα meetings που έχει καταχωρίσει κάποιος άλλος</br>
                              υπεύθυνος ομάδας στο τρέχων πρόγραμμα στη τρέχων ομάδα.";
$langInfoInfoMeeeting = "Με <span class='text-info TextBold'>γαλάζιο</span> χρώμα εμφανίζονται τα διαθέσιμα meetings που έχετε καταχωρίσει ως</br>
                              υπεύθυνος ομάδας στο τρέχων πρόγραμμα σε άλλη ομάδα.";



$langContinueActionRequest = "Θέλετε να προχωρήσετε στην συγκεκριμένη ενέργεια;";
$langNoExistMentoringRequests = "Δεν υπάρχουν αιτήματα συνεργασίας";
$langAcceptRequest = "Αποδοχή αιτήματος";
$langDenyRequest = "Απόρριψη αιτήματος";
$langTutotHasDeniedRequest = "Το αίτημα σας έχει απορριφθεί από τον συντονιστή του προγράμματος.";
$langDeleteRequest = "Διαγραφή αιτήματος";
$langFreeMeeting = "Δεν υπάρχει κωδικός. Ελεύθερη πρόσβαση.";
$langRequestsHasAccepted = "Αιτήματα που έχετε αποδεχτεί";
$langRequestsHasDenied = "Αιτήματα που έχετε απορρίψει";
$langRequestReset = "Επαναφορά";
$langMentoringAction = "Καταγραφή ενεργειών προγράμματος";
$langUntilNow = "Μέχρι σήμερα";
$langAboutWith = "Σχετικά με";
$langDirectory = "Φάκελος";
$langNoActionsExists = "Δεν έχουν καταγραφεί ενέργειες για το συγκεκριμένο υποσύστημα.";
$langProfileAsMentor = "Το προφίλ μου ως μέντορας";
$langProfileAsGuided = "Το προφίλ μου ως καθοδηγούμενος";
$langProfileAsTutor = "Το προφίλ μου ως συντονιστής";
$langProfileAsAdmin = "Το προφίλ μου ως διαχειριστής";
$langMoreChoices = "Περισσότερες επιλογές";
$langNoChangeRentezvousOtherUser = "Δεν μπορείτε να αλλάξατε το ραντεβού άλλου χρήστη";
$langChangeRentezvousSuccess = "Το ραντεβού σας άλλαξε επιτυχώς";
$langDeleteRentezvousSuccess = "Το ραντεβού σας διαγράφηκε επιτυχώς";
$langDeleteRentezvousNoUser = "Δεν μπορείτε να διαγράψατε το ραντεβού άλλου χρήστη.";
$langAddRentezvousSuccess = "Η προσθήκη του ραντεβού σας έγινε με επιτυχία.";
$langGuidedProgramParticipate = "Καθοδηγούμενοι που συμμετέχουν στο πρόγραμμα";
$langDeleteGuidedMentoring = "Διαγραφή καθοδηγούμενου από το συγκεκριμένο πρόγραμμα";
$langDeleteGuidedSuccess = "Η διαγραφή του καθοδηγούμενου ολοκληρώθηκε με επιτυχία.";
$langNoDeleteGuidedSuccess = "Η διαγραφή του καθοδηγούμενου δεν ολοκληρώθηκε με επιτυχία. Δοκιμάστε πάλι.";
$langMentoringGroupSpace = "Χώρος συμβουλευτικής";
$langGroupMentorsMentees = "Ομάδες Μέντορα - καθοδηγούμενου";
$langCreateMentoringGroup = "Δημιουργία ομάδας";
$langMentees = "Καθοδηγούμενοι";
$langMentee = "Καθοδηγούμενος";
$langMaxMentees = "Μέγιστος αριθμών καθοδηγούμενων";
$langNoGroupMentoring = "Η ομάδα δεν δημιουργηθήκε. Δοκιμάστε πάλι.";
$langNoMenteesExistInGroup = "Δεν υπάρχουν εγγεγραμένοι καθοδηγούμενοι στην συγκεκριμένη ομάδα";
$langDeleteMenteeFromGroup = "Αφαίρεση από την ομάδα";
$langDeleteMentoringGroup = "Διαγραφή ομάδας"; 
$langDeleteMentoringGroupMsg = "Προσοχή! Αν διαγράψετε την ομάδα, θα αφαιρεθούν όλα τα περιεχόμενα και όλοι οι χρήστες που είναι εγγεγραμένοι.</br>
                                Θέλετε να συνεχίσετε?";
$langDeleteMenteeFromGroupSuccess = "Ο χρήστης αφαιρέθηκε από την ομάδα";
$langDeleteMenteeFromGroupNoSuccess = "Η διαγραφή δεν ολοκληρώθηκε. Δοκιμάστε πάλι.";
$langDeleteMenteeFromGroupCheck = "Πρόκειται να γίνει αφαίρεση του χρήστη από την ομάδα.</br>
                                   Επιπλέον θα αφαιρεθούν όλα τα μηνύματά του χρήστη που έχουν σταλεί στις συζητήσεις της ομάδας καθώς και οι κρατήσεις του για επικοινώνια.</br>
                                   Θέλετε να προχωρήσετε?";

$langQuestionDeleteAllMentoringGroups = "Πρόκειται να διαγραφούν όλες οι ομάδες του συγκεκριμένου προγράμματος</br>
                                         και όσοι χρήστες συμμετέχουν σε αυτές.</br>
                                         Θέλετε να προχωρήσετε στην συγκεκριμένη ενέργεια?";
$langDeleteAllMentoringGroupsSuccess = "Η διαγραφή όλων των ομάδων ολοκληρώθηκε με επιτυχία";
$langDeleteAllMentoringGroupsNoSuccess = "Η διαγραφή όλων των ομάδων δεν ολοκληρώθηκε. Δοκιμάστε πάλι.";
$langNoGroupMentees = "Δεν έχουν ορισθεί ομάδες καθοδηγούμενων";
$langDeleteMentoringGroupSuccess = "Η διαγραφή της ομάδας ολοκληρώθηκε με επιτυχία.";
$langDeleteMentoringGroupNoSuccess = "Η διαγραφή δεν ολοκληρώθηκε. Δοκιμάστε πάλι.";

$langAboutMentoring = "
<p class='text-center mt-0'><strong class='text-capitalize fs-5'>Τι είναι το mentoring</strong></p>
Ο μέντορας βοηθάει τον καθοδηγούμενο να πετύχει τους στόχους που σχετίζονται με την επαγγελματική του εξέλιξη.
Οργανώνει ένα πλάνο με το να μοιράζεται διάφορες εμπειρίες και γνώση που έχει αποκτήσει κατά τη διάρκεια της δικής του πορείας. 
Ουσιαστικά, είναι το εργαλείο που βοηθάει τους καθοδηγούμενους να φτάσουν όσο πιο ψηλά μπορούν σχετικά με τους στόχους που έχουν θέσει.
";

$langAboutMentoring2 = "
<p class='text-center mt-0'><strong class='text-capitalize fs-5'>Τι δεν είναι</strong></p>
Το mentoring δεν είναι εκπαίδευση, coaching, παροχή υπηρεσιών, ψυχοθεραπεία. 
Ο μέντορας δεν γνωρίζει τα πάντα, αλλά διευκολύνει τη διαδικασία της ανάπτυξης του καθοδηγούμενου.
";

$langAboutMentoring3 = "

<p class='text-center mt-0'><strong class='text-capitalize fs-5'>Πως ακριβώς λειτουγεί</strong></p>
<div class='col-12 text-start'>
  <div class='d-flex'>
    <span class='TextBold'> 1) </span> 
    <span class='ms-1'>συναντήσεις πρόσωπο με πρόσωπο</span>
  </div>

  <div class='d-flex mt-2'>
    <span class='TextBold'> 2) </span> 
    <span class='ms-1'>επικοινωνία μέσω online πλατφόρμας, Skype, Zoom, Microsoft Teams, τηλέφωνο κτλ</span>
  </div>

  <div class='d-flex mt-2'>
    <span class='TextBold'>3)</span> <span class='ms-1'>όρος «shadowing», όπου ο καθοδηγούμενος παρακολουθεί το μέντορά του επί τω έργω</span>
  </div>
</div><br>
";
...
$langAboutMentoring4 = "
<p class='text-center'><strong class='text-capitalize fs-5'>Σε ποιους απευθύνεται</strong></p>
<p class='text-center'>Σε όσους θέλουν να κάνουν πραγματικότητα τα επαγγελματικά τους όνειρα, 
να μοιραστούν την εμπειρία τους ή ακόμα καλύτερα και τα δύο!</p>
";

$langDocsMentoringGroups = "Έγγραφα";
$langForumMentoringGroups = "Συζητήσεις";
$langAllMenteesMentoringGroups = "Μέλη";
$langRequestsRegisterGroups = "Αιτήματα εγγραφής";
$langMananeDocMentees = "Ρυθμίσεις εγγράφων για τους χρήστες";
$langRequestsRegisterGroupsNoExists = "Δεν υπάρχουν αιτήματα εγγραφής";
$langExistRequestToMentoringGroup = "Υπάρχουν αιτήματα από καθοδηγούμενος που θέλουν να εγγραφούν στην ομάδα.";
$langAcceptRequestForGroupMentees = "";
$langReuestHasCanceledFromUser = "Προειδηποίηση! Ο χρήστης έχει ακυρώσει το αίτημα του. Η επεξεργασία του αιτήματος δεν ολοκληρώθηκε.";
$langCancelRequestIsModified = "Δεν μπορείτε να προχωρήσετε στην συγκεκριμένη ενέργεια. Το αίτημα βρίσκεται υπο επεξεργασία από τον συντονιστή του προγράμματος.";
$langRegisterDoneMenteesOfGroup = "Καθοδηγούμενοι που συμμετέχουν στην συγκεκριμένη ομάδα";
$langCreateTopicMentoringGroup = "Προσθήκη θέματος συζήτησης";
$langTopicCreate = "Το θέμα δημιουργήθηκε με επιτυχία.";
$langTopicDontCreateEmptyMessage = "Το θέμα δεν δημιουργήθηκε. Ισως αφήσατε κάποια υποχρεωτικά πεδία κενά.";
$langAnswerTopicMentoringGroup = "Απάντηση στο θέμα";
$langDeleteAllMessagesOfTopic = "Διαγραφή όλων των μηνυμάτων";
$langMessagesOfTopicHasDeleted = "Τα μηνύματα διαγράφηκαν επιτυχως.";
$langDeleteAllMessagesOfTopicQuestion = "Πρόκειται να διαγραφούν όλα τα μηνύματα. Θέλετε να προχωρήσετε?";
$langTopicDontAnswerEmptyMessage = "Το θέμα δεν απαντήθηκε. Ισως αφήσατε κάποια υποχρεωτικά πεδία κενά.";
$langAcceptRequestMsg = "<p class='fs-6 TextBold mb-0'>Πρόκειται να επεξεργαστείτε το συγκεκριμένο αίτημα.</p>
                         <strong class='TextRegular'>1) Αν απορρίψετε το αίτημα τότε χρήστης δεν θα μπορεί να ξαναστείλει μέχρι να το επαναφέρετε.</br>
                                 2) Αν το διαγράψετε τότε ο χρήστης θα μπορεί να ζητήσει εκ νέου εγγραφή στέλνοντας αίτημα.</strong>";
$langNoInfoForMentees = "Δεν υπάρχουν πληροφορίες σχετικά με τον συγκεκριμένο χρήστη.";
$langNoInfoForDatesMentor = "Δεν υπάρχουν πληροφορίες σχετικά με τον χρήστη.";
$langUntilOneMonth = "Μέχρι ένα μήνα μετά";
$langAddDateAvailableMentor = "Δημιουργία meeting";
$langMyAvailableDates = "Ημέρες και ώρες επικοινωνίας στο τρέχων προγράμμα για --> ";
$langReqEditMsg = "Το αίτημα επεξεργάστηκε επιτυχώς.";
$langReqDeniedFromTutor = "Το αίτημά σας έχει απορριφθεί.";
$langNoForumMentoring = "Δεν υπάρχουν θέματα συζητήσεων στην συγκεκριμένη ομάδα.";
$langEditTopicMentoring = "Επεξεργασία μηνύματος";
$langDeleteTopicMentoring = "Διαγραφή μηνύματος";
$langDeleteTopicMentoringSuccess = "Το μήνυμα διαγράφηκε επιτυχώς.";
$langSubjectMentoringDeleteSuccess = "Το θέμα έχει διαγραφεί επιτυχώς καθώς και όλη συζήτησή της.";
$langTopicEditSuccessName = "Η ονομασία του θέματος άλλαξε επιτυχώς.";
$langDeleteTopicMentoringMsg = "Θέλετε να προχωρήσετε στη διαγραφή του μηνύματος?";
$langDeleteSubjectMentoringMsg = "<strong>Προσοχή!</strong> Η διαγραφή του συγκεκριμένου θέματος θα διαγράψει και όλο το περιεχόμενο του.</br>Θέλετε να προχωρήσετε?";
$langFileDeleted = "Το αρχείο διαγράφηκε με επιτυχία.";
$langBackDocGroup = "Πίσω στα έγγραφα της ομάδας";
$langConfirmEmptyInput = "Παρακαλώ συμπληρώστε τα υποχρεωτικά πεδία.";
$langHistoryRentezvous = "Ιστορικό ραντεβού";
$langNoExistHistoryRentezvous = "Δεν υπάρχει κάποιο ραντεβού";
$langRemoveFromProgram = "Αφαίρεση χρήστη από το πρόγραμμα";

$langProgramDel = "Διαγραφή προγράμματος";
$langFinalizeProgram = "Δημιουργία προγράμματος";
$langModifyProgram = "Επεξεργασία προγράμματος";
$langProgram = "Πρόγραμμα";
$langProgramInfo = "Πληροφορίες προγράμματος";
$langDocEnable = "εγγραφών προγάμματος";
$langForumEnable = "συζητήσεων προγράμματος";

$langAvailableInPlatform = "Ενεργός/η";
$langAddAvailabilityMentor = "Η ημερομηνία διαθεσιμότητά σας στη πλατφόρμα ολοκληρώθηκε με επιτυχία.";
$langParticipateAsTutorProgram = "Είστε συντονιστής κάποιου προγράμματος?";
$langParticipateAsTutorProgramNoExist = "Δεν συμμετέχετε σε κάποιο πρόγραμμα ως συντονιστής.";
$langParticipateAsMenteeProgramNoExist = "Δεν συμμετέχετε σε κάποιο πρόγραμμα ως καθοδηγούμενος.";
$langMenteeCanRegisterToOneGroup = "Σε αυτό το πρόγραμμα έχετε επιλέξει τον καθοδηγούμενο να μπορεί να εγγραφεί μόνο σε μία ομάδα του προγράμματος.";
$langMenteeCanRegisterToManyGroups = "Σε αυτό το πρόγραμμα έχετε επιλέξει τον καθοδηγούμενο να μπορεί να εγγραφεί σε περισσότερες από μία ομάδες του προγράμματος.";
$langParticipateAsMentorProgram = "Είστε μέντορας κάποιου προγράμματος?";
$langParticipateAsMenteeProgram = "Είστε καθοδηγούμενος κάποιου προγράμματος?";
$langParticipateAsMenteeProgramUser = "Προγράμματα που συμμετέχει ως καθοδηγούμενος";
$langUpgradeDbFist = "<strong>ΣΗΜΕΙΩΣΗ</strong></br>Για να προχωρήσετε στην ενεργοποίση της mentoring πλατφόρμας, θα πρέπει πρώτα να αναβαθμίσετε την βάση σας.";

$langSetAvailableDateForGroup = "Είστε διαθέσιμος;";
$langAddAvailableDateTime = "Καταχωρίστε τις διαθέσιμες ημέρες και ώρες σας, ώστε τα μέλη της ομάδας να μπορούν να επικοινωνήσουν μαζί σας.";
$langDatesAddedComplete = "Η διαθέσιμη ημερομηνία επικοινωνίας προστέθηκε με επιτυχία.";
$langDatesADeletedComplete = "Η διαθέσιμη ημερομηνία διαγράφηκε επιτυχώς";
$langDatesDeletedNotComplete = "Δεν μπορείτε να προχωρήσετε στην συγκεκριμένη ενέργεια καθώς έχει γίνει κράτηση από κάποιον χρήστη για επικοινωνία.</br>
                                Ακυρώστε την συγκεκριμένη κράτηση και δοκιμάστε πάλι.";
$langContactDates = "Ημέρες επικοινωνίας";
$langToolsGroup = "Εργαλεία";
$langAddTagMentor = "Λίστα  ετικετών - προσθήκη ετικέτας σε μέντορα";
$langAddTagMentorSuccessMsg = "Η καταχώριση ετικέτας σε μέντορα ολοκληρώθηκε με επιτυχία.";
$langStepMentoring = "Βήμα";
$langEmploymentSector = "Τομέας απασχόλησης";
$langCommonGroup = "Ομάδα ολομέλειας";
$langUnRegisterDontAllowedFromGroup = "Δεν επιτρέπεται η απεγγραφή απο την ομάδα.";
$langWallProgram = "Τοίχος προγράμματος";

$langAddBooking = "Κάντε κράτηση";
$langBookings = "Κρατήσεις με τον υπεύθυνο της ομάδας";
$langAddBookingSuccess = "Η κράτησή σας έγινε επιτυχώς. Έχει σταλθεί ενημερωτικό email στον υπεύθυνο.";
$langAddBookingByMentee = "Κράτηση για επικοινωνία";
...
$langContinueToDeleteBooking = "Θελέτε να προχωρήσετε στην ακύρωση της κράτησης?";
$langDeleteBookingSuccess = "Η κράτησή σας διαγράφηκε επιτυχώς.";
$langDeleteBookingByMentee = "Ακύρωση κράτησης";
$langBookingHasCalceledAll = "Οι κρατήσεις αφαιρέθηκαν επιτυχώς.";
$langNoExistBookings = "Δεν υπάρχουν διαθέσιμες κρατήσεις.";
$langHasDoingBookingWith = "Έχετε κάνει κράτηση στον υπεύθυνο της ομάδας ";
$langForContanct = "για επικοινωνία";
$langBookingHasBooking = "έχει κάνει κράτηση για να επικοινωνήσει μαζί σας";
$langHasBookingAdminTutor = "έχει κάνει κράτηση για να επικοινωνήσει με τον υπεύθυνο ομάδας";
$langCancelBooking = "Κάντε ακύρωση";
$langBookingHasCalceled = "Η κράτηση ακυρώθηκε επιτυχώς. Έχει σταλθεί ενημερωτικό email στον χρήστη.";
$langBookingHistory = "Κρατήσεις που έχουν παρέλθει";
$langDeleteAllBookings = "Διαγραφή όλων των κρατήσεων";
$langAcceptBooking = "Αποδοχή";
...
$langHasAcceptedBooking = "Έχει γίνει αποδοχή της κράτησης";
...
$langAnnHasPublishedGroup = "Έχει δημοσιευθεί ανακοίνωση στην ομάδα";
$langDeleteAnnouncementGroup = "Η ανακοινώση θα αφαιρεθεί από την ομαδα. Θέλετε να προχωρήσετε?";
$invalidDate = "Λανθασμένη ημερομηνία. Δοκιμάστε πάλι.";
$AnnDelSuccess = "Η ανακοίνωση διαγράφηκε με επιτυχία.";
$langNoExistAnnGroup = "Δεν υπάρχουν ανακοινώσεις για την συγκεκριμένη ομάδα.";
$langEmailNotSendedByInvisibleAnn = "Η κατάσταση της ανακοίνωσης άλλαξε σε μη εμφανής.</br>
                                     Δεν στάλθηκε κάποιο email στους επιλεγμένους χρήστες.";
$langMenteeAllowRegister = "Οι καθοδηγουμενοι επιτρέπεται να εγγραφούν";
$langMenteeAllowUnregister = "Οι καθοδηγουμενοι επιτρέπεται να απεγγραφούν";
$langCanRegisterToGroup = "Δυνατότητα αίτημα εγγραφής";
$langMenteeSendRequest = "Οι καθοδηγουμενοι μπορουν να στείλουν αιτημα εγγραφης";
$langTheTutorsOfProgram = "Οι συντονινστές του προγράμματος";
$langInvalidDates = "Οι ημερομηνίες που καταχωρίσατε δεν είναι έγκυρες. Δοκιμάστε πάλι.";

$langEmptyComment = "Η ενέργεια δεν ολοκληρώθηκε. Το κείμενο ήταν κενό. Δοκιμάστε πάλι.";
$langCommentAddSuccess = "Το σχόλιο προστέθήκε με επιτυχία.";
$langAddAcomment = "πρόσθεσε ένα σχόλιο";
$langChangeComment = "Επεξεργασία σχόλιου";
$langdeleteComment = "Διαγραφή σχόλιου";

$langContinueChangeComment = "Θέλετε να προχωρήσετε στην συγκεκριμένη ενέργεια?";
$langCommentUpdateSuccess = "Το σχόλιο άλλαξε.";
$langCommentUpdateNoSuccess = "Κάτι πήγε στραβά. Δοκιμάστε πάλι";
$langCommentDeleteSuccess = "Το σχόλιο διαγράφηκε.";
$langCommentDeleteNoSuccess = "Κάτι πήγε στραβά. Δοκιμάστε πάλι";
...
$langDateHasExpire = "Πρόβλημα! Επιλέτε μία ημερομηνία από την τρέχων ημερομηνία και έπειτα.";
$langAddDatesSuccess = "Η ημερομηνία προστέθηκε με επιτυχία.";

$langBooking = "Κράτηση";
$langGroupMentees = "Ομάδες χρηστών";

$langHaveDoneBooking = "ΕΧΕΤΕ ΚΑΝΕΙ ΚΡΑΤΗΣΗ - ΑΚΥΡΩΣΤΕ ΤΗΝ";
$langDoBooking = "ΚΑΝΤΕ ΚΡΑΤΗΣΗ";
$langDisableBooking = "ΜΗ ΔΙΑΘΕΣΙΜΟ";
$langBookingIsDone = "ΕΙΝΑΙ ΚΛΕΙΣΜΕΝΟ";

$langMentoringGroupMembers = "Ομάδες χρηστών";

$langSendMenteeRequestToProgram = "Αίτημα συνεργασίας στο πρόγραμμα";
$langDetailsUser = "Στοιχεία χρήστη";
$langAcceptRequestInProgram = "Αποδοχή αιτήματος στο πρόγραμμα";
$langYourRequestHasAccepted = "Το αίτημα συνεργασίας στο πρόγραμμα έγινε αποδεκτό. Πλέον είστε μέλος του προγράμματος.";
$langDiscardRequestInProgram = "Απόρριψη αιτήματος στο πρόγραμμα";
$langYourRequestHaDiscurded = "Το αίτημα συνεργασίας στο πρόγραμμα έχει απορριφθεί.";
$langRequestToGroup = "Αίτημα συμμετοχής στην ομάδα";
$langRequestInGroupHasAccepted = "Το αίτημά σας έχει γίνει αποδεκτό στην ομάδα:";
$langRequestInGroupHasDiscurded = "Το αίτημα σας δεν έγινε αποδεκτό στην ομάδα:";
$langAvailableMeeting = "Διαθέσιμο meeting";

$langWithTutorOfGroup = "Με τον υπεύθυνο ομάδας:";
$typeMeetings = "Τύπος συνάντησης:";
$langDetailsMeeting = "Στοιχεία συνάντησης";
$langPlsWait = "Περιμένετε...";
$langMembers = "Μέλη";

$langManageGroup = "Διαχείριση ομάδων";

$langAvailability = "Διαθεσιμότητα";
$langAvailabilityMentor = "Ενεργός/η";
$langUnAnavailability = "Μη ενεργός/η";
$langlistMentor = "Λίστα μεντόρων";

$langDeleteMentorFromTag = "Αφαίρεση ετικέτας από τον συγκεκριμένο μέντορα";
$langDeleteTagsFromMentor = "Αφαίρεση ετικετών από τον χρήστη";
$langDelMentorFromTag = "Αφαίρεση ετικέτας από τον μέντορα";
$langDeleteCurrentTagsFromMentor = "Οι ετικέτες αφαιρέθηκαν από τον χρήστη με επιτυχία.";
$langSearchTagByKeyboard = "Μπορείτε να αναζητήσετε οποιαδήποτε ετικέτα, πληκτρολογώντας στο πεδίο κειμένου, τον τίτλο της ετικέτας που έχετε καταχωρίσει.";
$langShowAllMentors = "Στο πεδίο επιλογής, εμφανίζονται όλοι οι μέντορες της πλατφόρμας που έχει ορίσει ο διαχειριστής της πλατφόρμας.";

$langTagList = "Λίστα ετικετών";
$langNoExistsMentorInThisTag = "Δεν έχουν καταχωριθεί μέντορες στην συγκεκριμένη ετικέτα.";
$langDelTag = "Διαγραφή ετικέτας:";
$langDeleteTagMsg = "<strong class='text-warning TextBold'>ΠΡΟΣΟΧΗ!</strong></br>
                        Αν αφαιρέσετε την συγκεκριμένη ετικέτα, θα διαγραφούν και όλοι οι μέντορες που έχουν καταχωριθεί σε αυτήν.</br>
                        <strong>Θέλετε να προχωρήσετε στην συγκεκριμένη ενέργεια;</strong>";
$langDelTagSuccessMsg = "Η ετικέτα διαγράφηκε επιτυχώς.";
$langSelectTagMsg = "Δεν επιλέξατε κάποια ετίκετα. Η ενέργεια δεν ολοκληρώθηκε.";
$langChooseTagMentorMsg = "Η ενέργεια δεν ολοκληρώθηκε. Δεν καταχωρίσατε κάποια ετικέτα.";
$langAddTagSuccessMsg = "Η ετικέτα προστέθηκε με επιτυχία.";
$langTextHomePage = "Κείμενα αρχικής σελίδας";

$langIsAvailableInPlatform = "Είστε διαθέσιμος/ή στην πλατφόρμα;";

$langTutorProgram = "Συντονιστής";
$langMentorProgram = "Μέντορας";
$langMenteeProgram = "Καθοδηγούμενος";
$langMembersProgram = "Μέλη προγράμματος";
$langViewHour = "Προβολή";
$langDelPictureSucc = "Η φωτογραφία αφαιρέθηκε με επιτυχία."; 
$langAboutUser = "Σχετικά με τον χρήστη ";

$langAddfiltersformentor = "Δημιουργία φίλτρων για τους μέντορες";

$langMentoringSkills = "Δεξιότητες";
$langInsertMentoringSkills = "Εισάγετε τα πεδία δεξιοτήτων για το πεδίο εξειδίκευσης στην παρακάτω φόρμα κειμένου.";

$langMentoringKeyWords = "Λέξεις-κλειδιά";
$langInsertMentoringKeyWords = "Εισάγετε λέξεις κλειδιά που να σχετίζονται με το πεδίο εξειδίκευσης και τις δεξιότητες.";

$langFieldsExpertise = "Πεδίο εξειδίκευσης";
$langInsertFieldsExpertise = "Εισάγετε το πεδίο εξειδίκευσης στην παρακάτω φόρμα κειμένου.";

$langAddFiltersSuccessMsg = "Οι τιμές των φίλτρων προστέθηκαν με επιτυχια.";
$langAddFiltersNoSuccessMsg = "Η ενέργεια δεν ολοκληρώθηκε καθώς καταχωρισάτε τιμές που υπάρχουν ήδη. Δοκιμάστε παλί.";

$langSpecializations = "Εξειδικεύσεις";
$langSkills = "Δεξιότητες";
$langSkillCanOfferMentor = "Δεξιότητες που μπορεί να υποστηρίξει ο μέντορας στην συγκεκριμένη εξειδίκευση";
$langKeyWord = "Λέξεις-κλειδιά";

$langDelSpecializationSuccessMsg = "Η διαγραφή ολοκληρώθηκε με επιτυχία.";
$langDelSpecializationNoSuccessMsg = "Κάτι πήγε στραβά. Δοκιμάστε πάλι.";

$langListFilters = "Λίστα φίλτρων";

$langRelationshipMentorsFilter = "Διασύνδεση μεντόρων - φίλτρων";

$langformSubmitSuccess = "Οι μέντορες καταχωρίθηκαν στα φίλτρα που επιλέξατε με επιτυχία.";
$langformSubmitNoSuccess = "Δεν μπορείτε να καταχώρισετε ξανά τις ίδιες τιμές για τους συγκεκριμένους μέντορες ή μέντορα που επιλέξατε.";
$langformSubmitWarning = "Έχετε αφήσει κάποια πεδία κενά. Δοκιμάστε πάλι.";
$langMentorsHasAdded = "Μέντορες που έχετε καταχωρίσει στις διαθέσιμες εξειδικεύσεις";
$langMentorDelFromSkillSuccess = "Ο μέντορας αφαιρέθηκε από την συγκεκριμένη εξειδίκευση και δεξιότητα με επιτυχία.";
$langDelMentorFromSkill = "Θέλετε να προχωρήσετε στην αφαίρεση του μέντορα από την συγκεκριμένη εξειδίκευση-δεξιότητα?";
$langDelSpecialization = "Θέλετε να προχωρήσετε στην αφαίρεση της συγκεκριμένης εξειδίκευσης?</br>
                          Επιπλέον θα αφαιρεθούν και όλοι οι μέντορες που έχετε καταχωρίσει σε αυτήν.";
$langChooser = "<span class='small-text help-block'>Επιλέξτε&nbsp<span class='fa fa-arrow-down'></span></span>";
$langAvailableSpecializations = "Διαθέσιμες εξειδικεύσεις";
$langAddSkillIfYouWant = "Επιθυμείτε να προσθέτε κάποια δεξιότητα ή να αφαιρέσετε κάποια υπάρχουσα?";
$langAddKeyIfYouWant = "Επιθυμείτε να προσθέτε κάποια λέξη-κλειδί ή να αφαιρέσετε κάποια υπάρχουσα?";
$langClickHere = "Πιέστε εδώ";
$langNameSkill = "Όνομα δεξιότητας";
$langAddSkillSuccessMsg = "Η δεξιότητα προστέθηκε με επιτυχία στην συγκριμένη εξειδίκευση.";
$langAddSkillNoSuccessMsg = "Η ενέργεια δεν ολοκληρώθηκε. Ισως κατάχωρισατε κάποιο όνομα που υπάρχει ήδη. Δοκιμάστε πάλι.";
$langdelSkill = "Διαγραφή δεξιότητας";
$langSkillSuccessMsg = "Η αφαίρεση των δεξιοτήτων ολοκληρώθηκε με επιτυχία.";
$langSkillNoSuccessMsg = "Η ενέργεια δεν ολοκληρώθηκε. Δοκιμάστε πάλι.";
$langByKewWords = "Αναζήτηση ενεργών και μη ενεργών μεντόρων μέσω λέξεων-κλειδιών";

$langSearchMentorsForCreateProgram = "Αναζητήστε τους ενεργούς μέντορες της πλατφόρμας με βάση τις παρακάτω εξειδικεύσεις";
$langSearchMentorsForEditProgram = "Παρακάτω εμφανίζονται όλοι οι μέντορες της πλατφόρμας , ενεργοί και μη ενεργοί καθώς και οι επιλεγμένοι μέντορες του προγράμματος.</br>
                                    Παρατηρήστε αν κάποιος μέντορας του προγράμματος δεν είναι διαθέσιμος στην πλατφόρμα ώστε να τον αφαιρέσετε από το πρόγραμμα.</br>
                                    Θα εμφανίζεται το ακόλουθο σήμα <span class='badge bg-danger'><span class='fa fa-info'></span></span> δίπλα από το όνομα του μέντορα.
                                    <p class='TextBold text-info mt-3 mb-0'>ΣΗΜΑΝΤΙΚΗ ΣΗΜΕΙΩΣΗ</p>
                                    <p>Ο μέντορας που είναι και συντονιστής του προγράμματος, δεν μπορεί να αφαιρεθεί από μέντορας στο τρέχων πρόγραμμα καθώς συμμέτεχει ως υπεύθυνος ομάδας στην ομάδα ολομέλειας.</br></br>
                                    Αν η επιλογή κάποιου μέντορα είναι απενεργοποιημένη, αυτό σημαίνει ότι ο συγκεκριμένος μέντορας συμμετέχει ως καθοδηγούμενος στο τρέχων πρόγραμμα και δεν μπορεί να επιλεγεί.</p>";
$langNoFound = "Δεν βρέθηκε";
$langUnvailableMentor = "Μη διαθέσιμος μέντορας στην πλατφόρμα";
$langDeleteAvailableMeeting = "Θέλετε να διαγράψατε την συγκεκριμένη συνάντηση?";
$langdobookingwithmentor = "Θέλετε να κάνετε κρατήση για να επικοινωνήσετε με τον συγκεκριμένο μέντορα?";
$langdelbookingwithmentor = "Θέλετε να ακυρώσετε την συγκεκριμένη κράτηση?";

$langExitMentoring = "Πλατφόρμα Open Eclass";
$langMentoringPrograms = "Προγράμματα";
$langWelcomeMentoring = "Καλώς ήρθατε στην πλατφόρμα mentoring του Open Eclass!";
$langInfoWelcomeMentoring = "Η πλατφόρμα Mentoring του Open Eclass σου προσφέρει την δυνατότητα με σκοπό να</br>
                             αναζήτησεις τον μέντορα που εσύ επιθυμείς ώστε να σε καθοδηγήσει</br>
                             για διάφορες προκλήσεις που αντιμετωπίζεις στον</br>
                             επαγγελματικό σου τομέα.";
$langInfoWelcomeMentoring2 = "Είσαι νεός χρήστης και χρειάζεσαι βοήθεια;</br>
                                Αναζήτησε τον μέντορα που εσύ επιθυμείς.";
$langViewMentor = "Γνώρισε τους";
$langShowMentor = "Προβολή";
$langPlatformOpenEclass = "Πλατφόρμα Open Eclass";
$langPlatformMentoring = "Πλατφόρμα Mentoring";

$MentoringEnableHomepageEclass = "<p class='TextBold fs-6'>Σας καλωσορίζουμε στην νέα λειτουργία του Open Eclass, την <span class='text-info'>MENTORING</span> πλατφόρμα.</p>
                                  <p class='small-text text-secondary TextBold mt-2'>Αναζήτας έναν μέντορα να σε καθοδηγήσει για διάφορες προκλήσεις που αντιμετωπίζεις στον επαγγελματικό σου τομέα;</p>";
                                  
$langOldVersion = "Παλαιότερη έκδοση";
$langVersionEclass = "Έκδοση eClass";
$langDelSpecializationNoSuccessMsgMentor = "Η διαγραφή δεν ολοκληρώθηκε καθώς ο χρήστης είναι μέντορας κάποιου προγράμματος.</br>
                                            Αφαιρέστε τον από το πρόγραμμα και δοκιμάστε πάλι.";
$langNoMentoringProgramsAsMentee = "Δεν υπάρχουν διαθέσιμα προγράμματα που συμμετέχετε ως καθοδηγούμενος.";
$langSpaceDoc = "Επισκόπηση αποθηκευτικού χώρου"; 
$langMentoringActivePrograms = "Ενεργά";
$langMentoringDeactivePrograms = "Μη ενεργά";
$langTotalMentors = "Μέντορες";
$langTotalMentees = "Καθοδηγούμενοι";
$langTotalTutors = "Συντονιστές";
$langInfoPrograms = "Διάλεξε το πρόγραμμα με τον μέντορα που επιθυμείς για να συνεργαστείς μαζί του.";
$langGoToPrograms = "Δες τα προγράμματά μας";
$langInfoHomeText = "Εδώ μπορείς να αναζητήσεις τον μέντορα που θα σε βοηθήσει να αντιμετωπίσεις τις προκλήσεις της επαγγελματικής σου ζωής ή να γίνεις εσύ μέντορας και να μοιραστείς με κάποιον καθοδηγούμενο τις διάφορες επαγγελματικές εμπειρίες που είχες.";
$langGoToMentors = "Δες τους μέντορές μας";
$langInfoMentors = "Διάλεξε τον μέντορα που επιθυμείς να συνεργαστείς μαζί του.";
$langInfoMentorsText = "Οι διαθέσιμοι μέντορες μας μπορούν να σε καθοδηγήσουν και να υποστηρίξουν διάφορους επαγγελματικούς κλάδους. Αναζήτησε τον κλάδο που επιθυμείς και βρες τον μέντορα που θα σε βοηθήσει να ανταποκριθείς στην επαγγελματική σου ζωή.";
$langInfoProgramsText = "Έχεις επιλέξει τον μέντορα που θέλεις να συνεργαστείς μαζί του;</br>
                            Αναζήτησε το πρόγραμμα που υποστηρίζει ο μέντορας σου και γίνε μέλος.";
$langShowMentoringPlatform = "Γνώρισε την πλατφόρμα Mentoring";





$langInfoMyProgramsText = "Όλα τα διαθέσιμα προγράμματά μου στα οποία συμμετέχω</br>είτε ως συντονιστής είτε ως μέντορας είτε ως καθοδηγούμενος.";
$langInfoMyDeactiveProgramsText = "Όλα τα μη διαθέσιμα προγράμματά μου στα οποία συμμετέχω</br>είτε ως συντονιστής είτε ως μέντορας είτε ως καθοδηγούμενος.";
$langInfoMyProfileText = "Διαθέσιμο προφίλ για όλους τους χρήστες.</br>Πληροφορίες διαθέσιμου χρήστη σχετικά με την συμμετοχή του σε κάποιο προγράμμα.";
$langRequestsPrograms = "Αιτήματα προγράμματος";
$langProgramUsers = "Χρήστες προγράμματος";
$langInfoUserProgramsText = "Εδώ θα βρείτε όλους τους διαθέσιμους χρήστες</br>που συμμετέχουν ως καθοδηγούμενοι ομάδων στο τρέχων πρόγραμμα.";
$langInfoUserGroupText = "Εδώ θα βρείτε όλους τους διαθέσιμους χρήστες</br>που συμμετέχουν ως καθοδηγούμενοι στην συγκεκριμένη ομάδα.";
$langInfoHistoryMeetingsText = "Εδώ θα βρείτε όλο το ιστορικό των συναντήσεων, meetings που είναι ενεργά και meetings που έχει παρέλθει η ημερομηνία τους.";
$langNextMeeting = "Επόμενη συνάντηση";
$langNoExistMeetings = "Δεν υπάρχουν διαθέσιμα meeting";
$langInfoMeetingsText = "Εδώ θα βρείτε όλα τα διαθέσιμα meeting σας μέχρι ένα μήνα μέτα.</br>Μπορείτε να δείτε και το ιστορικό των ραντεβού απο την επιλογή <<ιστορικό ραντεβού>>.";
$langWithMentor = "με τον υπεύθυνο";
$langMeetingNotStartedYet = "Το meeting δεν έχει ξεκινήσει ακόμα";
$langInfoActionProgramText = "Παρακάτω μπορείτε να χρήσιμοποιήσετε την καταγραφή ενεργείων για το τρέχων πρόγραμμα σχετικά με τα εργαλεία που διαθέτουν οι ομάδες.";
$langInfoCreateProgramText = "Δημιουργείστε το πρόγραμμα που θα αξιοποιεί τις απαιτήσεις των καθοδηγούμενων.</br>Επιλέξτε τους κατάλληλους μέντορες για το πρόγραμμα αυτό και δημιουργείστε μία ομάδα ολομέλειας κοινή για όλα τα μέλη του προγράμματος.";
$langInfoEditProgramText = "Τώρα έχετε την δυνατότητα να αξιοποιήσετε το πρόγραμμα και να το ρυθμίσετε κατάλληλα ώστε να παρέχει όλα αυτά που αναζητεί ένας καθοδηγούμενος του προγράμματος.";
$langAlwaysActiveMentoringPlatform = "Μόνιμα ενεργοποιημένη";
$langTutorMentor = "Συντονιστής - Μέντορας";
$langMentee = "Καθοδηγούμενος";
$langProfRegTutorMentor = "Αίτησεις συντονιστών - μεντόρων";
$langUserOpenMentee = "Αιτήσεις καθοδηγούμενων";
$linkRegTutorMentor = "Εγγραφή συντονιστή - μέντορα";
$langReqHaveClosedTutorMentor = "Ανοικτές αιτήσεις συντονιστών - μεντόρων";
$langUserOpenMenteeRequests = "Αιτήσεις καθοδηγούμενων";
$langOpenProfessorTutorMentorRequests = "Ανοικτές αιτήσεις συντονιστών - μεντόρων";
$langMenteeDetails = "Εγγραφή καθοδηγούμενου";
$langProfTutorMentorReg = 'Εγγραφή συντονιστή - μέντορα';
$langsOfMentee = "Καθοδηγούμενων";
$langsOfTutorMentor = "Συντονιστών - Μεντόρων";
$langProfTutorMentorOnly = "στους συντονιστές - μέντορες";
$langMenteesOnly = "στους καθοδηγούμενους";
$langProfileInfoTutors = "εμφάνιση στους συντονιστές";
$langSuchAsTutorMentor = "Συντονιστή - μέντορα";
$langUserMenteeRequest = "Αίτηση δημιουργίας λογαριασμού καθοδηγούμενου";
$langReqRegTutorMentor = "Αίτηση δημιουργίας λογαριασμού συντονιστή - μέντορα";
$langBackPage = "Πίσω";
$langPressMessage = "Πληκτρολογήστε το μήνυμα σας...";
$langBelowDaysMentor = "Στο παρακάτω ημερολόγιο μπορείτε να βρείτε τις διαθέσιμες ώρες επικοινωνίας του υπευθύνου.";
$langInfoMentorsText2 = "Δείτε όλες τις διαθέσιμες πληροφορίες για τον μέντορα που επιλέξατε.</br>Ακόμη μπορείτε να δείτε όλα τα προγράμματα στα οποία συμμετέχει.";
$langNoGroupRegMentees = "Μη εγγεγραμμένοι καθοδηγούμενοι";
$langMenteeCanSendGroupRequest = "Οι καθοδηγουμενοι μπορουν να στείλουν αιτημα εγγραφης";
$langOpRegReq = "Δυνατότητα αίτημα εγγραφής";
$langGroupAllowMenteeUnregister = "Οι καθοδηγούμενοι επιτρέπεται να απεγγραφούν";
$langGroupAllowMenteeRegistration = "Οι καθοδηγούμενοι επιτρέπεται να εγγραφούν";
$langRequestsExist = "Αιτήματα συνεργασίας";
$langInfoGroupSpaceText = "Εξερευνήστε τον χώρο εργασίας της ομάδας.</br>Δείτε τα διαθέσιμα εργαλεία και τις διαθέσιμες ώρες επικοινωνίας των υπευθύνων.";
$langInfoWallGroupSpaceText = "Εξερευνήστε τον χώρο εργασίας της ομάδας.</br>Δείτε τα διαθέσιμα εργαλεία και τον διαθέσιμο τοίχο της ομάδας.";
$langInfoDivGroupSpaceText = "Εδώ θα βρείτε όλες τις διαθέσιμες υπό-ομάδες του προγράμματος.</br>Κάντε εγγραφή σε μία ομάδα με τον υπεύθυνο που επιθυμείτε να έχετε μία συνεργασία μαζί του.";
$langCreateMeeting = "Επιθυμείτε να δημιουργήσετε κάποιο meeting για να επικοινωνήσετε</br>με κάποιο μέλος της ομάδας;";
$langAddAvailableDateHour = "Επιθυμείτε να προσθέσετε τις διαθέσιμες ημερές και ώρες</br>επικοινωνία σας;";
$langPostWall = "Αναρτήσεις τοίχου";
$langNoWallPostsMentoring = "Δεν υπάρχουν αναρτήσεις στον τοίχο της ομάδας";
$langInfoGroupAnnouncementText = "'Ολες οι ανακοινώσεις της ομάδας βρίσκονται στον πίνακα παρακάτω.</br>Δείτε τις τελευταίες ανακοινώσεις τις ομάδας επιλέγοντας αυτή που επιθυμείτε.";
$langInfoGroupForumText = "Τώρα έχετε την δυνατότητα να δημιουργήσετε ένα θέμα συζήτησης</br>και να ανταλλάξετε απόψεις με τα μέλη της ομάδας.";
$langInfoWallText = "Τώρα έχετε την δυνατότηα να κάνετε μία ανάρτηση στον τοίχο της ομάδας.<br>Κάντε μία ανάρτηση αν επιθυμείτε.";
$langHasNoAcceptedBookingYet = "Δεν έχει γίνει ακόμα αποδοχή από τον υπεύθυνο.</br>Θα ενημερωθείτε σύντομα με email.</br></br>Μπορείτε να ακυρώσετε την κράτηση σας αν επιθυμείτε.";
$langMyMeetings = "Οι συναντήσεις μου";
$langMyBookings = "Οι κρατήσεις μου";
$langInfoGroupWallCommentsText = "Τώρα μπορείτε να προσθέσετε ένα σχόλιο σε μία ανάρτηση ενός χρήστη.</br>Θέλετε να σχολίασετε μία ανάρτηση;</br>Κάντε ένα σχόλιο.";
$langInfoGroupDocsText = "Όλα τα έγγραφα της ομάδας εμφανίζονται στον πίνακα παρακάτω.</br>Δοκιμάστε να κάνετε και μία λήψη ενός εγγράφου.";
$langInfoGroupBookingsText= "Η λίστα με τις κρατήσεις σας φαίνεται παρακάτω.</br>Αν θέλετε να ακυρώσετε μία κράτηση, σας δίνεται η δυνατότητα από το κουμπί ακύρωσης.";
$langAddMentors = "Προσθήκη μέντορα στην πλατφόρμα";
if (file_exists('config/config.php')) {
    if(get_config('mentoring_always_active')){
        $langUserAccount = "Λογαριασμός Καθοδηγούμενου Πιστοποίηση μέσω πλατφόρμας";
        $langProfAccount = "Λογαριασμός Συντονιστή";
    }
}
$langTutorAsMenteeInPlatform = "Να μπορεί ένας χρήστης με ιδιότητα συντονιστή ή μέντορα να συμμετάσχει ως καθοδηγούμενος σε κάποιο πρόγραμμα;";
$langSelectAtLeastOneTutor= "Παρακαλώ επιλέξτε τουλάχιστον έναν συντονιστή";
$langKeyWord1 = "Λέξη-κλειδί";
$langKeySuccessMsg = "Η λέξη-κλειδί προστέθηκε με επιτυχία";
$langMissingKeyNameMsg = "Παρακαλώ πληκτρολογήστε μία λέξη-κλειδί.";
$langDontSelectKeyNameMsg = "Δεν επιλέξατε κάποια λέξη-κλειδί. Δοκιμάστε πάλι.";
$langDelKeyNameMsgSuccess = "Οι λέξεις-κλειδιά αφαιρέθηκαν με επιτυχία.";

$langInfoGroupMentoringSpaceText = "Στον χώρο συμβουλευτικής θα βρείτε τις διαθέσιμες ομάδες του προγράμματος.</br>
                                    Θέλεις να μοιραστείς διάφορες απόψεις με όλα τα μέλη του προγράμματος;</br>
                                    Στην ομάδα ολομέλειας έχεις την δυνατότητα.</br>
                                    Θέλεις να συνεργαστείς με έναν μέντορα του προγράμματος;</br>
                                    Στις ομάδες χρηστών βρες τον υπεύθυνο που αναζητάς και κάνε εγγραφή.";

$langShareInCommonGroup = "Μοιράσου τις απόψεις σου με τα μέλη του προγράμματος.</br>Κάνε μία ανάρτηση στο τοίχο της ολομέλειας.";
$langShareInGroups = "Βρες τον μέντορα που θέλεις να συνεργαστείς μαζί του.</br>Κάνε μία εγγραφή στην ομάδα.";


$langNoTutorAsMenteeFromAdminTool = "Η ενέργεια που αφορά τον χρήστη με ιδιότητα συντονιστή-μέντορα να μην συμμετέχει ως
                                    καθοδηγούμενος , δεν ολοκληρώθηκε καθώς υπάρχουν χρήστες που συμμετέχουν σε προγράμματα.
                                    Πρέπει να αφαιρεθούν απο αυτά και να δοκιμάσετε πάλι.</br>
                                    Οι χρήστες είναι:</br></br>";

$langCreateEditDelDoc = "(ανέβασμα αρχείου,επεξεργασία,διαγραφή)";
$langManageDocs = "Να μπορούν οι χρήστες να διαχειρίζονται τα αρχεία";
$langMentoringIntro = "Εισαγωγικό κείμενο";
$langAddText = "Προσθήκη κειμένου";
$langdelHomePageIntroSuccess = "Το εισαγωγικό κείμενο διαγράφηκε.";
$langOutSideHomePage = "εξωτερικής αρχικής σελίδας";
$langInsideHomePage = "εσωτερικής αρχικής σελίδας";
$langMentoringAdminCreateHomeTexts = "Κείμενα εσωτερικής αρχικής σελίδας";
$langRegUserGroup = "εγγεγραμένους χρήστες της ομάδας";
$langDateMaxHour = "Η διαθέσιμη ώρα σας θα πρέπει να έχει διάρκεια μισής ή μίας ώρας";
$langRentezvousMaxHour = "Το διαθέσιμο ραντεβού σας θα πρέπει να έχει διάρκεια μισής ή μίας ώρας";
$langTranslation = "Μετάφραση";
$langTranslationExisting = "Μετάφραση υπάρχουσας δεξιότητας";
$langAddTranslationSuccessMsg = "Η μετάφραση έγινε με επιτυχία";
$langHasTranslated = "Έχει μεταφραστεί σε:";
$langDatesHourTutorAvailability = "Ημέρες και ώρες επικοινωνίας του υπεύθυνου ομάδας";
$langAllowUnregMenteeFromProgram = "Να μπορεί ο καθοδηγούμενος να απεγγραφεί από το πρόγραμμα;";
$langUnregProgramMentee = "Απεγγραφή από το πρόγραμμα";
$langHasUnregisteredSuccess = "Η απεγγραφή σας από το πρόγραμμα ολοκληρώθηκε με επιτυχία.";
$langNolangHasUnregisteredSuccess= "Η απεγγραφή σας από το πρόγραμμα δεν ολοκληρώθηκε με επιτυχία. Δοκιμάστε πάλι.";
$langMentorAsTutorProgram = "Να μπορεί ένας μέντορας να δημιουργήσει ένα πρόγραμμα ως συντονιστής προγράμματος;";
$langNoMentorAsTutorProgram = "Η ενέργεια να μπορεί ένας μέντορας να δημιουργήσει ένα πρόγραμμα ως συντονιστής δεν ολοκληρώθηκε
                               καθώς υπάρχει μέντορας που έχει δημιουργήσει ήδη ένα πρόγραμμα. Θα πρέπει να διαγραφεί το πρόγραμμα ή να αφαιρεθεί ο μέντορας από συντονιστής και να επιλέξετε κάποιο άλλον.
                               </br>Παρακάτω εμφανίζονται οι μέντορες που είναι συντονιστές προγραμμάτων:</br>";
$langMentorAsTutorExistMsg = "Η ενέργεια να μην μπορεί ένας μέντορας να δημιουργήσει ένα πρόγραμμα ως συντονιστής ολοκληρώθηκε με επιτυχία.</br>
                                Υπάρχουν όμως κάποιοι μέντορες που παλαιότερα είχαν γίνει συντονιστές.</br>
                                Αν θέλετε μπορείτε να τους αφαιρέσετε.</br>
                                Παρακάτω εμφανίζονται οι συγκεκριμένοι μέντορες ως συντονιστές προγραμμάτων:</br>";
$langNoGroupRegUsers = "Μη εγγεγραμμένοι χρήστες";
$langLimitGroupNotAllowed = "Μη επιτρεπτό όριο εγγραφής στην ομάδα";
$langInfoAutomaticallyRegMentor = "<strong>ΣΗΜΕΙΩΣΗ</strong></br>
                                    Κατά την δημιουργία της ομάδας ολομέλειας, θα εγγραφούν αυτόματα στην ομάδα και οι μέντορες που επιλέξατε στο συγκεκριμένο πρόγραμμα.</br>
                                    Αν ο αριθμός των συμμετεχόντων στην ομάδα είναι μικρότερος από τον αριθμό των μεντόρων, τότε κάποιοι από αυτούς δεν θα εγγραφούν αυτόματα στην ομάδα
                                    και θα πρέπει να εγγραφούν οι ίδιοι στην συγκεκριμένη ομάδα αν το όριο εγγραφής της ομάδας είναι επιτρεπτό.";
$langBookingHasCalceledOne = "Η κράτηση αφαιρέθηκε επιτυχώς.";
$langOnlyNumbersLetters = "Ο κωδικός πρέπει να περιέχει μόνο γράμματα και αριθμούς.";
