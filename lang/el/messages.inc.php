 ...
 * ************************************************** */
// index
$langDisplayPlatformAsCardLayout = "Ενεργοποίηση εμφάνισης της πλατφόρμας σε μορφή cards (περιλαμβάνει border-radius)";
$langDisplayPlatformAsCardLayoutNoBorderRadius = "Ενεργοποιημένη εμφάνιση σε μορφή cards (δεν περιλαμβάνει border-radius)";
$langComments = "Σχόλια";
...
$langPointsWon = "Συγχαρητήρια! Μόλις κερδίσατε %s πόντους!";
$langLevelPromoted = "Συγχαρητήρια! Μόλις ανεβήκατε στο επίπεδο <i>%s</i>!";
...
$langNoPointsGames = "Δεν έχουν οριστεί παιχνίδια πόντων.";
...
$langBgGradientBgImageProfileContainerInfo = "Προσθήκη χρώματος (φιλτράρισμα) στην εικόνα φόντου";
...
$langHoverBgColorButton = "Χρώμα Hover φόντου κουμπιού πλοήγησης";
...
$langSFAfail = 'Λάθος απάντηση του 2FA κωδικού';
$langSFAremove = 'Απενεργοποίησε 2FA';
$langSFAkeep = 'Διατήρησε το 2FA';
$langSFAadd = 'Ενεργοποίησε το 2FA';
