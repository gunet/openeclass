...
$langConfirmDisconnectBackpack = "Είστε σίγουροι ότι θέλετε να αποσυνδέσετε το backpack σας;";$langProviderDiscoveryFailed = "Η ανακάλυψη παρόχου απέτυχε";
...
$langClientIdHelp = "OAuth Client ID για έλεγχο ταυτότητας με τον πάροχο backpack";
$langClientSecretHelp = "OAuth Client Secret για έλεγχο ταυτότητας με τον πάροχο backpack";
