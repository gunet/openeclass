...
<li>Συμπληρώστε τον τύπο της απάντησης που δίνει το επιθυμητό απότελεσμα της άσκησης καθώς και τον βαθμό στα πεδία <strong>Τύπος απάντησης</strong> και <strong>Βαθμός</strong> αντίστοιχα. Το σύστημα υπολογίζει αυτόματα το τελικό αποτέλεσμα βασισμένο στον τύπο που δώσατε.</li>
...
<ul class='mt-3'>
<li>Στο πεδίο <strong>Εκφώνηση άσκησης</strong> γράφουμε την εκφώνηση που θέλουμε συμπεριλαμβανομένου και των στοιχείων της άσκησης εαν αυτά υπάρχουν. Μπορούμε λοιπόν να δώσουμε την εκφώνηση `Υπολογίστε το αποτέλεσμα της αριθμητικής πράξης {X}+{Y}`.</li>
<li>Στο πεδίο <strong>Τύπος απάντησης</strong> συμπληρώνουμε τον τύπο που θα δώσει το τελικό αποτέλεσμα. Στο παραδειγμά μας γράφουμε {X}+{Y}.</li>
...
<ul class='mt-4'>
<li>Στο πεδίο <strong>Εκφώνηση άσκησης</strong> γράφουμε την εκφώνηση που θέλουμε. Στο παράδειγμά μας μπορούμε να γράψουμε `Βρείτε τον άγνωστο x της εξίσωσης 3x - 2 = 2x`.</li>
<li>Στο πεδίο <strong>Τύπος απάντησης</strong> συμπληρώνουμε την αριθμητική έκφραση μαζί με την τελική τιμή του χ που ψάχνουμε ως αποτέλεσμα χωρισμένα με το σύμβολο (<strong>:</strong>) δηλαδή γράφουμε 3x - 2 = 2x:2</li>
<li>Στο πεδίο <strong>Βαθμός</strong> συμπληρώνουμε τον βαθμό του.</li>
