...
$langAISyllabusURL = 'URL PDF Αναλυτικού Προγράμματος';
$langAIURLDownloadFailed = 'Απέτυχε η λήψη αρχείου από URL';
$langAIInvalidURL = 'Μη έγκυρο URL';
$langAIURLNotAccessible = 'Το URL δεν είναι προσβάσιμο';
$langAIDownloading = 'Λήψη από URL...';
$langAIURLDescription = 'Εισάγετε την άμεση διεύθυνση URL ενός PDF αρχείου με την περιγραφή του μαθήματος. Το αρχείο θα ληφθεί και θα επεξεργαστεί.';
