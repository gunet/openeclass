...
$langWarnHelpDesk = "Στο \"Email Helpdesk\" στέλνονται οι αιτήσεις χρηστών για λογαριασμό στην πλατφόρμα";
...
$lang_hide_login_link = "Να μην εμφανίζεται σύνδεσμος προς την αρχική σελίδα";
...
$langConcerngingQuestionnairePanels = "Αναφορικά με τα panels - ερωτηματολόγια - αναφορές χρηστών";
...
$langFormUploadImage = "Ανέβασμα εικόνας στις φόρμες";
...
$langclBorderBottomListMenu = "Χρώμα border στο κάτω μέρος των μενού επιλογών";
$langclHoveredclHoveredListMenu = "Χρώμα Hovered συνδέσμων επιλογών μενού";
...
$langbgBorderContextualMenu = "Χρώμα border μενού";
...
$langInfoNewSession = "Στο ημερολόγιο θα δείτε όλες τις καταχωριμένες συνεδρίες της συνεργασίας εαν υπάρχουν.
                        Σε αυτά τα slots δεν μπορείτε να καταχωρήσετε κάποια καινούρια συνεδρία. Μπορείτε να επιλέξετε τα ελεύθερα slots ημέρας και ώρας
                        προκειμένου να κάνετε μία καταχώρηση. </br>
                        Επιλέγοντας ένα από αυτά κάνοντας κλικ στο επιθυμητό slot και αφού πατήσετε το κουμπί << προσθήκη >> στο νέο παράθυρο που θα εμφανιστεί,
...
$langInfoEditSession = "Στο ημερολόγιο θα δείτε όλες τις καταχωριμένες συνεδρίες της συνεργασίας εαν υπάρχουν.
                        Το πράσινο χρώμα αφορά την τρέχων συνεδρία που θέλετε να επεξεργαστείτε.
                        Επιλέγοντας ένα διαφορετικό slot ημέρας και ώρας κάνοντας κλικ στο επιθυμητό slot </br> και αφού πατήσετε το κουμπί << προσθήκη >> ,
                        θα καταχωρίσετε προσωρινά την νέα ημερομηνία ενάρξης και λήξης της συνεδρίας. </br></br>
                        <strong>Η καταχώριση ολοκληρώνεται κάνοντας υποβολή στην φόρμα από το κουμπί << αλλαγή >> .</strong>";
