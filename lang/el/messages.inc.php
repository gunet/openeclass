...
$langDropboxMailNotify = "σας έχει αποσταλλεί ένα καινούριο μήνυμα. Θα το βρείτε στο υποσύστημα 'Ανταλλαγή Μηνυμάτων' αφού προηγουμένως κάνετε login στην πλατφόρμα.";
