...
$langUploadWhitelist = "Τύποι επιτρεπτών αρχείων για ανέβασμα (whitelist)";
...
$langAnnMod = "Η ανακοίνωση τροποποιήθηκε";
...
$langByDel="Διαγράφοντας το μάθημα θα διαγράψετε μόνιμα όλα τα περιεχόμενά του και όλους τους ".$langsStudents." που είναι γραμμένοι σε αυτό 
                (δεν θα διαγραφούν από τα άλλα μαθήματα).";
...
$langCopy="Αντιγραφή";
$langNoSpace="Το ανέβασμα του αρχείου απέτυχε. Έχετε υπερβεί το όριο χώρου αποθήκευσης. Για περισσότερες πληροφορίες, επικοινωνήστε με το διαχειριστή του συστήματος.";
...
* dropbox.php
*************************************************/
$langConfirmDelete1 = "Σημείωση: Το αρχείο ";
$langConfirmDelete2 = " θα διαγραφεί μόνο από τον κατάλογό σας";
$langConfirmDeleteAll = "Σημείωση: Τα αρχεία θα διαγραφούν μόνο από τον κατάλογό σας";
$langBadFormData = "Η αποστολή του αρχείου απέτυχε";
$langSendTo = "Αποστολή στον/στην";
$langReceivedFiles = "Εισερχόμενα Αρχεία";
$langSentFiles = "Απεσταλμένα Αρχεία";
$langNoteDropBox = "Σημείωση: Τα αρχεία θα διαγραφούν μόνο από τον κατάλογό σας";
...
$langdocAdd = "Το αρχείο στάλθηκε με επιτυχία";
$langMailToUsers = "Να ειδοποιηθούν (μέσω email) οι χρήστες";
$langDropboxMailNotify = "σας έχει αποσταλλεί ένα καινούριο αρχείο. Θα το βρείτε στο υποσύστημα 'Ανταλλαγή Αρχείων' αφού προηγουμένως κάνετε login στην πλατφόρμα.";
$langNewDropboxFile = "Ενημέρωση για καινούριο αρχείο";
...
$langDBSettingIntro = "Το πρόγραμμα εγκατάστασης θα δημιουργήσει την κύρια βάση δεδομένων του Open eClass αν δεν υπάρχει.";
...
$langPassShort = 'Το συνθηματικό είναι πολύ σύντομο: πρέπει να έχει τουλάχιστον %d χαρακτήρες';
...
<li>Μπορείτε να αντιγράψετε/επικολλήσετε τις αλλαγές σας σε ένα κειμενογράφο και κάντε 
κλίκ στο 'edit last version' για να προσπαθήσετε να προσθέσετε τις αλλαγές σας στην καινούργια έκδοση της σελίδας.</li>
...
$langSubmissionError = "Δεν υπάρχει εργασία";
...
$langUploadError = "Πρόβλημα κατά το ανέβασμα του αρχείου!";
...
$langAddGrade = "Προσθήκη βαθμολογίας";
...
$langBetaCMSRedirectAfterImport = "Παρακαλώ χρησιμοποιήστε το εργαλείο δημιουργίας μαθήματος για να εισαγάγετε 
        το επιλεγμένο μάθημα. Αν ο περιηγητής ιστού δε σας ανακατευθύνει αυτόματα, πατήστε";
