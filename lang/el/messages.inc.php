...
$langWikiLockInfo = "Η σελίδα που θέλετε να αλλάξετε έχει κλειδωθεί, γίνεται επεξεργασία της από κάποιον άλλο χρήστη. Δοκιμάστε ξανά σε λίγο.";
...
$langCourseUnitDeleteConfirm = "Επιβεβαίωση διαγραφής";
