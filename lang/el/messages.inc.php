...
$langImportAttendancesHelp = 'Μπορείτε να εισάγετε παρουσίες μαζικά αποστέλλοντας ένα αρχείο τύπου Excel (xlsx) που περιέχει τις παρουσίες που θέλετε να τροποποιήσετε.';
$langImportAttendancesStepOne = 'Κάντε λήψη του αρχείου κάνοντας κλικ στο κουμπί';
$langImportAttendancesStepTwo = 'Ανοίξτε το αρχείο και <strong>ΜΗΝ</strong> αλλάξετε την δομή του (π.χ. αριθμό στηλών), καθώς η εισαγωγή θα αποτύχει.';
$langImportAttendancesStepThree = 'Κάντε κλικ στο κελί της τελευταίας στήλης για τον χρήστη που θέλετε να τροποποιήσετε.';
$langImportAttendancesStepFour = 'Πληκτρολογήστε τον αριθμό <strong>0</strong> για να δηλώσετε απουσία (κόκκινο X), ή τον αριθμό <strong>1</strong> για να προσθέσετε μια παρουσία (πράσινο τικ).';
$langImportAttendancesStepFive = 'Πιέστε το πλήκτρο Enter και έπειτα αποθηκεύστε το αρχείο.';
$langImportAttendancesStepSix = 'Ανεβάστε το αρχείο στην παρακάτω φόρμα.';
