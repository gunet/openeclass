...
<li>
    ...
    πηγαίνετε στο συγκεκριμένο σημείο και επιλέξτε το σχήμα του από το πεδίο <strong>Σχήμα</strong>. Αφού το επιλέξατε (π.χ ορθογώνιο), ξεκινήστε να σχηματίζετε
    πάνω στην εικόνα την προκαθορισμένη απάντηση.
</li>
<li>Δώστε το κείμενο της προκαθορισμένης απάντησης στο πεδίο <strong>Απάντηση</strong> (Υποχρεωτικό).</li>
<li>Αν επιθυμείτε η προκαθορισμένη απάντηση να εμφανίζεται μέσω εικόνας και όχι κειμένου τότε συμπληρώστε το πεδίο <strong>Απάντηση</strong> και ανεβάστε την εικόνα μέσω της επιλογής <strong>η προκαθορισμένη απάντηση θα εμφανίζεται μέσω της εικόνας</strong>.</li>
<li>Δώστε βαθμό στην απάντηση στο πεδίο <strong>Βαθμός</strong> (προαιρετικό).</li>
<li>Επιλέγετε <strong>Προσθήκη</strong> για να αποθηκεύσετε την απάντηση προσωρινά.</li>
<li>Η διαδικασία για την δημιουργία των προκαθορισμένων απαντήσεων ολοκληρώνεται πατώντας <strong>Υποβολή</strong>.</li>
</ul>";
...
$langAddCorrectMandatoryWildCrds = "Η αριθμητική παράσταση περιλαμβάνει παραπάνω στοιχεία από αυτά που συμπληρώσατε. Δοκιμάστε πάλι.";
...
Σε διαφορετική περίπτωση συμπληρώνετε την τιμή του στο πεδίο <strong>Τιμή στοιχείου</strong>.";
$langCompleteTheTextOfTheQuestion = "Εκφώνηση";
$langCompleteVariablesOfQuestionInfo = "
<ul>
<li>Συμπληρώστε την εκφώνηση στο πεδίο κειμένου <strong>Εκφώνηση</strong>.</li> 
<li>Κάθε στοιχείο θα πρέπει να ορίζεται μέσα σε <strong>άγκυστρα {}</strong>.</li>
<li>Συμπληρώστε τον αριθμητικό τύπο που δίνει το απότελεσμα της άσκησης καθώς και τον βαθμό στα πεδία <strong>Τύπος απάντησης</strong> και <strong>Βαθμός</strong> αντίστοιχα. Το σύστημα υπολογίζει αυτόματα το τελικό αποτέλεσμα της άσκησης βασισμένο στον τύπο που δώσατε.</li>
<li>Καταχωρήστε τις τιμές των στοιχείων από την <strong>επεξεργασία στοιχείων</strong>. Μπορείτε επίσης να ορίσετε τυχαίες τιμές από το εύρος τιμών.</li>
</ul>
<div class='mt-4'>
Για παράδειγμα, αν θέλουμε να υπολογίσουμε το αποτέλεσμα της αριθμητικής πράξης 15+30 τότε ακολουθούμε τα εξής βήματα:
<ul class='mt-3'>
<li>Στο πεδίο <strong>Εκφώνηση</strong> γράφουμε την εκφώνηση που θέλουμε συμπεριλαμβανομένου και των στοιχείων εαν αυτά υπάρχουν. Μπορούμε λοιπόν να δώσουμε την εκφώνηση `Υπολογίστε το αποτέλεσμα της αριθμητικής πράξης {X}+{Y}`.</li>
<li>Στο πεδίο <strong>Τύπος απάντησης</strong> συμπληρώνουμε τον τύπο που θα δώσει το τελικό αποτέλεσμα. Στο παραδειγμά μας γράφουμε τον τύπο {X}+{Y}.</li>
<li>Στο πεδίο <strong>Βαθμός</strong> συμπληρώνουμε τον βαθμό του.</li>
<li>Στην συνέχεια από την <strong>Επεξεργασία στοιχείων</strong>, ορίζουμε τις τιμές των στοιχείων X = 15,Y = 30 μέσω της επιλογής <strong>Αποτελεί στοιχείο της άσκησης</strong>.</li>
<li>Τέλος, πατάμε <strong>Υποβολή</strong>.</li>
</ul>
</div>";
$langCompleteVariablesOfQuestionWarning = "
<strong>Προσοχή!</strong></br></br>
Αν η άσκηση <strong>ΔΕΝ</strong> περιλαμβάνει κάποιο στοιχείο και πρέπει να υπολογιστεί, τότε θα πρέπει στον πεδίο <strong>Τύπος απάντησης</strong> να συμπληρώσετε την αριθμητική έκφραση όπως την συμπληρώσατε στην εκφώνηση μαζί με το τελικό της αποτέλεσμα χωρισμένα με το σύμβολο της άνω-κάτω τελείας <strong>(:)</strong></br>
<div class='mt-3'>
Για παράδειγμα, αν θέλουμε να υπολογίσουμε τον άγνωστο <strong>x</strong> στην εξίσωση <strong>3x - 2 = 2x</strong> τότε ακολουθούμε τα εξής βήματα:
<ul class='mt-4'>
<li>Στο πεδίο <strong>Εκφώνηση</strong> γράφουμε την εκφώνηση που θέλουμε. Στο παράδειγμά μας μπορούμε να γράψουμε `Βρείτε τον άγνωστο <strong>x</strong> της εξίσωσης <strong>3x - 2 = 2x</strong>`.</li>
<li>Στο πεδίο <strong>Τύπος απάντησης</strong> συμπληρώνουμε την αριθμητική έκφραση μαζί με την τελική τιμή του <strong>χ</strong> που ψάχνουμε ως αποτέλεσμα χωρισμένα με το σύμβολο (<strong>:</strong>) δηλαδή γράφουμε <strong>3x - 2 = 2x:2</strong></li>
<li>Στο πεδίο <strong>Βαθμός</strong> συμπληρώνουμε τον βαθμό του.</li>
<li>Στην συνέχεια <strong>ΔΕΝ</strong> επιλέγουμε την <strong>Επεξεργασία στοιχείων</strong>, καθώς δεν υπάρχουν <strong>{στοιχεία}</strong>.</li>
<li>Τέλος, πατάμε <strong>Υποβολή</strong>.</li>
</ul>
</div>
";
