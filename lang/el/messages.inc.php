...
$langMyAccount = "Ο Λογαριασμός μου";
...
$langModProfile = "Επεξεργασία προφίλ";
...
$langImportGradesGradebookHelp = 'Μπορείτε να αποστείλετε ένα αρχείο λογιστικού φύλλου (π.χ. xls, xlsx, csv) με δύο στήλες.
    Η πρώτη στήλη πρέπει να περιέχει τα ονόματα χρήστη των χρηστών που συμμετέχουν στο βαθμολόγιο.
    Η δεύτερη στήλη πρέπει να περιέχει έναν αριθμητικό βαθμό. 
    Εναλλακτικά μπορείτε να συμπληρώσετε τους βαθμούς των χρηστών συμπληρώνοντας μόνο τη στήλη των βαθμών στο πρότυπο αρχείο 
    που μπορείτε να κατεβάσετε παρακάτω.';
