...
$langAIGenerateQuestions = 'AI Δημιουργία Ερωτήσεων';
$langAIQuestionGeneration = 'AI Δημιουργία Ερωτήσεων';
$langAINotAvailable = 'Η λειτουργία AI δεν είναι διαθέσιμη';
$langContentRequired = 'Το περιεχόμενο είναι απαραίτητο';
$langQuestionsGenerated = '%d ερωτήσεις δημιουργήθηκαν επιτυχώς';
...
$langAIQuestionInfo = 'Χρησιμοποιήστε AI για να δημιουργήσετε ερωτήσεις από το περιεχόμενό σας. Το AI θα αναλύσει το κείμενό σας και θα δημιουργήσει ερωτήσεις κατάλληλες για αξιολογήσεις.';
...
$langDefaultCategory = 'Προεπιλεγμένη Κατηγορία';
