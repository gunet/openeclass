...
if (file_exists('config/config.php')) {
    if(get_config('mentoring_always_active')){
        ...
        $langsTeacher = "συντνονιστής";
        $langsOfTeacher = "συντονιστή";
        $langsTeachers = "συντονιστές";
        $langsOfTeachers = "συντονιστών";
        $langCTeacher = "ΣΥΝΤΟΝΙΣΤΗΣ";

        $langStudent = "Καθοδηγούμενος";
        $langOfStudent = "Καθοδηγούμενου";
        $langStudents = "Καθοδηγούμενοι";
        $langOfStudents = "Καθοδηγούμενων";
        $langCStudent = "ΚΑΘΟΔΗΓΟΥΜΕΝΟΣ";

        $langsStudent = "καθοδηγούμενος";
        $langsOfStudent = "καθοδηγούμενου";
        $langsStudents = "καθοδηγούμενοι";
        $langsOfStudents = "καθοδηγούμενων";
        $langsOfStudentss = "καθοδηγούμενους";
        $langsstudent_acc = "καθοδηγούμενο";

        $langCourse = "Πρόγραμμα";
        $langCourses = "Προγράμματα";
        $langOfCourses = "Προγραμμάτων";
        $langOfCourse = "Προγράμματος";

        $langsCourse = "πρόγραμμα";
        $langsCourses = "προγράμματα";
        $langsOfCourse = "προγράμματος";
        $langsOfCourses = "προγραμμάτων";
    }
}