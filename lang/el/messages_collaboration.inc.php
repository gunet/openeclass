...
$langCopyrightNotice = '
<a href="https://yppoa.cfserver3.net/" target=_blank>Υπουργείο Πολιτισμού</a> © 2023<br>&nbsp;<br>
Η ' . $siteName . ' είναι ένα ολοκληρωμένο Σύστημα Διαχείρισης Ηλεκτρονικών '.$langOfCourses.' και αποτελεί
...
$langSendEmailWithComments = "Με την υποβολή των σχόλιων σας, θα σταλεί ενημερωτικό email στον χρήστη.";
$langNoExistsTClink = "Δεν υπάρχει βρέθηκε ο σύνδεσμος τηλεδιάσκεψης στους πόρους της συνεδρίας.";
...
$langWithConsent = "Να συναινέσει ο χρήστης για την εγγραφή του στην συνεδρία;";
...
$langCancelSessionRegistration = "Πρόκειται να ακυρωθεί η εγγραφή του χρήστη. Ο χρήστης θα μπορεί να εγγραφεί ξανά στην συνεδρία.
                                  Η διαδικασία ολοκλήρωσης της συνεδρίας από τον συγκεκριμένο χρήστη δεν θα αφαιρεθεί.
                                  Για την οριστική διαγραφή του συμπεριλαμβανομένου και της προόδου του σχετικά με την ολοκλήρωση της συνεδρίας, μπορείτε να μεταβείτε στην επεξεργασία της συνεδρίας.</br></br>
                                  Θέλετε να συνεχίσετε?";
$langInfoAboutDelUser = "Η αφαίρεση ενός χρήστη, θα διαγράψει και την πρόοδο του σχετικά με την ολοκλήρωση της συνεδρίας.";