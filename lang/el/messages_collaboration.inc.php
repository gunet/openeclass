...
$langSessionParticipants = "Εγγεγραμμένοι - Συμμετέχοντες";
...
$langUploadOnBehalfOf = "Ανέβασμα αρχείου εκ μέρους κάποιου $langsOfStudent";
...
$langNotExistUsers = "Δεν υπάρχουν $langsStudents";
$langWithConsent = "Να ζητηθεί επιβεβαίωση του $langsOfStudent κατά την είσοδό του στη συνεδρία;";
...
$langUsersHaveCompletedCriteria = "Έχουν συμμετάσχει με επιτυχία στις δραστηριότητες ολοκλήρωσης της συνεδρίας";
...
$langUpdatePercentage = "Ενημέρωση ποσοστού ολοκλήρωσης συνεδριών";