...
if (mysql_num_rows($result2) > 0) {
          ...
          <tr><td class=color1 valign=middle style='border: 2px solid #FFFFFF;'><b>$langMyCoursesUser</b></td></tr>
			...
			$tool_content .= "
          <tbody><tr><th style='text-align: left; border: 0px; background: #E6EDF5; color: #4F76A3; font-size: 90% !important;' width='65%'>$langCourseCode</th>
         <th style='text-align: left; border:0px; background: #E6EDF5; color: #4F76A3; font-size: 90% !important;' width='30%'>$langProfessor</th>
         <th style='text-align: left; border:0px; background: #E6EDF5; color: #4F76A3; font-size: 90% !important;' width='5%'>$langUnCourse</th>
         </tr>";
     ...
     $result2 = mysql_query("SELECT cours.code k, cours.fake_code c, cours.intitule i, cours.titulaires t, cours_user.statut s FROM cours, cours_user WHERE cours.code=cours_user.code_cours
        ...
        if (mysql_num_rows($result2) > 0) {
         $tool_content .= "<tr><td><br>
              ...
              <table width='100%' cellpadding='0' cellspacing='1' valign=middle align=center style='border:2px solid #FFFFFF;'>
              <tr><td class=color1 valign=middle style='border: 2px solid #FFFFFF;'><b>$langMyCoursesProf</b></td></tr>
  						<tr><td>
            	<table class='sortable' id='t1' cellpadding='0' cellspacing='0' align=center style='border: 2px solid #FFFFFF;'>
           <tr>
				<th style='text-align: left; border: 0px; background: #E6EDF5; color: #4F76A3; font-size: 90% !important;' width='65%'>$langCourseCode</th>
        <th style='text-align: left; border: 0px; background: #E6EDF5; color: #4F76A3; font-size: 90% !important;' width='30%'>$langProfessor</th>
        <th style='text-align: left; border: 0px; background: #E6EDF5; color: #4F76A3; font-size: 90% !important;' width='5%'>$langManagement</th>
               </tr>";
...
while ($mycours = mysql_fetch_array($result2)) {
             ...
             $status[$dbname] = $mycours["s"];
	           $tool_content .= "<tr onMouseOver=\"this.style.backgroundColor='#F5F5F5'\" onMouseOut=\"this.style.backgroundColor='transparent'\">";
             $tool_content .= "<td height=26 style='border: 2px solid #FFFFFF;'><a class='CourseLink' href='${urlServer}courses/$mycours[k]'>$mycours[i]</a><span class='explanationtext'><font color=#4175B9> ($mycours[c]) </font></span></td>
           <td style='border: 2px solid #FFFFFF;'><span class='explanationtext'>$mycours[t]</span></td>
           <td style='border: 2px solid #FFFFFF;' align=center valign=middle>
	...
	$tool_content .= '</table></td></tr></table>';
         ...
         $tool_content .= "<tr><td style='border: 2px solid #FFFFFF;'>$langWelcomeProf</td></tr>\n";
} // if
