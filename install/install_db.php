...
$default_config = array(
    ...
    'mentoring_platform',0,
    'mentoring_always_active',0,
    'mentoring_tutor_as_mentee',0,
    'creation_mentoring_tables',1,
    'email_required', 0,
    'email_from', 1,
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////// Mentoring platform tables ///////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////


$db->query("CREATE TABLE `mentoring_programs` (
    `id` INT(11) NOT NULL auto_increment,
    `code` VARCHAR(20) NOT NULL,
    `lang` VARCHAR(16) NOT NULL DEFAULT 'el',
    `title` VARCHAR(255) NOT NULL DEFAULT '',
    ...
    `other_groups_reg` INT(11) NOT NULL DEFAULT 0,
    `allow_unreg_mentee` INT(11) NOT NULL DEFAULT 0,
    PRIMARY KEY (`id`),
...
$db->query("CREATE TABLE `mentoring_programs_user` (
...
`reg_date` DATETIME NOT NULL,
`is_guided` INT(11) NOT NULL DEFAULT 0,
...
$db->query("CREATE TABLE IF NOT EXISTS `mentoring_rentezvous` (
    `id` INT(11) NOT NULL AUTO_INCREMENT,
    ...
    `end` DATETIME NOT NULL,
    `group_id` INT(11) NOT NULL DEFAULT 0,
    `type_tc` VARCHAR(255) DEFAULT NULL,
    `api_url` VARCHAR(255) DEFAULT NULL,
...
$db->query("CREATE TABLE IF NOT EXISTS `mentoring_rentezvous_user` (
    `id` INT(11) NOT NULL AUTO_INCREMENT,
...
$db->query("CREATE TABLE IF NOT EXISTS `mentoring_programs_requests` (
    `id` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    `mentoring_program_id` INT(11) NOT NULL,
...
$db->query("CREATE TABLE IF NOT EXISTS `mentoring_forum` (
        `id` INT(10) NOT NULL AUTO_INCREMENT,
        `name` VARCHAR(255) DEFAULT '' NOT NULL,
        `desc` MEDIUMTEXT NOT NULL,
        `num_topics` INT(10) DEFAULT 0 NOT NULL,
...
$db->query("CREATE TABLE IF NOT EXISTS `mentoring_forum_category` (
    `id` INT(10) NOT NULL AUTO_INCREMENT PRIMARY KEY,
    `cat_title` VARCHAR(255) DEFAULT '' NOT NULL,
    `cat_order` INT(11) DEFAULT 0 NOT NULL,
    `mentoring_program_id` INT(11) NOT NULL,
...
$db->query("CREATE TABLE IF NOT EXISTS `mentoring_forum_notify` (
    `id` INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
    `user_id` INT(11) DEFAULT 0 NOT NULL,
    `cat_id` INT(11) DEFAULT 0 NOT NULL ,
    `forum_id` INT(11) DEFAULT 0 NOT NULL,
...
$db->query("CREATE TABLE IF NOT EXISTS `mentoring_forum_post` (
    `id` INT(10) NOT NULL AUTO_INCREMENT PRIMARY KEY,
    `topic_id` INT(10) NOT NULL DEFAULT 0,
    `post_text` MEDIUMTEXT NOT NULL,
    `poster_id` INT(10) NOT NULL DEFAULT 0,
...
$db->query("CREATE TABLE IF NOT EXISTS `mentoring_forum_topic` (
    `id` INT(10) NOT NULL auto_increment,
    `title` VARCHAR(255) DEFAULT NULL,
    `poster_id` INT(10) DEFAULT NULL,
    `topic_time` DATETIME,
...
$db->query("CREATE TABLE IF NOT EXISTS `mentoring_forum_user_stats` (
    `user_id` INT(11) NOT NULL,
    `num_posts` INT(11) NOT NULL,
    `mentoring_program_id` INT(11) NOT NULL,
...
$db->query("CREATE TABLE IF NOT EXISTS `mentoring_group_properties` (
    `mentoring_program_id` INT(11) NOT NULL,
    `group_id` INT(11) NOT NULL PRIMARY KEY,
    `self_registration` TINYINT(4) NOT NULL DEFAULT 1,
    `allow_unregister` TINYINT(4) NOT NULL DEFAULT 0,
    ...
    `self_request` TINYINT(4) NOT NULL DEFAULT 0,
    `announcements` TINYINT(4) NOT NULL DEFAULT 0,
    `wall` TINYINT(4) NOT NULL DEFAULT 0) $tbl_options");
...
$db->query("CREATE TABLE IF NOT EXISTS `mentoring_group` (
    `id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
    ...
    `secret_directory` varchar(100) NOT NULL DEFAULT 0,
    `visible` TINYINT(4) NOT NULL DEFAULT 1,
    `allow_manage_doc` INT(11) NOT NULL DEFAULT 0,
    `common` INT(11) NOT NULL DEFAULT 0) $tbl_options");
...
$db->query("CREATE TABLE IF NOT EXISTS `mentoring_group_members` (
    `group_id` int(11) NOT NULL,
    `user_id` int(11) NOT NULL,
    `is_tutor` int(11) NOT NULL DEFAULT 0,
    `description` TEXT,
...
$db->query("CREATE TABLE IF NOT EXISTS `mentoring_group_category` (
    `id` INT(6) NOT NULL AUTO_INCREMENT,
    `mentoring_program_id` INT(11) NOT NULL,
    `name` VARCHAR(255) NOT NULL,
    `description` TEXT,
...
$db->query("CREATE TABLE IF NOT EXISTS `mentoring_programs_old_session` (
    `id` INT(6) NOT NULL AUTO_INCREMENT,
    `user_id` INT(11) UNSIGNED NOT NULL DEFAULT 0,
...
$db->query("CREATE TABLE IF NOT EXISTS `mentoring_document` (
    `id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
    `mentoring_program_id` INT(11) NOT NULL DEFAULT 0,
    `subsystem` TINYINT(4) NOT NULL,
    `subsystem_id` INT(11) DEFAULT NULL,
...
$db->query("CREATE TABLE IF NOT EXISTS `mentoring_log` (
    `id` int(11) NOT NULL auto_increment,
    `user_id` int(11) NOT NULL default 0,
    `mentoring_program_id` int(11) NOT NULL default 0,
    `module_id` int(11) NOT NULL default 0,
...
$db->query("CREATE TABLE IF NOT EXISTS `mentoring_mentor_availability` (
    `id` int(11) NOT NULL auto_increment,
    `user_id` int(11) NOT NULL default 0,
...
$db->query("CREATE TABLE IF NOT EXISTS `mentoring_mentor_availability_group` (
    `id` int(11) NOT NULL auto_increment,
    `user_id` int(11) NOT NULL default 0,
    `group_id` int(11) NOT NULL default 0,
    `start` DATETIME DEFAULT NULL,
...
$db->query("CREATE TABLE IF NOT EXISTS `mentoring_mentor_tag` (
    `id` INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
    `user_id` int(11) NOT NULL,
    `date` DATETIME DEFAULT NULL,
    `tag_id` int(11) NOT NULL) $tbl_options");
...
$db->query("CREATE TABLE IF NOT EXISTS mentoring_tag (
    `id` INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
    `name` VARCHAR(255) NOT NULL,
    UNIQUE KEY (name)) $tbl_options");
...
$db->query("CREATE TABLE IF NOT EXISTS mentoring_specializations (
    `id` INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
    `name` VARCHAR(255) NOT NULL,
    UNIQUE KEY (name)) $tbl_options");


$db->query("CREATE TABLE IF NOT EXISTS mentoring_specializations_translations (
    `id` INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
$db->query("CREATE TABLE IF NOT EXISTS `mentoring_skills` (
    `id` INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
    `name` VARCHAR(255) NOT NULL,
    UNIQUE KEY (name)) $tbl_options");


$db->query("CREATE TABLE IF NOT EXISTS mentoring_skills_translations (
    `id` INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
$db->query("CREATE TABLE IF NOT EXISTS `mentoring_specializations_skills` (
    `id` INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
    `skill_id` int(11) NOT NULL,
    `specialization_id` int(11) NOT NULL,
...
$db->query("CREATE TABLE IF NOT EXISTS `mentoring_keywords` (
    `id` INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
    `name` VARCHAR(255) NOT NULL,
    `specialization_id` int(11) NOT NULL,
    `skill_id` int(11) NOT NULL,
...
$db->query("CREATE TABLE IF NOT EXISTS `mentoring_mentor_skills` (
    `id` INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
    `specialization_id` int(11) NOT NULL,
    `skill_id` int(11) NOT NULL,
    `user_id` int(11) NOT NULL,
...
$db->query("CREATE TABLE IF NOT EXISTS `mentoring_booking` (
    `id` INT(11) NOT NULL AUTO_INCREMENT,
    `mentoring_program_id` INT(11) NOT NULL,
    `group_id` INT(11) NOT NULL DEFAULT 0,
    `mentor_id` INT(11) NOT NULL,
...
$db->query("CREATE TABLE IF NOT EXISTS `mentoring_booking_user` (
    `id` INT(11) NOT NULL AUTO_INCREMENT,
...
$db->query("CREATE TABLE IF NOT EXISTS `mentoring_wall_post` (
    `id` INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
    `mentoring_program_id` INT(11) NOT NULL,
    `user_id` INT(11) UNSIGNED NOT NULL DEFAULT 0,
    `content` TEXT DEFAULT NULL,
...
$db->query("CREATE TABLE `mentoring_wall_post_resources` (
    `id` INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
    `post_id` INT(11) NOT NULL,
    `title` VARCHAR(255) NOT NULL DEFAULT '',
    `res_id` INT(11) NOT NULL,
...
$db->query("CREATE TABLE IF NOT EXISTS `mentoring_comments` (
    `id` INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
    `rid` INT(11) NOT NULL,
    `rtype` VARCHAR(50) NOT NULL,
    `content` TEXT NOT NULL,
...
$db->query("CREATE TABLE `mentoring_announcement` (
    `id` INT(11) NOT NULL auto_increment,
    `title` VARCHAR(255) NOT NULL DEFAULT '',
    `content` TEXT,
    `date` DATETIME NOT NULL,
...
$db->query("CREATE TABLE `mentoring_announcement_user` (
    `id` INT(11) NOT NULL AUTO_INCREMENT,
...
$db->query("CREATE TABLE IF NOT EXISTS `mentoring_homepageTexts` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `lang` VARCHAR(16) NOT NULL DEFAULT 'el',
    `title` text NULL,
    `body` text NULL,
...
$db->query("CREATE TABLE IF NOT EXISTS `mentoring_admin_announcement` (
`id` INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
`title` VARCHAR(255) NOT NULL,
`body` TEXT,
`date` DATETIME NOT NULL,
