                ...
                <div class='col-12'>
                    <div class='row'>
                        <div class='col-lg-6 col-12'>
                            <input type='submit' class='btn cancelAdminBtn w-100' name='install1' value='&laquo; {{ trans('langPreviousStep') }}'>
                        </div>
                        <div class='col-lg-6 col-12 mt-lg-0 mt-3'>
                            <input type='submit' class='btn w-100' name='install3' value='{{ trans('langAccept') }}'>
                        </div>
                    </div>
                </div>
            </div>
