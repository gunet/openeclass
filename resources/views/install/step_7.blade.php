        ...
        <div class='col-12'>
            <div class='row'>
                <div class='col-lg-5 col-12'>
                    <input type='submit' class='btn cancelAdminBtn w-100' name='install6' value='&laquo; {{ trans('langPreviousStep') }}'>
                </div>
                <div class='col-lg-7 col-12 mt-lg-0 mt-3'>
                    <input type='submit' class='btn w-100' name='install8' id='install8' value='{{ trans('langInstall') }} &raquo;'>
                </div>
            </div>
        </div>
    </div>
