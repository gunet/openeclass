            ...
            @if($image_footer)
                ...
                <div class='col-12 d-flex d-flex justify-content-center align-items-center gap-3 flex-wrap mt-3'>
                    ...
                    @if (!get_config('dont_display_contact_menu'))
                        <div>
                            <a class="a_tools_site_footer" href="{{$urlAppend}}info/contact.php" @if($_SESSION['provider'] == 'lti_publish') target="_blank" @endif aria-label="{{ trans('langContact') }}">
                                {{ trans('langContact') }}
                            </a>
                        </div>
                    @endif
                    ...
                    @if (!get_config('dont_display_manual_menu'))
                        <div>
                            <a class="a_tools_site_footer" href="{{$urlAppend}}info/manual.php" @if($_SESSION['provider'] == 'lti_publish') target="_blank" @endif aria-label="{{ trans('langManuals') }}">
                                {{ trans('langManuals') }}
                            </a>
                        </div>
                    @endif
                ...
                <div class="col-12 d-flex justify-content-center align-items-center flex-wrap gap-5 mt-3 pb-3">
                    <a class="copyright" href='{{$urlAppend}}info/copyright.php' @if($_SESSION['provider'] == 'lti_publish') target="_blank" @endif aria-label="Copyright © {{ date('Y') }} All rights reserved">Copyright © {{ date('Y') }} All rights reserved</a>
            ...
            @else
                ...
                <nav class='col-12 d-flex justify-content-between align-items-center'>
                    ...
                    <div class='d-flex justify-content-start align-items-center'>
                        <a class="copyright px-2" href='{{ $urlAppend }}info/copyright.php' @if($_SESSION['provider'] == 'lti_publish') target="_blank" @endif aria-label="Copyright © {{ date('Y') }} All rights reserved">Copyright © {{ date('Y') }} All rights reserved</a>
                        @if(get_config('enable_social_sharing_links'))
                            @if (get_config('link_fb'))
                                <a class='a_tools_site_footer' href="{!! get_config('link_fb') !!}" target="_blank" aria-label="Facebook: {{ trans('langOpenNewTab') }}">
                                    <i class="fab fa-facebook-f social-icon-tool"></i>
