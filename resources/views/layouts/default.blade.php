                                ...
                                <li id="profile_menu_dropdown" class="dropdown">
                                   <a class="dropdown-toggle clearfix" role="button" id="dropdownMenu1" data-toggle="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right" role="menu" aria-labelledby="dropdownMenu1">
                                        ...
                                        <li role="presentation">
                                            <a role="menuitem" tabindex="-1" href="{{ $urlAppend }}main/profile/personal_stats.php"><span class="fa fa-area-chart fa-fw"></span>{{ trans('langMyStats') }}</a>
                                        </li>
                ...
                <div class="panel-group" id="sidebar-accordion">                   
                    <div class="panel">
                        ...
                        <div id="collapse{{ $key }}" class="panel-collapse list-group collapse{{ $tool_group[0]['class'] }}">
                            ...
                            <a href="{{ $tool_group[2][$key2] }}" class="list-group-item {{ module_path($tool_group[2][$key2]) == $current_module_dir ? " active" : ""}}" {{ is_external_link($tool_group[2][$key2]) or $tool_group[3][$key2] == 'fa-external-link' ? ' target="_blank"' : "" }}>
