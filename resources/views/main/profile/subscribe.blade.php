                            ...
                            <div class='row'>
                                ...
                                <div class='col-lg-6 col-12'>
                                    <div class='form-wrapper form-edit border-0 px-0'>
                                        ...
                                        <label class='label-container' aria-label="{{ trans('langSelect') }}" id="id_selected">
                                            <input id="id_selected" type='checkbox' name='c_unsub' value='1' {{ $selected }}>
                                        ...
                                        @else
                                            @foreach($_SESSION['courses'] as $code => $status)
                                                ...
                                                <label class='label-container' aria-label="{{ trans('langSelect') }}" for="id_{{ $code }}">
                                                    <input id="id_{{ $code }}" type='checkbox' name='c_unsub[{{ $code }}]' value='1' {{ get_user_email_notification($uid, course_code_to_id($code)) ? 'checked' : '' }}>
                                                    <span class='checkmark'></span>
