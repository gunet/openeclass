                    ...
                    <form class='form-horizontal' role='form' method='post' enctype='multipart/form-data' action='{{ $sec }}' onsubmit='return validateNodePickerForm();'>
                            ...
                            <div class='form-group mt-4'>
                                ...
                                <div class='row'>
                                    <div class='col-sm-12'>
                                        ...
                                        @endif
                                        <span class='help-block'>{{ trans('langVisibleInfo') }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            @if (get_config('email_verification_required'))
                                <div class='form-group {{ $messageClass }} mt-4'>
                                    <div class='col-sm-12 control-label-notes mb-2'>{{ trans('langVerifiedMail') }}<span class='ps-3'>{!! $message !!}</span></div>
                                </div>
                            @endif

                            @if (!get_config('restrict_owndep'))
                                <div class='form-group mt-4'>
                                    <label for='dialog-set-value' class='col-sm-12 control-label-notes mb-2'>{{ trans('langFaculty') }} <span class='asterisk Accent-200-cl'>(*)</span></label>
