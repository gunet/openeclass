                            ...
                            <div class="col-md-8 col">
                                <div class="card-body py-0">
                                    ...
                                    @if(empty($c->description))
                                        @if(!$c->is_collaborative)
                                        <h2 class='text-heading-h3 form-label mb-1'>{{ trans('langCourseProgram')}}</h2>
                                        @else
                                        <h2 class='text-heading-h3 form-label mb-1'>{{ trans('langCollabDes')}}</h2>
                                        @endif
                                    ...
                                    <h2 class='text-heading-h3 form-label mb-1 mt-4'>{{ trans('langCreationDate')}}</h2>
                            ...
                            <div class='panel-group group-section mt-2 px-0' id='accordionDesC'>
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item px-0 mb-4 bg-transparent">
                                        ...
                                        <h2 class='text-heading-h3 d-flex justify-content-between border-bottom-default'>
