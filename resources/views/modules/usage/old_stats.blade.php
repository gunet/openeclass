                                ...
                                <div class="form-wrapper form-edit rounded">
                                    <form class="form-horizontal" role="form" method="post" action="{{ $_SERVER['SCRIPT_NAME'] }}?course={{ $course_code  }}">
                                        <div class='input-append date form-group mt-4' id='user_date_start' data-date='{{ $user_date_start }}' data-date-format='dd-mm-yyyy'>
                                            <label for="user_date_start_id" class='col-12 control-label-notes'>{{ trans('langStartDate') }} <span class='asterisk Accent-200-cl'>(*)</span></label>
                                        ...
                                        <div class='input-append date form-group mt-4' id='user_date_end' data-date='{{ $user_date_end }}' data-date-format='dd-mm-yyyy'>
                                            <label for="user_date_end_id" class='col-12 control-label-notes'>{{ trans('langEndDate') }} <span class='asterisk Accent-200-cl'>(*)</span></label>
                                            <div class='input-group'>
                                                <span class='add-on input-group-text h-40px bg-input-default input-border-color border-end-0'><i class='fa-regular fa-calendar'></i></span>
                                        ...
                                        <div class="form-group mt-4">
                                            <label for="u_module_id" class="col-12 control-label-notes">{{ trans('langModule') }} <span class='asterisk Accent-200-cl'>(*)</span></label>
                                            <div class="col-12">
