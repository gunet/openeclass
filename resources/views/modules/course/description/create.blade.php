                        ...
                        <div class='form-wrapper form-edit rounded'>
                            ...
                            <form class='form-horizontal' role='form' action='{{$urlServer}}modules/course_description/index.php?course={{ $course_code }}' method='post'>
                                ...
                                <div class='form-group'>
                                    <label for='typSel' class='col-sm-6 control-label-notes'>{{ trans('langType') }}</label>
                                    <div class='col-sm-12'>
                                ...
                                <div class='form-group{{ $titleError ? " form-error" : ""}} mt-4'>
                                    <label for='titleSel' class='col-sm-6 control-label-notes'>{{ trans('langTitle') }} <span class='asterisk Accent-200-cl'>(*)</span></label>
                                    <div class='col-sm-12'>
