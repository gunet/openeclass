...
<script type="text/javascript">
    ...
    function refreshHeader() {
        _refreshFragment(
            '{{ $urlAppend }}modules/learnPath/viewer.php?course={{ $course_code }}&fragment=header{!! $unitParamPlain !!}',
            'lp-header',
            function() {
                window.eclassLP.closeUrl = document.querySelector('#lp-header [data-close-url]')?.getAttribute('data-close-url') || '';
                bindHeaderEvents();
    ...
    function refreshToc() {
        _refreshFragment(
            '{{ $urlAppend }}modules/learnPath/viewer.php?course={{ $course_code }}&fragment=toc{!! $unitParamPlain !!}',
            'lp-sidebar'
        );
    }
    ...
    function _buildPrepareUrl(moduleId) {
        return '{{ $urlAppend }}modules/learnPath/viewer.php?course={{ $course_code }}{!! $unitParamPlain !!}&action=prepareModule&module_id=' + moduleId;
    }
