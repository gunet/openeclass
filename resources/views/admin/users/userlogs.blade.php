                    ...
                    <form class='form-horizontal' role='form' method='get' action='{{ $_SERVER['SCRIPT_NAME'] }}'>
                        ...
                        <div class="form-group mt-5">
                            <div class="col-12 d-flex justify-content-end align-items-center gap-2">
                                ...
                                <a class="btn cancelAdminBtn" href="listusers.php" data-bs-placement="bottom" data-bs-toggle="tooltip" title="" data-bs-original-title="{{ trans('langCancel') }}" aria-label="{{ trans('langCancel') }}">
                                    {{ trans('langCancel') }}
                                </a>
                                <a class="btn successAdminBtn" href="user_last_logins.php?u={{ $u }}" data-bs-placement="bottom" data-bs-toggle="tooltip" title="" data-bs-original-title="{{ trans('langUserLastLogins') }}" aria-label="{{ trans('langUserLastLogins') }}">
                                    {{ trans('langUserLastLogins') }}
                                </a>
                            </div>
                        </div>
                    </form>
