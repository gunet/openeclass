                    ...
                    <form class='form-horizontal' role='form' name='edit-tenant' method='post' action='tenant_edit.php' onsubmit='return validateNodePickerForm();'>
                        ...
                        <fieldset>
                            ...
                            <div class='form-group'>
                                ...
                                <div class='col-sm-12'>
                                    <input id='name' class='form-control' type='text' name='name' required @if ($tenant) value='{{ $tenant->name }}' @endif>
                                </div>
                            </div>
                            ...
                            <div class='form-group mt-4'>
                                <label class='col-sm-12 control-label-notes mb-2'>{{ trans('langAssociateCategory') }}</label>
                                <div class="col-sm-12">
                                    @if ($tenant)
                                    ...
                                    @else
                                        <div class="radio mb-2">
                                            <label>
                                                ...
                                                {{ trans('langAddCategoryAuto') }}
                                            </label>
                                        </div>
                                        <div class="radio">
                                            <label>
                                                <input type="radio" value="1" name="tenant_category">
                                                {{ trans('langChooseExistingCategory') }}
                                            </label>
                                            <div class="help-block">{{ trans('langChooseExistingInfo') }}</div>
                                        </div>
                                    @endif
                                </div>
                            </div>
