...
@section('content')
    ...
    <div class='form-wrapper'>
        ...
        <div class='form-group'>
            <label for='ip_form' class='col-sm-3 control-label'>{{ trans('langOpenMeetingsPort') }}:</label>
            <div class='col-sm-9'>
        ...
        <div class='form-group'>
            ...
            <div class='form-group'>
                <label for='module_key_form' class='col-sm-3 control-label'>{{ trans('langOpenMeetingsModuleKey') }}:</label>
                <div class='col-sm-9'>
                    <input class='form-control' type='text' name='module_form' value='{{ isset($server) ? $server->module_key : "" }}'>
                </div>
            </div>
            <div class='form-group'>
