                    ...
                    <div class='form-wrapper form-edit border-0 px-0'>
                        ...
                        <form class='form-horizontal' action='{{ $_SERVER['SCRIPT_NAME'] }}' method='post'>
                            @foreach($appParams as $param)
                                @if ($param->name() == SebApp::ENABLEDCOURSES)
                                    <div class='form-group mt-4' id='courses-list'>
                                        ...
                                        <div class='col-12'>
                                            <select id='select-courses' class='form-control' name='seb_courses[]' multiple>
                                                {!! $courses_content !!}
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class='col-sm-offset-3 col-sm-9'>
                                            <div class='checkbox'>
                                                <label class='label-container' aria-label='{{ trans('langSelect') }}'>
                                                    <input type='checkbox' name='{{ $param->name() }}' value='1' @if ($param->value() == 1) checked @endif>
                            ...
                            <div class='form-group mt-5'>
                                <div class='col-12 d-flex justify-content-end'>
                                    <button class='btn submitAdminBtn me-2' type='submit' name='submit'>{{ trans('langSubmit') }}</button>
