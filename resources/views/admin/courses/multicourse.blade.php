                        ...
                        <form role='form' class='form-horizontal' method='post' action='{{ $_SERVER['SCRIPT_NAME'] }}' onsubmit="return validateNodePickerForm();">
                            <fieldset>
                                ...
                                <div class='radio mb-3'>
                                    <label>
                                        <input id='courseopen' type='radio' name='formvisible' value='2' @if ($default_access === COURSE_OPEN) checked @endif>
                                ...
                                <div class='radio mb-3'>
                                    <label>
                                        <input id='coursewithregistration' type='radio' name='formvisible' value='1' @if ($default_access === COURSE_REGISTRATION) checked @endif>
                                        {{ trans('langRegCourse') }}
                                    </label>
                                </div>
                                ...
                                <div class='radio mb-3'>
                                    <label>
                                        <input id='courseclose' type='radio' name='formvisible' value='0' @if ($default_access === COURSE_CLOSED) checked @endif>
                                ...
                                <div class='radio mb-3'>
                                    <label>
                                        <input id='courseinactive' type='radio' name='formvisible' value='3' @if ($default_access === COURSE_INACTIVE) checked @endif>
                                        {{ trans('langInactiveCourse') }}
                                    </label>
                                </div>

                                <div class='form-group mt-4'>
                                    <label for='password' class='col-sm-12 control-label-notes'>{{ trans('langOptPassword') }}</label>
                                    <div class='col-sm-12'>
