                                        ...
                                        <td>
                                            ...
                                            @foreach ($questions as $question)
                                                ...
                                                <table class="table-default mb-4">
                                                    <tr>
                                                        <th valign="top" colspan="2">{{ trans('langQuestion') }}
                                                            &nbsp;{{ $questionCount }}</th>
                                                    </tr>
                                                    <tfoot>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td valign="top" colspan="2">
                                                            <i>{!! parse_user_text($question->selectDescription()) !!}</i>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    @for ($answerId = 1; $answerId <= $answerCount; $answerId++)
                                                        @if ($question->selectType() == UNIQUE_ANSWER || $question->selectType() == TRUE_FALSE)
                                                            ...
                                                            <tr>
                                                                <td width="5%" align="center">
                                                                    <input type="radio"
                                                                           name="unique_{{ $questionCount }}_x"
                                                                           id="scorm_{{ $idCounter }}"
                                                                           value="{{ $answer->getWeighting($answerId) }}">
                                                                </td>
                                                                <td width="95%"><label
                                                                            for="scorm_{{ $idCounter }}">{!!  strip_tags($answer->getTitle($answerId)) !!}</label>
                                                                </td>
                                                            </tr>
                                                                ...
                                                                <td width="5%" align="center">
                                                                    <div class='checkbox'>
                                                                        <label class='label-container'>
                                                                            <input type="checkbox"
                                                                                   name="multiple_{{ $questionCount }}_{{ $answerId }}"
                                                                                   id="scorm_{{ $idCounter }}"
                                                                                   value="{{ $answer->getWeighting($answerId) }}">
                                                        ...
                                                        @elseif ($question->selectType() == FILL_IN_BLANKS || $question->selectType() == FILL_IN_BLANKS_TOLERANT)
                                                            ...
                                                            <tr>
                                                                <td colspan="2">
                                                                        ...
                                                                        $explodedAnswer = explode('::', strip_tags($answer->getTitle($answerId)));
                                                        ...
                                                        @elseif ($question->selectType() == MATCHING)
                                                            ...
                                                            @if (!$answer->isCorrect($answerId))
                                                                    ...
                                                                    $Select[$answerId] = strip_tags($answer->getTitle($answerId));
                                                                    ?>
                                                            @else
                                                                <tr>
                                                                    <td colspan="2">
                                                                        <table border="0" cellpadding="0"
                                                                            ...
                                                                            <tr>
                                                                                <td width="40%" valign="top">
                                                                                    <b>{{ $choiceCounter }}
                                                                                        .</b>{!!  strip_tags($answer->getTitle($answerId)) !!}
                                                                                </td>
                                                                                <td width="20%" valign="top">&nbsp;
                                                                                    <select class='form-select'
                                                                                            name="matching_{{ $questionCount }}_{{ $answerId }}"
                                                                                            id="scorm_{{ $idCounter }}">
                                                                                        ...
                                                                                        @foreach ($Select as $key => $val)
                                                                                                <?php $scoreModifier = ($key == $answer->isCorrect($answerId)) ? $answer->getWeighting($answerId) : 0; ?>
