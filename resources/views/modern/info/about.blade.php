                        ...
                        <div class='row'>
                            <div class='col-md-6 col-12'>
                                <ul class='list-group list-group-flush'>
                                    <li class='list-group-item'><strong class='text-primary text-uppercase'>{{ trans('langCourses') }}</strong><span class='badge bg-primary text-white float-end'>{{ $course_inactive }}</span></li>
                            ...
                            <div class='col-md-6 col-12 mt-md-0 mt-3'>
                                <ul class='list-group list-group-flush'>
                                    <li class='list-group-item'><strong class='text-primary text-uppercase'>{{ trans('langUsers') }}</strong><span class='badge bg-primary text-white float-end'>{{ $count_total }}</span></li>
