...
<div class="container-fluid main-container details-section">
    ...
    <div class="row rowMedium">
        <div class="col-lg-12 user-details" >
            <div class="row py-md-5 px-md-5 py-3 px-2">
                    ...
                    <div class="row block-title-2 rowMedium justify-content-between">
                        ...
                        <div class="col-xl-4 col-md-7 col-2 pe-0">
                            <div class="collapse-details-button" data-bs-toggle="collapse" data-bs-target=".user-details-collapse" aria-expanded="false" onclick="switch_user_details_toggle()" >
                                <span class="user-details-collapse-less float-end"> <span class='hidden-xs text-primary text-uppercase mt-2'>{{ trans('langMyProfile') }}</span> <i class="fas fa-chevron-up"></i> </span>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                            <div class="container-fluid">
                                ...
                                <div class="row justify-content-center text-center">
                                    <div class="py-1" >
                                        <a href="{{ $urlAppend }}main/profile/profile.php" class="rounded-pill btn btn-outline-primary w-100 text-uppercase"><i class="fas fa-pen me-2"></i>{{ trans('langModProfile') }}</a>
                                    </div>
                                    <div class="py-1">
                                        <a href="{{$urlAppend}}main/unreguser.php" class="rounded-pill btn btn-outline-warning w-100 text-uppercase"><i class="fa fa-trash-o me-2"></i>{{ trans('langUnregUser') }} </a>
                                    </div>
                                    <div class="py-1">
                                        {{ trans('langExplain') }}
                                    </div>
                        ...
                        <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                                ...
                                {{--<div class='row mt-md-0 mt-3'>
                                    <div class='col-md-6 col-12'>
                                        <p class='TextMedium text-md-start text-center'>{{ trans('langSumCoursesEnrolled') }}&nbsp;&nbsp;{{ $student_courses_count }}</p>
                                        <p class='TextMedium text-md-start text-center '>{{ trans('langSumCoursesSupport') }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $teacher_courses_count }}</p>
                                    </div>
                                    <div class='col-md-6 col-12'>
                                        <p class='small-text TextMedium text-secondary text-center'>{{ trans('langProfileLastVisit') }}:
                                        <span class='blackBlueText text-md-start text-center'>{{ format_locale_date(strtotime($lastVisit->when)) }}</span>
                                        </p>
                                    </div>
                                </div>--}}

                                <div class='panel panel-admin border-0 bg-white mt-md-2 mt-3 rounded-0'>
                                ...
                                <div class='panel panel-admin border-0 bg-white mt-3 rounded-0'>
                                    <div class='panel-heading rounded-0 bg-body'>
                                        <div class='panel-heading bg-body'>
                                            <div class='col-12 Help-panel-heading'>
    ...
    <div class="container-fluid main-container cources-section mt-lg-3 mt-0">
        <div class="row rowMedium py-md-4 px-md-5 py-3 px-2">
            <div class="col-12 col-lg-8 user-courses ps-md-0 pe-md-3">
                <div class="row rowMedium">
            ...
            <div class="col-12 col-lg-4 calendar_announce_message_col mt-md-2 pe-md-0">
...
<div class="container-fluid main-container cources-section mt-lg-3 mt-0">
    <div class="row rowMedium py-md-5 px-md-5 py-3 px-3">

        <div class='col-lg-8 col-12 pe-lg-4'>
            <div class='row block-title-2'>
                <div class="col-8 d-inline-flex align-items-top p-0">
            ...
            <div class='row'>
                <div id="cources-bars" class="col-12 p-0">
                    {!! $perso_tool_content['lessons_content'] !!}
                    {{--<div class='d-flex justify-content-center'>
                        <a class="btn-slide" href="{{$urlServer}}modules/auth/courses.php" >
                            <span class="circle d-flex justify-content-center align-items-center">
            ...
            <div class='row'>
                <div id="cources-pics" class="col-12 cources-paging p-0" style="display:none">
                    <div class="row cources-pics-page" id="cources-pics-page-1">
                        @php $i=0; @endphp
                        @foreach($cources as $cource)
                        <div class="col-md-6 col-12">
        ...
        <div class='col-lg-4 col-12 ps-lg-2 pe-lg-0 pe-0 ps-0 mt-lg-0  mt-5'>
            @include('portfolio.portfolio-calendar')
