...
<div class="col-12 main-section">
                ...
                <div class='col-lg-6 col-12'>
                    <div class='card bg-transparent border-0'>
                        ...
                        <div class='card-body px-0 py-3'>
                            <div class='col-12'>
                                <div class='row rowMargin row-cols-1 row-cols-md-3 g-lg-3'>
        ...
        @if(get_config('mentoring_platform'))
            <div class='{{ $container }}'>
                <div class="row m-auto row-cols-2">
                    <div class='col-lg-6'>
                        <div class='card border-card bg-transparent'>
                            ...
                            <div class='card-body px-3'>
                                <div class="col-12 mt-0">
                                    ...
                                    <a id='goToMentoringPlatformBtn' class='btn submitAdminBtn w-50 float-end mt-3' 
