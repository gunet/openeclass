...
<div class="row back-navbar-eclass2"></div>
   ...
   <script type="text/javascript" src="{{ $urlAppend }}template/modern/js/notes_color_header.js"></script>
   <div class="pb-5">
        <div class="container-fluid notes_container">
            <div class="row">
                <div class="col-xl-12 col-lg-8 col-md-12 col-sm-6 col-xs-6 justify-content-center col_notes">
