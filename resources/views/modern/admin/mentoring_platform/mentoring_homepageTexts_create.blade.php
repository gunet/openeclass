                                ...
                                <div class='col-12'>
                                    <div id='orderTexts'>
                                        @foreach($texts as $text)
                                            <div class='panel panel-default mb-3 rounded-2' data-id='{{ $text->id }}'>
                                                <div class='panel-heading rounded-1 bg-light'>
                                                    
                                                        <div class='d-inline-flex justify-content-start align-items-center blackBlueText text-uppercase'>
                                                            {!! $text->title !!}
                                                        </div>
                                                        <div class='d-inline-flex justify-content-end align-items-center float-end'>
                                                            <a href='{{$urlAppend}}modules/admin/mentoring_homepageTexts_create.php?homepageText=modify&id={{$text->id}}'>
