            ...
            <div class='form-group'>
                <label for='ldaphost' class='col-sm-6 control-label-notes'>{{ trans('langldap_host_url') }}:</label>
                <div class='col-sm-12'>
            ...
            <div class='form-group'>
                <label for='ldap_base' class='col-sm-6 control-label-notes'>{{ trans('langldap_base') }}:</label>
                <div class='col-sm-12'>
            ...
            <div class='form-group'>
                <label for='ldapbind_dn' class='col-sm-6 control-label-notes'>{{ trans('langldap_bind_dn') }}:</label>
                <div class='col-sm-12'>
            ...
            <div class='form-group'>
                <label for='ldapbind_pw' class='col-sm-6 control-label-notes'>{{ trans('langldap_bind_pw') }}:</label>
                <div class='col-sm-12'>
            ...
            <div class='form-group'>
                <label for='ldap_login_attr' class='col-sm-6 control-label-notes'>{{ trans('langldap_login_attr') }}:</label>
                <div class='col-sm-12'>
            ...
            <div class='form-group'>
                <label for='ldap_login_attr2' class='col-sm-6 control-label-notes'>{{ trans('langldap_login_attr2') }}:</label>
                <div class='col-sm-12'>
            ...
            <div class='form-group'>
                <label for='ldap_login_attr' class='col-sm-6 control-label-notes'>{{ trans('langldap_mail_attr') }}:</label>
                <div class='col-sm-12'>
            ...
            <div class='form-group'>
                <label for='ldap_studentid' class='col-sm-6 control-label-notes'>{{ trans('langldap_id_attr') }}:</label>
                <div class='col-sm-12'>
