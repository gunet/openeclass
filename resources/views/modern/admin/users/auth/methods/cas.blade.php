                ...
                <div class='form-group mt-3'>
                    <label for='cas_host' class='col-sm-6 control-label-notes'>{{ trans('langcas_host') }}:</label>
                    <div class='col-sm-12'>
                ...
                <div class='form-group mt-3'>
                    <label for='cas_port' class='col-sm-6 control-label-notes'>{{ trans('langcas_port') }}:</label>
                    <div class='col-sm-12'>
                ...
                <div class='form-group mt-3'>
                    <label for='cas_context' class='col-sm-6 control-label-notes'>{{ trans('langcas_context') }}:</label>
                    <div class='col-sm-12'>
                ...
                <div class='form-group mt-3'>
                    <label for='cas_logout' class='col-sm-6 control-label-notes'>{{ trans('langcas_logout') }}:</label>
                    <div class='col-sm-12'>
                ...
                <div class='form-group mt-3'>
                    <label for='cas_logout' class='col-sm-6 control-label-notes'>{{ trans('langcas_ssout') }}:</label>
                    <div class='col-sm-12'>
                        {!! selection(
                            [
                                0 => trans('langNo'),
                ...
                <div class='form-group mt-3'>
                    <label for='cas_cachain' class='col-sm-6 control-label-notes'>{{ trans('langcas_cachain') }}:</label>
                    <div class='col-sm-12'>
                ...
                <div class='form-group mt-3'>
                    <label for='casusermailattr' class='col-sm-6 control-label-notes'>{{ trans('langcasusermailattr') }}:</label>
                    <div class='col-sm-12'>
                ...
                <div class='form-group mt-3'>
                    <label for='casuserfirstattr' class='col-sm-6 control-label-notes'>{{ trans('langcasuserfirstattr') }}:</label>
                    <div class='col-sm-12'>
                ...
                <div class='form-group mt-3'>
                    <label for='casuserlastattr' class='col-sm-6 control-label-notes'>{{ trans('langcasuserlastattr') }}:</label>
                    <div class='col-sm-12'>
                ...
                <div class='form-group mt-3'>
                    <label for='casuserstudentid' class='col-sm-6 control-label-notes'>{{ trans('langcasuserstudentid') }}:</label>
                    <div class='col-sm-12'>
                ...
                <div class='form-group mt-3'>
                    <label for='cas_altauth' class='col-sm-6 control-label-notes'>{{ trans('langcas_altauth') }}:</label>
                    <div class='col-sm-12'>
                        {!! selection(
                            [
                                0 => '-',
