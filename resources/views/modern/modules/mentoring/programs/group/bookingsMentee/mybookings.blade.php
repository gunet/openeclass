        ...
        <div class="row m-auto">
                    ...
                    <div class='col-6 text-end'>
                        @if($is_tutor_of_mentoring_program or $is_admin)
                            @if(count($booking_history) > 0)
                                <button class='btn submitAdminBtnDefault float-end'
                                        data-bs-toggle='modal' data-bs-target='#BookingHistory'><span class='fa-solid fa-trash-can'></span><span class='hidden-xs-mentoring'>&nbsp{!! trans('langBookingHistory') !!}</span>
                                </button>
                                        ...
                                        <div class="modal-dialog modal-lg modal-danger">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <button type='submit' class="btn deleteAdminBtn rounded-2 mb-3" name="delete_history_booking_id" value='delAllBooking'>
                                                        <span class='fa-solid fa-trash-can'></span>&nbsp{{ trans('langDeleteAllBookings') }}
                                                    </button>
                                                            ...
                                                            @foreach($booking_history as $h)
                                                                <tr>
                                                                    ...
                                                                    <td class='text-center'>
                                                                        ...
                                                                        <button type='submit' class="btn deleteAdminBtn" name="delete_history_booking_id" value='delOneBooking'>
                            ...
                            <div class='col-md-6 col-12 d-flex align-items-strech'>
                                <div class="panel panel-admin rounded-2 border-1 BorderSolid bg-white mb-lg-4 mb-4 py-md-4 px-md-4 py-3 px-3 shadow-none">
                                    ...
                                    <div class='panel-footer text-center rounded-2'>
                                        @if($is_editor_current_group or $is_tutor_of_mentoring_program or $is_admin)
                                            @if($b->accepted == 0)
                                                <button class='btn successAdminBtn me-3 mb-3'
                                            ...
                                            @endif
                                            <button class='btn deleteAdminBtn mt-4 mb-3'
                                                    data-bs-toggle='modal' data-bs-target='#BookingDelete{{ $b->id }}'><span class='fa-solid fa-trash-can'></span>&nbsp{!! trans('langCancelBooking') !!}
                                            </button>
                                        @else
                                            @if($b->accepted == 1)
                                                <span class='fa fa-check text-success fs-6 TextBold me-3'>&nbsp{{ trans('langHasAcceptedBooking') }}</span>
                                            ...
                                            @endif
                                            <a class='btn deleteAdminBtn mb-3' href='{{ $urlAppend }}modules/mentoring/programs/group/bookingsMentee/booking_space.php?group_id={!! getInDirectReference($b->group_id) !!}&mentor_id={!! getInDirectReference($b->mentor_id) !!}'>
                                    ...
                                    <div class="modal-dialog modal-md modal-success">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type='submit' class="btn successAdminBtn" name="accept_booking">
                    ...
                    @else
                       <div class='col-12 mt-4'>
                                ...
                                <span>{{ trans('langNoExistBookings') }}</span></div>
