                          ...
                          <form class='form-horizontal' role='form' method='post' name='createform' action="{{ $_SERVER['SCRIPT_NAME'] }}" enctype="multipart/form-data">
                            ...
                            <div class='form-group mt-4'>
                                ...
                                <div class='col-sm-12'>
                                    <div class='checkbox'>
                                        <label>
                                            <input id='id_self_reg' type='checkbox' name='self_reg' checked>{{ trans('langGroupAllowMenteeRegistration') }}
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class='form-group mt-4'>
                                ...
                                <div class='col-sm-12'>
                                    <div class='checkbox'>
                                        <label>
                                            <input id='id_self_request' type='checkbox' name='self_request'>{{ trans('langMenteeCanSendGroupRequest')}}
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class='form-group mt-4'>
                                ...
                                <div class='col-sm-12'>
                                    <div class='checkbox'>
                                        <label>
                                            <input type='checkbox' name='allow_unreg'> {{ trans('langGroupAllowMenteeUnregister') }}
                                        </label>
                                    </div>
                                </div>
                            </div>
