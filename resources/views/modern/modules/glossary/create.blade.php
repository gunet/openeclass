                                    ...
                                    <div class='form-wrapper form-edit rounded'>
                                        <form role='form' action='{{ $edit_url }}' method='post'>
                                                ...
                                                <div class='form-group{{ Session::getError('term') ? " has-error" : "" }}'>
                                                    <label for='term' class='col-sm-12 control-label-notes'>{{ trans('langGlossaryTerm') }} <span class='asterisk Accent-200-cl'>(*)</span></label>
                                                    <div class='col-sm-12'>
                                                ...
                                                <div class='form-group{{ Session::getError('definition') ? " has-error" : "" }} mt-4'>
                                                    <label for='definition' class='col-sm-6 control-label-notes'>{{ trans('langGlossaryDefinition') }} <span class='asterisk Accent-200-cl'>(*)</span></label>
                                                    <div class='col-sm-12'>
