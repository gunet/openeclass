                                    ...
                                    <div class='panel'>
                                        <div class='alert alert-success row mt-1' role='alert' style='margin: 0'>
                                            ...
                                            @if ($show_results)
                                                ...
                                                <div class='col-sm-2'><span class='fa fa-bar-chart showResults'></span> <span class='fa fa-list-alt fa-fw showPoll hide'></span></div>
                                            </div>
                                            <div class='row plotscontainer'>
                                                <div class='col-lg-12'></div>
                                            </div>
                                            <div class='panel-body pollResultsDiv hide'>
