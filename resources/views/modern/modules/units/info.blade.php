                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-12">
                                                    <div class="input-group mb-4">
                                                        <span class="input-group-text h-40px input-border-color bg-white border-end-0" id="basic-addon1"><i class='fa-regular fa-calendar'></i></span>
                                                ...
                                                <div class="col-lg-6 col-12 mt-lg-0 mt-4">
                                                    <div class="input-group mb-4">
                                                        <span class="input-group-text h-40px input-border-color bg-white border-end-0" id="basic-addon2"><i class='fa-regular fa-calendar'></i></span>
