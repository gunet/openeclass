...
@section('content')
<!-- <div class="container"><span class="bg-info text-danger" style="border:1px solid #a94442;border-radius:5px;padding:2px"><strong>this is modern: create_cource index</strong></span></div> -->
{!! $action_bar !!}
