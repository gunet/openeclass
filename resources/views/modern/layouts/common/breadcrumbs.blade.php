    ...
    <div class='d-inline-flex align-items-top overflow-hidden'>
        ...
        @if($course_code and !$is_in_tinymce and $currentCourseName and !isset($_GET['fromFlipped']))
            <nav class="me-lg-0 me-2" role="navigation" aria-label="Breadcrumb">
                <a class="btn d-lg-none p-0" type="button" data-bs-toggle="offcanvas" href="#collapseTools" role="button" aria-controls="collapseTools" aria-label="Open Course tools">
