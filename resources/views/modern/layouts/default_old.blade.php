...
<head>
    ...
    <?php if (isset($styles_str) && $styles_str) echo '<style>'.$styles_str.'</style>'; ?>
                                ...
                                <li id="profile_menu_dropdown" class="dropdown">
                                   <a class="dropdown-toggle clearfix" role="button" id="dropdownMenu1" data-toggle="dropdown">
                                    ...
                                    <ul class="dropdown-menu float-end" role="menu" aria-labelledby="dropdownMenu1">
                                        ...
                                        <li role="presentation">
                                            <a role="menuitem" tabindex="-1" href="{{ $urlAppend }}modules/usage/index.php?t=u"><span class="fa fa-area-chart fa-fw"></span>{{ trans('langMyStats') }}</a>
                                        </li>
