...
<div class="dropdown dropstart">
    ...
    <ul class="dropdown-menu manage-course-ul" aria-labelledby="dropdownManageCourse">
        <li class='bg-primary active-manage-course-li'><span class="manage-course-title ms-2 me-2 fs-5">{{trans('langModifyInfo')}}</span></li>
        ...
        @if ($is_course_admin)
            <li class="manage-course-li"><a href="{{ $urlAppend }}modules/course_home/editdesc.php?course={{$coursePrivateCode}}" class="manage-course-item ps-3 pe-2"><i class="fas fa-edit"></i> {{trans('langCourseEdit')}}</a></li>
        @endif
