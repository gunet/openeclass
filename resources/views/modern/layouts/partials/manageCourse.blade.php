...
<div class="dropdown dropstart">
    <button class="btn btn-primary rounded dropdown-toggle float-end" type="button" id="dropdownManageCourse" data-bs-toggle="dropdown" aria-expanded="false" aria-haspopup="true" aria-expanded="false">
