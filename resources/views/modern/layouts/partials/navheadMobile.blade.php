            ...
            <div class="btn-group w-100" role="group" aria-label="Basic example">
                ...
                @if($_SESSION['uid'])
                        ...
                        <ul class="dropdown-menu dropdown-menu-end dropdown_menu_user" aria-labelledby="dropdownMenuButton1">
                            <div class="d-flex justify-content-center text-white bg-warning p-2 mb-2" style='margin-top:-8px;'>
                                <i class="fa fa-user mt-1 pe-2"></i> {{uid_to_am($uid)}}
                            </div>
                            ...
                            @if($_SESSION['status'] == USER_TEACHER or $_SESSION['status'] == ADMIN_USER)
                               <li class='ps-1 pe-3 pt-2'><a class="dropdown-item text-white" href="{{ $urlAppend }}modules/create_course/create_course.php"><i class="fas fa-plus-circle fs-6 text-warning pe-2"></i>{{ trans('langCourseCreate') }}</a></li>
                            @endif
                            <li class='ps-1 pe-3 pt-2'>
                            ...
                            <li class='ps-1 pe-3 pt-2'>
                                <a class="dropdown-item text-white" href="{{ $urlAppend }}main/my_widgets.php"><i class="fa fa-magic fa-fw fs-6 text-warning pe-2"></i> {{ trans('langMyWidgets') }}</a>
                            </li>
                            <li class='ps-1 pe-3 pt-2'>
                                <a class="dropdown-item text-white" href="{{ $urlAppend }}main/gradebookUserTotal/index.php"><i class="fa fa-sort-numeric-desc fa-fw fs-6 text-warning pe-2"></i> {{ trans('langGradeTotal') }}</a>
                            </li>
                            <li class='ps-1 pe-3 pt-2'>
                                <a class="dropdown-item text-white" href="{{ $urlAppend }}main/mycertificates.php"><i class="fa fa-trophy fa-fw fs-6 text-warning pe-2"></i> {{ trans('langMyCertificates') }}</a>
                            </li>
                            ...
                            <li>
                                <form method='post' action='{{ $urlAppend }}modules/auth/logout.php' style='height:14px;'>
                                    ...
                                    <li>
                                        <button type='submit' class='d-flex justify-content-center btn btn-primary w-100 mt-3' name='submit'><i class="fas fa-sign-out-alt pt-1"></i><span class='ps-2 fs-6 text-white'>{{ trans('langLogout') }}</span></button>
                                    </li>
                                </form>
                            </li>
                        </ul>
